try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = '9c98b291-7311-47a3-82d8-d58f7a806f75'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-9c98b291-7311-47a3-82d8-d58f7a806f75'));
} catch (e) {}
('use strict');
  ...
  [5135],
  {
    ...
    36947: function (e, t, n) {
      ...
      var u = n(4899),
        g = n(12556),
        p = (0, i.memo)((e) => {
          let { safeQuorum: t, isMissingAddress: n, address: i } = e;
          return t
            ? (0, r.BX)(a.Kqy, {
                align: 'center',
                justify: 'center',
                ...
                children: [
                  ...
                  (0, r.BX)(a.xvT.Body.M.Regular, { lineHeight: '1', children: ['SAFE ', t] }),
                ],
              })
            : (0, r.tZ)(a.xvT.Body.M.Regular, { children: n ? 'No Address.' : (0, a.GQT)(i) });
        }),
        h = (0, i.memo)((e) => {
          var t;
          let {
            ...
            { targetChainId: y, targetChain: b } = (0, l.Z_)(),
            Z = (0, i.useMemo)(() => (0, a.Czs)(u), [u]),
            w = (0, i.useMemo)(() => (u ? o.ChainUtils.getExplorerAddressUrl(y, u) : null), [u, y]);
          return (0, r.tZ)(c.x, {
            ...f,
            children: (0, r.BX)(a.Kqy, {
              justify: 'center',
              ...
              children: [
                ...
                (0, r.BX)(s, {
                  ...
                  align: 'center',
                  children: [
                    (0, r.tZ)(p, { address: u, isMissingAddress: Z, safeQuorum: m }),
                    !Z &&
                      (0, r.BX)(a.Kqy, {
                        align: 'center',
                        children: [
                          (0, r.tZ)(a.mUV, {
                            toCopy: u,
                            toastMessage: x || 'Address copied to clipboard.',
                            tooltipMessage: h,
                          }),
                          (0, r.tZ)(a.ua7, {
                            content: 'Go to '.concat(
                              (null === (t = b.blockExplorers) || void 0 === t
                                ? void 0
