...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [4711],
  {
    84711: function (t, e, r) {
      ...
      s.create = (t, e) => new f(t, e);
      /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ let u = BigInt(0),
        a = BigInt(1),
        d = BigInt(2);
      function h(t) {
        return (
      ...
      let p = Array.from({ length: 256 }, (t, e) => e.toString(16).padStart(2, '0'));
      function y(t) {
        c(t);
        let e = '';
      ...
      function F(t, e, r) {
        ...
        let n = L(t),
          ...
          f = (...t) => r(i, n, ...t),
          s = (t = L()) => {
            (i = f(P([0]), t)), (n = f()), 0 !== t.length && ((i = f(P([1]), t)), (n = f()));
          },
          u = () => {
      ...
      /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ let C = BigInt(0),
        _ = BigInt(1),
        T = BigInt(2),
        V = BigInt(3),
        j = BigInt(4),
      ...
      function Y(t, e) {
        ...
        if (n !== _) throw Error('invert: does not exist');
        return M(i, e);
      }
      let G = [
        'create',
      ...
      function Q(t, e, r = !1, n = {}) {
        ...
        let { nBitLength: o, nByteLength: l } = $(t, e);
        ...
        let f = Object.freeze({
          ...
          pow: (t, e) =>
            (function (t, e, r) {
              ...
              let n = t.ONE,
                i = e;
              for (; r > C; ) r & _ && (n = t.mul(n, i)), (i = t.sqr(i)), (r >>= _);
              return n;
            })(f, t, e),
          div: (e, r) => M(e * Y(r, t), t),
          sqrN: (t) => t * t,
              ...
              i ||
                (i = (function (t) {
                  ...
                  return (function (t) {
                    let e, r, n;
                    let i = (t - _) / T;
                    for (e = t - _, r = 0; e % T === C; e /= T, r++);
                    for (
                      n = T;
                      n < t &&
                      (function (t, e, r) {
                        if (e < C) throw Error('invalid exponent, negatives unsupported');
                        if (r <= C) throw Error('invalid modulus');
                        if (r === _) return C;
                        let n = _;
                        for (; e > C; ) e & _ && (n = (n * t) % r), (t = (t * t) % r), (e >>= _);
                        return n;
                      })(n, i, t) !==
                        t - _;
                      n++
      ...
      /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ let tt = BigInt(0),
        te = BigInt(1);
      function tr(t, e) {
        let r = e.negate();
        return t ? r : e;
      ...
      function ti(t, e) {
        return tn(t, e), { windows: Math.ceil(e / t) + 1, windowSize: 2 ** (t - 1) };
      }
      let to = new WeakMap(),
        tl = new WeakMap();
      function tf(t) {
      ...
      function ts(t) {
        return (
          ...
          Object.freeze({ ...$(t.n, t.nBitLength), ...t, p: t.Fp.ORDER })
        );
      }
      /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ function tu(t) {
        void 0 !== t.lowS && g('lowS', t.lowS), void 0 !== t.prehash && g('prehash', t.prehash);
      }
      let { bytesToNumberBE: ta, hexToBytes: td } = n;
      ...
      let tc = {
          ...
          _int: {
            encode(t) {
              let { Err: e } = tc;
              if (t < tg) throw new e('integer: negative integers are not allowed');
              let r = m(t);
      ...
      BigInt(4);
      /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ let tm = BigInt(
        ...
        tv = Q(tm, void 0, void 0, {
          sqrt: function (t) {
            let e = BigInt(3),
              ...
              b = (W(E, r, tm) * s) % tm,
              B = W(b, tb, tm);
            if (!tv.eql(tv.sqr(B), t)) throw Error('Cannot find square root');
            return B;
          },
        }),
        tx = (function (t, e) {
          let r = (e) =>
            (function (t) {
              ...
              let {
                  ...
                  let r = (function (t) {
                    ...
                    o =
                      ...
                      ((t, e, r) => {
                        let i = e.toAffine();
                        return O(Uint8Array.from([4]), n.toBytes(i.x), n.toBytes(i.y));
                      }),
                    l =
                      r.fromBytes ||
                      ((t) => {
                  ...
                  function s(t) {
                    ...
                    if (n && 'bigint' != typeof t) {
                      if ((h(t) && (t = y(t)), 'string' != typeof t || !n.includes(t.length)))
                        throw Error('invalid private key');
                      t = t.padStart(2 * i, '0');
                    }
                    try {
                      e = 'bigint' == typeof t ? t : v(I('private key', t, i));
                    } catch (e) {
                      throw Error(
                        'invalid private key, expected hex or ' + i + ' bytes, got ' + typeof t
                      );
                    }
                    return o && (e = M(e, l)), R('private key', e, tp, l), e;
                  }
                  function u(t) {
                  ...
                  class c {
                    constructor(t, e, r) {
                      if (((this.px = t), (this.py = e), (this.pz = r), null == t || !n.isValid(t)))
                    ...
                    static fromHex(t) {
                      let e = c.fromAffine(l(I('pointHex', t)));
                    ...
                    static msm(t, e) {
                      return (function (t, e, r, n) {
                        ...
                        let i = t.ZERO,
                          ...
                          f = (1 << l) - 1,
                          s = Array(f + 1).fill(i),
                          u = Math.floor((e.BITS - 1) / l) * l,
                          a = i;
                        for (let t = u; t >= 0; t -= l) {
                          s.fill(i);
                          for (let e = 0; e < n.length; e++) {
                            let i = Number((n[e] >> BigInt(t)) & BigInt(f));
                            s[i] = s[i].add(r[e]);
                          }
                          let e = i;
                          for (let t = s.length - 1, r = i; t > 0; t--)
                            (r = r.add(s[t])), (e = e.add(r));
                          if (((a = a.add(e)), 0 !== t)) for (let t = 0; t < l; t++) a = a.double();
                        }
                        return a;
                      })(c, i, t, e);
                    }
                    _setWindowSize(t) {
                      m.setWindowSize(this, t);
                    }
                    assertValidity() {
                      d(this);
                    }
                    ...
                    add(t) {
                      ...
                      let { px: e, py: i, pz: o } = this,
                        ...
                        E = n.add(e, i),
                        b = n.add(l, f);
                      (E = n.mul(E, b)), (b = n.add(y, m)), (E = n.sub(E, b)), (b = n.add(e, o));
                      let B = n.add(l, s);
                      return (
                        (b = n.mul(b, B)),
                        (B = n.add(y, w)),
                    ...
                    wNAF(t) {
                      return m.wNAFCached(this, t, c.normalizeZ);
                    }
                    multiplyUnsafe(t) {
                      let { endo: e, n: i } = r;
                      R('scalar', t, tg, i);
                      ...
                      if (!e || m.hasPrecomputes(this))
                        return m.wNAFCachedUnsafe(this, t, c.normalizeZ);
                      let { k1neg: l, k1: f, k2neg: s, k2: u } = e.splitScalar(t),
                        a = o,
                        d = o,
                        h = this;
                      for (; f > tg || u > tg; )
                      ...
                      return (
                        l && (a = a.negate()),
                        s && (d = d.negate()),
                        (d = new c(n.mul(d.px, e.beta), d.py, d.pz)),
                        a.add(d)
                      );
                    }
                    multiply(t) {
                      let e, i;
                      let { endo: o, n: l } = r;
                      if ((R('scalar', t, tp, l), o)) {
                        let { k1neg: r, k1: l, k2neg: f, k2: s } = o.splitScalar(t),
                          { p: u, f: a } = this.wNAF(l),
                          { p: d, f: h } = this.wNAF(s);
                        (u = m.constTimeNegate(r, u)),
                          (d = m.constTimeNegate(f, d)),
                          (d = new c(n.mul(d.px, o.beta), d.py, d.pz)),
                          (e = u.add(d)),
                          (i = a.add(h));
                      } else {
                      ...
                      return c.normalizeZ([e, i])[0];
                    }
                    multiplyAndAddUnsafe(t, e, r) {
                      let n = c.BASE,
                        i = (t, e) =>
                          e !== tg && e !== tp && t.equals(n) ? t.multiply(e) : t.multiplyUnsafe(e),
                    ...
                    isTorsionFree() {
                      ...
                      if (t === tp) return !0;
                      if (e) return e(c, this);
                      throw Error('isTorsionFree() has not been declared for the elliptic curve');
                    }
                    clearCofactor() {
                      let { h: t, clearCofactor: e } = r;
                      return t === tp ? this : e ? e(c, this) : this.multiplyUnsafe(r.h);
                    }
                    toRawBytes(t = !0) {
                      return g('isCompressed', t), this.assertValidity(), o(c, this, t);
                    }
                    toHex(t = !0) {
                      return g('isCompressed', t), y(this.toRawBytes(t));
                    }
                  }
                  (c.BASE = new c(r.Gx, r.Gy, n.ONE)), (c.ZERO = new c(n.ZERO, n.ONE, n.ZERO));
                  let p = r.nBitLength,
                    m =
                      ((e = r.endo ? Math.ceil(p / 2) : p),
                      {
                        constTimeNegate: tr,
                        hasPrecomputes: (t) => 1 !== tf(t),
                        unsafeLadder(t, e, r = c.ZERO) {
                          let n = t;
                          for (; e > tt; ) e & te && (r = r.add(n)), (n = n.double()), (e >>= te);
                          return r;
                        },
                        ...
                        wNAF(t, r, n) {
                          let { windows: i, windowSize: o } = ti(t, e),
                            l = c.ZERO,
                            f = c.BASE,
                            s = BigInt(2 ** t - 1),
                            u = 2 ** t,
                          ...
                          for (let t = 0; t < i; t++) {
                            ...
                            let d = e + Math.abs(i) - 1,
                              h = t % 2 != 0,
                              c = i < 0;
                            0 === i ? (f = f.add(tr(h, r[e]))) : (l = l.add(tr(c, r[d])));
                          }
                          return { p: l, f };
                        },
                        wNAFUnsafe(t, r, n, i = c.ZERO) {
                          let { windows: o, windowSize: l } = ti(t, e),
                            f = BigInt(2 ** t - 1),
                            s = 2 ** t,
                            u = BigInt(t);
                          for (let t = 0; t < o; t++) {
                            ...
                            if (n === tt) break;
                            let o = Number(n & f);
                            if (((n >>= u), o > l && ((o -= s), (n += te)), 0 === o)) continue;
                            let a = r[e + Math.abs(o) - 1];
                            o < 0 && (a = a.negate()), (i = i.add(a));
                          }
                          return i;
                        },
                        getPrecomputes(t, e, r) {
                          let n = to.get(e);
                          return (
                            n || ((n = this.precomputeWindow(e, t)), 1 !== t && to.set(e, r(n))), n
                          );
                        },
                        wNAFCached(t, e, r) {
                          let n = tf(t);
                  ...
                  toBytes(t, e, n) {
                    let i = e.toAffine(),
                      o = r.toBytes(i.x),
                      l = O;
                    return (g('isCompressed', n), n)
                      ? l(Uint8Array.from([e.hasEvenY() ? 2 : 3]), o)
                      : l(Uint8Array.from([4]), o, r.toBytes(i.y));
                  },
                  fromBytes(t) {
                    let e = t.length,
                      n = t[0],
                    ...
                    if (e === i && (2 === n || 3 === n)) {
                      let t;
                      let e = v(l);
                      if (!N(e, tp, r.ORDER)) throw Error('Point is not on curve');
                      let i = u(e);
                      try {
                        t = r.sqrt(i);
                      } catch (t) {
                      ...
                      return ((1 & n) == 1) != ((t & tp) === tp) && (t = r.neg(t)), { x: e, y: t };
                    }
                    if (e === o && 4 === n)
                      return {
                ...
                d = (t) => y(S(t, e.nByteLength)),
                c = (t, e, r) => v(t.slice(e, r));
              class p {
                constructor(t, e, r) {
                ...
                static fromCompact(t) {
                  let r = e.nByteLength;
                  return new p(c((t = I('compactSignature', t, 2 * r)), 0, r), c(t, r, 2 * r));
                }
                static fromDER(t) {
                ...
                assertValidity() {
                  R('r', this.r, tp, n), R('s', this.s, tp, n);
                }
                addRecoveryBit(t) {
                ...
                normalizeS() {
                  return this.hasHighS() ? new p(this.r, l(-this.s), this.recovery) : this;
                }
                toDERRawBytes() {
                  return B(this.toDERHex());
                }
                toDERHex() {
                  return tc.hexFromSig({ r: this.r, s: this.s });
                }
                toCompactRawBytes() {
              ...
              let w =
                ...
                b = z(e.nBitLength);
              function q(t) {
                return R('num < 2^' + e.nBitLength, t, tg, b), S(t, e.nByteLength);
              }
              ...
              return (
                f.BASE._setWindowSize(8),
                {
                  ...
                  getSharedSecret: function (t, e, r = !0) {
                    ...
                    return f.fromHex(e).multiply(s(t)).toRawBytes(r);
                  },
                  sign: function (t, i, o = L) {
                    let { seed: u, k2sig: d } = (function (t, i, o = L) {
                      if (['recovered', 'canonical'].some((t) => t in o))
                        throw Error('sign() legacy options not supported');
                      let { hash: u, randomBytes: d } = e,
                        { lowS: h, prehash: c, extraEntropy: g } = o;
                      null == h && (h = !0),
                        (t = I('msgHash', t)),
                        tu(o),
                        c && (t = I('prehashed msgHash', u(t)));
                      let y = E(t),
                        m = s(i),
                        b = [q(m), q(y)];
                      if (null != g && !1 !== g) {
                        let t = !0 === g ? d(r.BYTES) : g;
                        b.push(I('extraEntropy', t));
                      }
                      return {
                        seed: O(...b),
                        k2sig: function (t) {
                          ...
                          let s = l(r * l(y + o * m));
                          if (s === tg) return;
                          let u = (i.x === o ? 0 : 2) | Number(i.y & tp),
                            d = s;
                          if (h && s > n >> tp) (d = s > n >> tp ? l(-s) : s), (u ^= 1);
                          return new p(o, d, u);
                        },
                      };
                    })(t, i, o);
                    return F(e.hash.outputLen, e.nByteLength, e.hmac)(u, d);
                  },
                  verify: function (t, r, i, o = P) {
                    let s, u;
                    (r = I('msgHash', r)), (i = I('publicKey', i));
                    let { lowS: a, prehash: d, format: c } = o;
                    if ((tu(o), 'strict' in o)) throw Error('options.strict was renamed to lowS');
                    ...
                    try {
                      if ((y && (u = new p(t.r, t.s)), g)) {
                        try {
                          'compact' !== c && (u = p.fromDER(t));
                        } catch (t) {
                          if (!(t instanceof tc.Err)) throw t;
                        }
                        u || 'der' === c || (u = p.fromCompact(t));
                      }
                      s = f.fromHex(i);
                    } catch (t) {
                      return !1;
                    }
                    if (!u || (a && u.hasHighS())) return !1;
                    d && (r = e.hash(r));
                    let { r: m, s: w } = u,
                      b = E(r),
                      B = Y(w, n),
                      v = l(b * B),
                      x = l(m * B),
                      S = f.BASE.multiplyAndAddUnsafe(s, v, x)?.toAffine();
                    return !!S && l(S.x) === m;
                  },
                  ProjectivePoint: f,
                  Signature: p,
            ...
            })({ ...t, hash: e, hmac: (t, ...r) => s(e, t, (0, l.eV)(...r)), randomBytes: l.O6 });
          return { ...r(e), create: r };
        })(
          {
            a: BigInt(0),
            ...
            endo: {
              ...
              splitScalar: (t) => {
                let e = BigInt('0x3086d221a7d46bcde86c90e49284eb15'),
                  ...
                  u = f > i,
                  a = s > i;
                if ((u && (f = tw - f), a && (s = tw - s), f > i || s > i))
                  throw Error('splitScalar: Endomorphism failed, k=' + t);
                return { k1neg: u, k1: f, k2neg: a, k2: s };
              },
            },
          },
          i.JQ
        );
      BigInt(0), tx.ProjectivePoint;
    },
  },
]);
