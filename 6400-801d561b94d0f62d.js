  ...
  [6400],
  {
    ...
    69368: function (e, t, n) {
        ...
        z = (0, x.ZP)(l.Z, {
          ...
          overridesResolver: (e, t) => {
            ...
            return [
              ...
              t[`size${(0, h.Z)(n.size)}`],
              'default' !== n.color && t[`color${(0, h.Z)(n.color)}`],
            ];
          },
      ...
      var W = a.forwardRef(function (e, t) {
        ...
        const l = (0, v.i)({ props: e, name: 'MuiCheckbox' }),
          ...
          W = f ? x : p,
          $ = f ? x : d,
          j = (0, o.Z)({}, l, { color: m, indeterminate: f, size: Z }),
          y = ((e) => {
            const { classes: t, indeterminate: n, color: r, size: a } = e,
              i = {
                root: ['root', n && 'indeterminate', `color${(0, h.Z)(r)}`, `size${(0, h.Z)(a)}`],
              },
              c = (0, s.Z)(i, g, t);
            return (0, o.Z)({}, t, c);
          })(j);
        return (0, u.jsx)(
          ...
          (0, o.Z)(
            {
              type: 'checkbox',
              inputProps: (0, o.Z)({ 'data-indeterminate': f }, b),
              icon: a.cloneElement(W, { fontSize: null != (n = W.props.fontSize) ? n : Z }),
              checkedIcon: a.cloneElement($, { fontSize: null != (c = $.props.fontSize) ? c : Z }),
              ownerState: j,
              ref: t,
    ...
    65582: function (e, t, n) {
      ...
      const f = ['className', 'component', 'disableGutters', 'fixed', 'maxWidth', 'classes'],
        ...
        x = (e) => (0, d.Z)({ props: e, name: 'MuiContainer', defaultTheme: h });
      var b = n(98216),
        Z = n(90948),
        w = n(28628);
      const g = (function (e = {}) {
        const {
          ...
          m = a.forwardRef(function (e, t) {
            const a = n(e),
              ...
              Z = (0, r.Z)(a, f),
              w = (0, o.Z)({}, a, { component: h, disableGutters: v, fixed: x, maxWidth: b }),
              g = ((e, t) => {
            ...
            return (0, p.jsx)(
              u,
              (0, o.Z)({ as: h, ownerState: w, className: (0, i.Z)(g.root, m), ref: t }, Z)
            );
          });
        return m;
      })({
