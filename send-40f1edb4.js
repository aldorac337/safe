...
import { n as d, r as c, c as m, U as b, o as K } from './if-defined-5ea4ccf2.js';
import './index-fbd81dd5.js';
import './index-66bb34ae.js';
import { e as D, n as O } from './ref-51923e9b.js';
import { n as G, s as J } from './ConstantsUtil-30faab72.js';
import './index-ac2c30fa.js';
import { S as Q } from './index-f7f5ffdb.js';
import './index-a137b8c5.js';
import './index-e694f2bf.js';
import './index-ce2bc499.js';
...
(function () {
  try {
    ...
    e &&
      ...
      (n._sentryDebugIds[e] = '40b41407-7690-4f53-a59c-f9f3f64d1e6c'),
      (n._sentryDebugIdIdentifier = 'sentry-dbid-40b41407-7690-4f53-a59c-f9f3f64d1e6c'));
  } catch {}
})();
const X = f`
  :host {
...
var E =
  ...
  function (n, e, i, r) {
    var o = arguments.length,
      t = o < 3 ? e : r === null ? (r = Object.getOwnPropertyDescriptor(e, i)) : r,
      s;
    if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
      t = Reflect.decorate(n, e, i, r);
    else
      for (var a = n.length - 1; a >= 0; a--)
        (s = n[a]) && (t = (o < 3 ? s(t) : o > 3 ? s(e, i, t) : s(e, i)) || t);
    return o > 3 && t && Object.defineProperty(e, i, t), t;
  };
let T = class extends w {
  constructor() {
    super(...arguments),
      (this.inputElementRef = D()),
      (this.instructionElementRef = D()),
      (this.instructionHidden = !!this.value),
      (this.pasting = !1),
      (this.onDebouncedSearch = I.debounce(async (e) => {
        if (!e.length) {
        ...
        try {
          const o = await H.getEnsAddress(e);
          if (o) {
            l.setReceiverProfileName(e), l.setReceiverAddress(o);
...
T.styles = X;
E([d()], T.prototype, 'value', void 0);
E([c()], T.prototype, 'instructionHidden', void 0);
E([c()], T.prototype, 'pasting', void 0);
T = E([m('w3m-input-address')], T);
const Z = f`
  :host {
    position: relative;
...
let A = class extends w {
  ...
  render() {
    return (
      this.inputElementRef?.value && this.value && (this.inputElementRef.value.value = this.value),
      u`<input
      ${O(this.inputElementRef)}
      type="text"
      inputmode="decimal"
  ...
  dispatchInputChangeEvent(e) {
    const i = e.data;
    if (i && this.inputElementRef?.value)
      if (i === ',') {
        const r = this.inputElementRef.value.value.replace(',', '.');
        (this.inputElementRef.value.value = r), (this.value = `${this.value}${r}`);
      } else
        G.test(i) ||
          (this.inputElementRef.value.value = this.value.replace(
            new RegExp(i.replace(J, '\\$&'), 'gu'),
            ''
          ));
    this.dispatchEvent(
...
A.styles = [z, W, Z];
_([d({ type: Boolean })], A.prototype, 'disabled', void 0);
_([d({ type: String })], A.prototype, 'value', void 0);
_([d({ type: String })], A.prototype, 'placeholder', void 0);
A = _([m('wui-input-amount')], A);
const ee = f`
  :host {
    width: 100%;
    height: 100px;
...
let R = class extends w {
  ...
  maxAmountTemplate() {
    return this.token
      ? this.sendTokenAmount && this.sendTokenAmount > Number(this.token.quantity.numeric)
        ? u` <wui-text variant="small-400" color="error-100">
  ...
  actionTemplate() {
    return this.token
      ? this.sendTokenAmount && this.sendTokenAmount > Number(this.token.quantity.numeric)
        ? u`<wui-link @click=${this.onBuyClick.bind(this)}>Buy</wui-link>`
        : u`<wui-link @click=${this.onMaxClick.bind(this)}>Max</wui-link>`
      : null;
  }
  onInputChange(e) {
...
R.styles = ee;
V([d({ type: Object })], R.prototype, 'token', void 0);
V([d({ type: Number })], R.prototype, 'sendTokenAmount', void 0);
R = V([m('w3m-input-token')], R);
const te = f`
  :host {
    display: block;
  }
...
let p = class extends w {
  ...
  render() {
    return (
      this.getMessage(),
      u` <wui-flex flexDirection="column" .padding=${['0', 'l', 'l', 'l']}>
  ...
  getMessage() {
    (this.message = 'Preview Send'),
      this.receiverAddress &&
        !I.isAddress(this.receiverAddress, x.state.activeChain) &&
...
p.styles = te;
$([c()], p.prototype, 'token', void 0);
$([c()], p.prototype, 'sendTokenAmount', void 0);
$([c()], p.prototype, 'receiverAddress', void 0);
$([c()], p.prototype, 'receiverProfileName', void 0);
$([c()], p.prototype, 'loading', void 0);
$([c()], p.prototype, 'message', void 0);
p = $([m('w3m-wallet-send-view')], p);
const ie = f`
  .contentContainer {
    height: 440px;
    overflow: scroll;
...
let k = class extends w {
  constructor() {
    super(),
      ...
      (this.search = ''),
      (this.onDebouncedSearch = I.debounce((e) => {
        this.search = e;
      })),
      this.unsubscribe.push(
        l.subscribe((e) => {
  ...
  templateTokens() {
    return (
      (this.tokens = this.tokenBalances?.filter(
        (e) => e.chainId === x.state.activeCaipNetwork?.caipNetworkId
      )),
      this.search
...
k.styles = ie;
P([c()], k.prototype, 'tokenBalances', void 0);
P([c()], k.prototype, 'tokens', void 0);
P([c()], k.prototype, 'filteredTokens', void 0);
P([c()], k.prototype, 'search', void 0);
k = P([m('w3m-wallet-send-select-token-view')], k);
const ne = f`
  :host {
    display: flex;
...
let y = class extends w {
  ...
  imageTemplate() {
    return this.isAddress
      ? u`<wui-avatar address=${this.address} .imageSrc=${this.imageSrc}></wui-avatar>`
      : this.imageSrc
        ? u`<wui-image src=${this.imageSrc}></wui-image>`
        : u`<wui-icon size="inherit" color="fg-200" name="networkPlaceholder"></wui-icon>`;
  }
};
y.styles = [z, W, ne];
N([d()], y.prototype, 'text', void 0);
N([d()], y.prototype, 'address', void 0);
N([d()], y.prototype, 'imageSrc', void 0);
N([d({ type: Boolean })], y.prototype, 'isAddress', void 0);
y = N([m('wui-preview-item')], y);
const re = f`
  :host {
    display: flex;
...
let C = class extends w {
  ...
  templateContent() {
    return this.imageSrc
      ? u`<wui-image src=${this.imageSrc} alt=${this.textTitle}></wui-image>`
      : this.textValue
        ? u` <wui-text variant="paragraph-400" color="fg-100"> ${this.textValue} </wui-text>`
        : u`<wui-icon size="inherit" color="fg-200" name="networkPlaceholder"></wui-icon>`;
  }
};
C.styles = [z, W, re];
j([d()], C.prototype, 'imageSrc', void 0);
j([d()], C.prototype, 'textTitle', void 0);
j([d()], C.prototype, 'textValue', void 0);
C = j([m('wui-list-content')], C);
const oe = f`
  :host {
    display: flex;
    width: auto;
...
S.styles = oe;
U([d()], S.prototype, 'receiverAddress', void 0);
U([d({ type: Object })], S.prototype, 'caipNetwork', void 0);
S = U([m('w3m-wallet-send-details')], S);
const se = f`
  wui-avatar,
  wui-image {
    display: ruby;
...
let h = class extends w {
  constructor() {
    super(),
      ...
      (this.caipNetwork = x.state.activeCaipNetwork),
      (this.loading = l.state.loading),
      this.unsubscribe.push(
        l.subscribe((e) => {
          (this.token = e.token),
  ...
  async onSendClick() {
    ...
    try {
      ...
      B.showError('Failed to send transaction. Please try again.'),
        console.error('SendController:sendToken - failed to send transaction', e);
      const i = x.state.activeChain,
      ...
      F.sendEvent({
        ...
        properties: {
          message: r,
          isSmartAccount: M.state.preferredAccountTypes?.[i] === Y.ACCOUNT_TYPES.SMART_ACCOUNT,
          token: this.token?.symbol || '',
          amount: this.sendTokenAmount,
          network: x.state.activeCaipNetwork?.caipNetworkId || '',
        },
      });
    }
  }
...
h.styles = se;
v([c()], h.prototype, 'token', void 0);
v([c()], h.prototype, 'sendTokenAmount', void 0);
v([c()], h.prototype, 'receiverAddress', void 0);
v([c()], h.prototype, 'receiverProfileName', void 0);
v([c()], h.prototype, 'receiverProfileImageUrl', void 0);
v([c()], h.prototype, 'caipNetwork', void 0);
v([c()], h.prototype, 'loading', void 0);
h = v([m('w3m-wallet-send-preview-view')], h);
export { k as W3mSendSelectTokenView, h as W3mWalletSendPreviewView, p as W3mWalletSendView };
