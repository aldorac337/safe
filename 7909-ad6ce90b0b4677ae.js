try {
  ...
  i &&
    ...
    (e._sentryDebugIds[i] = '615472b6-dc12-42dd-806f-a4bcd4ed08e7'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-615472b6-dc12-42dd-806f-a4bcd4ed08e7'));
} catch (e) {}
('use strict');
  ...
  [7909],
  {
    ...
    4362: function (e, i, n) {
      ...
      let I = (e) => {
        ...
        let { marketId: w, collateralAddress: V, loanAddress: L, initialOperation: U } = e,
          ...
          [eC, eT, , eK] = (0, v._)(ep.data, eu, N, ec),
          eP = (0, C.Z)(eK, null == eT ? void 0 : eT.message),
          eF = (0, a.useMemo)(
      ...
      var t = n(78286),
        ...
        l = (0, a.memo)((e) => {
          let {
            ...
            g = (0, a.useMemo)(() => o.$0l.percent.digits(2).unit('%').of(i, 18), [i]);
          return g
            ? (0, t.tZ)(o.KNv, {
                ...
                (0, t.tZ)(r.J2e.Anchor, {
                  children: (0, t.BX)(p, {
                    children: [
                      ...
                      (0, t.tZ)(v, { children: i({ visible: T, markAsSeen: C }) }),
                    ],
                  }),
                }),
                (0, t.tZ)(r.J2e.Portal, {
    ...
    64219: function (e, i, n) {
      ...
      i.default = (0, a.memo)((e) => {
        ...
        return (0, t.tZ)(p.Z, {
          side: 'top',
          enabled: w && q.featureCallOut && !K && !P,
    ...
    9629: function (e, i, n) {
      ...
      var D = (0, a.memo)(function (e) {
          ...
          let { marketId: l, chainId: B, onClose: x } = e,
            ...
            { initialData: er, finalData: el } = (0, m.Z)(l, T.address, et),
            ed = (0, w.t)({
          ...
          let es = (0, a.useMemo)(
            ...
            ev = (0, f.Z)(T.address, j.data, null == eu ? void 0 : eu.address),
            ep = (0, a.useMemo)(
              () => !!ea || !!eo || !!T.isWrongChain || !(0, v.H)(J),
              [T.isWrongChain, eo, J, ea]
            ),
            eh = (0, g.Z)(ec, T.isWrongChain),
            ...
            eg = (0, a.useMemo)(
              () => (S && I) || !!ec || !!O || !(0, v.H)(J) || T.isWrongChain || !ev,
              [T.isWrongChain, S, ev, I, ec, J, O]
            ),
            ek = (0, a.useCallback)(() => {
              D((0, t.tZ)(s.Z, { operations: [J] }));
            }, [J, D]),
            ef = (0, a.useCallback)(() => {
              _ ? Q() : en && L(J.id, () => J), K(!0), x();
            }, [Q, en, _, x, K, L, J]),
    ...
    32355: function (e, i, n) {
      ...
      var S = (0, a.memo)(function (e) {
          var i, n, l, T;
          let { marketId: K, chainId: F, onClose: D } = e,
            { account: S } = (0, y.Z_)(),
            ...
            } = (0, p.N)(),
            {
              ...
              let i = { ...O, ...e };
              return P.aM(M, i);
            })({ variables: { uniqueKey: K, chainId: F } }),
            {
              isNew: H,
            ...
            } = (0, k.f)(K, { origin: 'position-manager' }),
            [er, el, , ed] = (0, m._)(en.data, et, R, H),
            { initialData: es, finalData: eu } = (0, g.Z)(K, S.address, er),
            ec = (0, B.B9)({
                    ...
                    (0, t.tZ)(x.F, {
                      ...
                      market: {
                        ...
                        dailyNetBorrowApy:
                          null == z
                            ? void 0
                            : null === (T = z.marketByUniqueKey.state) || void 0 === T
                              ? void 0
                              : T.dailyNetBorrowApy,
                      },
                      state: {
    ...
    3883: function (e, i, n) {
      ...
      var D = (0, a.memo)((e) => {
          ...
          let N = (0, a.useMemo)(
            ...
            { initialData: es, finalData: eu } = (0, m.Z)(l, T.address, er),
            ec = (0, b.Z)(ed, null == el ? void 0 : el.message),
            ev = (0, f.Z)(T.address, ee.data, null == N ? void 0 : N.address),
            ep = (0, a.useMemo)(
              () => !!el || !!ed || !ev || !!T.isWrongChain || !(0, v.H)(ei),
              [T.isWrongChain, ev, ed, ei, el]
            ),
            eh = (0, g.Z)(ec, T.isWrongChain),
            { confirmButtonLabel: em, bundlerButtonLabel: ey } = (0, k.Z)({
            ...
            eg = (0, a.useMemo)(
              () => (S && I) || !!ec || !!O || !(0, v.H)(ei) || T.isWrongChain || !ev,
              [T.isWrongChain, S, ev, I, ec, ei, O]
            ),
    ...
    67427: function (e, i, n) {
      ...
      var S = (0, a.memo)((e) => {
          var i, n, l;
          let { marketId: T, chainId: K, onClose: F } = e,
            { account: D } = (0, y.Z_)(),
            ...
            } = (0, p.N)(),
            {
              ...
              let i = { ...O, ...e };
              return P.aM(M, i);
            })({ variables: { uniqueKey: T, chainId: K } }),
            E = (0, Z.t)({
          ...
          let H = (0, s.wk)(null == N ? void 0 : N.marketByUniqueKey.loanAsset),
            ...
            } = (0, k.O)(T, { origin: 'position-manager' }),
            [ed, es, , eu] = (0, m._)(ea.data, eo, W, Y),
            { initialData: ec, finalData: ev } = (0, g.Z)(T, D.address, ed),
          ...
          let C = (0, o.wk)(A.collateralAsset),
            ...
            F = (0, l.isDefined)(
              ...
              ? null === (u = q.state) || void 0 === u
                ...
                : u.borrowAssets
              : null,
            D = (0, l.isDefined)(K) ? K.borrowAssets : void 0,
            ...
            M = (0, l.isDefined)(null == q ? void 0 : q.borrowAssetsUsd)
              ...
              : null,
            S = (0, l.isDefined)(D) ? (null == T ? void 0 : T.toUsd(D)) : void 0,
            I = (0, l.isDefined)(O) ? (null == T ? void 0 : T.toUsd(O)) : void 0,
            V = (0, l.isDefined)(
              ...
              ? null === (v = q.state) || void 0 === v
                ...
                : v.borrowShares
              : null,
            L = (0, l.isDefined)(K) ? K.borrowShares : void 0,
            ...
            $ = (0, l.isDefined)(null == q ? void 0 : q.healthFactor)
              ...
              : null,
            E = (0, l.isDefined)(K) ? K.healthFactor : void 0,
            ...
            G = (0, l.isDefined)(null == q ? void 0 : q.priceVariationToLiquidationPrice)
              ...
              : null,
            Y = (0, l.isDefined)(null == K ? void 0 : K.priceVariationToLiquidationPrice)
              ? K.priceVariationToLiquidationPrice
              : void 0,
            ...
            J =
              (0, l.isDefined)(
                ...
                : null,
            Q = (0, l.isDefined)(K) ? (null == K ? void 0 : K.liquidationPrice) : void 0,
            ...
            ei =
              ...
              void 0 !== b
                ? b
                : null,
            en = (0, l.isDefined)(K) ? (null == K ? void 0 : K.ltv) : void 0,
