      ...
      var n = t(90116),
        ...
        y = function (e) {
          var r = e.value,
            ...
            I = Number(j),
            Z = I >= C.ghoMinDiscountTokenBalanceForDiscount,
                ...
                children: [
                  (0, S.jsxs)(c.Z, {
                    ...
                    children: [
                      (0, S.jsx)(l.Z, {
                        color: 'text.secondary',
                        children: C || (0, S.jsx)(a.cC, { id: 'hehnjM' }),
                      }),
    ...
    99047: function (e, r, t) {
        ...
        he = function (e) {
          ...
          var te = (function () {
                        ...
                        switch ((e.prev = e.next)) {
                          ...
                          case 10:
                            (i = e.sent),
                              ...
                              I({ txHash: le.Z, loading: !1, success: !0 }),
                              (e.next = 29);
                            break;
                          case 15:
                            return (
                          ...
                          case 25:
                            I({ txHash: u.hash, loading: !1, success: !0 }),
                              g(u.hash, {
                          ...
                          case 31:
                            (e.prev = 31),
                              ...
                              E(d),
                              O.success || I({ txHash: void 0, loading: !1 });
                          case 36:
                          case 'end':
                            return e.stop();
                        }
            ...
            be = (0, a.useCallback)(
              ...
              [V, C, b, l.variableDebtTokenAddress, f.addresses.DEBT_SWITCH_ADAPTER, I, t]
            );
          return (
            (0, a.useEffect)(
              function () {
            ...
            (0, k.jsx)(me.B, {
              ...
              requiresApproval: _,
              actionText: (0, k.jsx)(o.cC, { id: 'vH2C/2' }),
              actionInProgressText: (0, k.jsx)(o.cC, { id: 'bSc4Zw' }),
              sx: i,
              fetchingData: d,
              errorParams: {
                loading: !1,
                disabled: p || !(null !== O && void 0 !== O && O.success),
                content: (0, k.jsx)(o.cC, { id: 'vH2C/2' }),
                handleClick: ne,
              },
              blocked: p,
              tryPermit: re,
      ...
      var De = function (e) {
            ...
            be = (function (e) {
              ...
              return (
                (0, a.useEffect)(
                                ...
                                function (e) {
                                  for (;;)
                                    switch ((e.prev = e.next)) {
                                      ...
                                      case 7:
                                        return T(!0), (e.prev = 8), (e.next = 11), I();
                                      case 11:
                                        (r = e.sent),
                                          E(''),
                                          S(r),
                  ...
                  [o, P.underlyingAsset, P.amount, C.underlyingAsset, C.amount, I, n]
                ),
                {
                  outputAmount: f,
                  outputAmountUSD: g,
          ...
          (0, ee.F$)({ symbol: pe.reserve.symbol, currentMarket: P })
            ? (Ce = h.aaveFacilitatorRemainingCapacity.toString())
            : ((Pe =
          ...
          var Ie = N.O.max(N.O.min(Ce, Pe), 0),
            Ze = Number(ve) * Number(r.priceInUSD),
            Ne = Number(fe) * Number(se.priceInUsd),
            Re = Ne - Ze,
            Me = 0 === Number(i.availableBorrowsUSD) || Re > Number(i.availableBorrowsUSD),
            Le = void 0;
          (0, N.O)(fe).gt(Ie) && (Le = ye.INSUFFICIENT_LIQUIDITY);
          var _e = function () {
              ...
              customAction: (0, k.jsxs)(v.Z, {
                ...
                children: [
                  (0, k.jsx)(b.Z, {
                    variant: 'description',
                    color: 'text.primary',
                    children: (0, k.jsx)(o.cC, { id: '+Tzhaj' }),
                  }),
                  (0, k.jsxs)(v.Z, {
                    direction: 'row',
                    alignItems: 'center',
          ...
          return (0, k.jsxs)(k.Fragment, {
            children: [
              ...
              (0, k.jsx)(V.W, {
                ...
                symbol: se.symbol,
                assets: R,
                inputTitle: (0, k.jsx)(o.cC, { id: 'N7dVh7' }),
