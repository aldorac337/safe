try {
  ...
  e &&
    ...
    (n._sentryDebugIds[e] = '61cf1dd1-655d-4bad-917d-ba8ea42ae166'),
    (n._sentryDebugIdIdentifier = 'sentry-dbid-61cf1dd1-655d-4bad-917d-ba8ea42ae166'));
} catch (n) {}
('use strict');
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [2193],
  {
    15328: function (n, e, t) {
      t.d(e, {
        _: function () {
          return l;
        },
      ...
      var r = t(58258);
      function u(n, e) {
        window.dispatchEvent(new StorageEvent('storage', { key: n, newValue: e }));
      }
      let i = (n, e) => {
          let t = JSON.stringify(e);
          window.localStorage.setItem(n, t), u(n, t);
        },
        o = (n) => {
          window.localStorage.removeItem(n), u(n, null);
        },
        a = (n) => window.localStorage.getItem(n),
        c = (n) => (
          window.addEventListener('storage', n), () => window.removeEventListener('storage', n)
        ),
        s = () => {
          throw Error('useLocalStorage is a client-only hook');
        };
      function l(n, e) {
        let t = r.useSyncExternalStore(c, () => a(n), s),
          u = r.useCallback(
            (e) => {
              try {
                let r = 'function' == typeof e ? e(JSON.parse(t)) : e;
                null == r ? o(n) : i(n, r);
              } catch (n) {
                console.warn(n);
              }
    ...
    15642: function (n, e, t) {
      ...
      function d() {
        ...
        let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          y = (0, s.useConfig)(t),
          v = (0, r.NL)(),
          h = (0, c.useChainId)({ config: y }),
          g = null !== (n = t.chainId) && void 0 !== n ? n : h,
          C = (function (n, e = {}) {
            return {
              gcTime: 0,
              async queryFn({ queryKey: e }) {
    ...
    84480: function (n, e, t) {
      ...
      function d() {
        ...
        let d = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          v = (0, l.useConfig)(y),
          h = (0, r.NL)(),
          { address: g, connector: C, status: w } = (0, c.useAccount)({ config: v }),
          I = (0, s.useChainId)({ config: v }),
          p = null !== (n = d.connector) && void 0 !== n ? n : C,
          { queryKey: m, ...b } = (function (n, e = {}) {
            return {
              gcTime: 0,
          ...
          })(v, { ...d, chainId: null !== (e = d.chainId) && void 0 !== e ? e : I, connector: p }),
          q = !!(
            ('connected' === w || ('reconnecting' === w && (null == p ? void 0 : p.getProvider))) &&
        ...
        return (
          (0, o.useEffect)(() => {
            let n = K.current;
            !g && n
              ? (h.removeQueries({ queryKey: m }), (K.current = void 0))
              : g !== n && (h.invalidateQueries({ queryKey: m }), (K.current = g));
          }, [g, h]),
          (0, a.aM)({ ...f, ...b, queryKey: m, enabled: q, staleTime: Number.POSITIVE_INFINITY })
        );
      }
    },
    1318: function (n, e, t) {
    ...
    95715: function (n, e, t) {
      ...
      function s() {
        ...
        let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          v = !!(s && (null === (e = l.enabled) || void 0 === e || e));
        return (0, o.aM)({ ...l, ...y, enabled: v });
      }
    },
    55968: function (n, e, t) {
      ...
      function s() {
        ...
        let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          h = !!(s && l && (null === (e = d.enabled) || void 0 === e || e));
        return (0, o.aM)({ ...d, ...v, enabled: h });
      }
    },
    82405: function (n, e, t) {
      ...
      async function a(n, e = {}) {
        ...
        return {
          formatted: {
            gasPrice: d ? (0, r.b)(d, v) : void 0,
            maxFeePerGas: f ? (0, r.b)(f, v) : void 0,
            maxPriorityFeePerGas: y ? (0, r.b)(y, v) : void 0,
          },
          gasPrice: d,
          maxFeePerGas: f,
          maxPriorityFeePerGas: y,
    ...
    67598: function (n, e, t) {
      ...
      function s() {
        ...
        let s = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          v = null !== (n = s.account) && void 0 !== n ? n : null == y ? void 0 : y.account,
          h = (0, o.useChainId)({ config: f }),
          g = (function (n, e = {}) {
            return {
              async queryFn({ queryKey: t }) {
                let { connector: u } = e,
            ...
            ...s,
            account: v,
            chainId: null !== (e = s.chainId) && void 0 !== e ? e : h,
            connector: l,
          }),
          C = !!((v || l) && (null === (t = d.enabled) || void 0 === t || t));
    ...
    40327: function (n, e, t) {
      ...
      function l() {
        ...
        let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          v = !!(r && u && (null === (e = l.enabled) || void 0 === e || e));
        return (0, a.aM)({ ...l, ...y, enabled: v });
      }
    },
    ...
    68889: function (n, e, t) {
      ...
      function f() {
        ...
        let r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          { abi: u, address: i, connector: f, functionName: y, query: v = {} } = r,
          h = (0, l.useConfig)(r),
          ...
          I = !!(u && i && y && (null === (t = v.enabled) || void 0 === t || t));
        return (0, c.aM)({ ...v, ...w, enabled: I });
      }
    },
      ...
      async function s(n, e) {
        ...
        try {
          ...
          return {
            ...
            name: f.result,
            symbol: y.result,
            totalSupply: { formatted: (0, u.b)(v.result, (0, a.W)(l)), value: v.result },
          };
        } catch (e) {
          if (e instanceof r.uq) {
            let e = { address: t, abi: d('bytes32'), chainId: s },
              [r, f, y, v] = await (0, c.J)(n, {
                allowFailure: !1,
                contracts: [
            ...
            return {
              ...
              totalSupply: { formatted: (0, u.b)(v, (0, a.W)(l)), value: v },
            };
          }
          throw e;
        }
    ...
    17293: function (n, e, t) {
      ...
      function s() {
        ...
        let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          })(v, { ...t, chainId: null !== (n = t.chainId) && void 0 !== n ? n : h }),
    ...
    79686: function (n, e, t) {
      ...
      function s() {
        ...
        let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          h = !!(!(s && l) && (s || l) && (null === (e = d.enabled) || void 0 === e || e));
        return (0, o.aM)({ ...d, ...v, enabled: h });
      }
    },
    9541: function (n, e, t) {
    ...
    36511: function (n, e, t) {
      ...
      function l() {
        ...
        let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          h = !!(r && u && l && (null === (e = d.enabled) || void 0 === e || e));
        return (0, a.aM)({ ...d, ...v, enabled: h });
      }
    },
