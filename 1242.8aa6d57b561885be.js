          ...
          (0, o.Z)(
            {
              ...
              icon: a.cloneElement(C, { fontSize: null != (t = C.props.fontSize) ? t : A }),
              checkedIcon: a.cloneElement(j, { fontSize: null != (u = j.props.fontSize) ? u : A }),
              ownerState: E,
              ref: r,
        ...
        ue = function (e) {
          ...
          return (0, te.jsx)(ie.R, {
            ...
            children: (0, te.jsxs)(v.Z, {
              ...
              children: [
                (0, te.jsx)(y.Z, { children: (0, te.jsx)(o.cC, { id: '2CAPu2' }) }),
                (0, te.jsxs)(v.Z, {
                  ...
                  children: [
                    ...
                    (0, te.jsx)(x.Z, {
                      sx: { fontSize: '14px' },
                      children: (0, te.jsx)(se.Z, { fontSize: '14px' }),
                    }),
      ...
      var ge,
        be = function (e) {
          ...
          var Pe = (We && '0' === Ee) || (ge && Oe),
            ...
            ze = (0, k.IG)(je, ie, fe.reserve.decimals);
          if (B.success) {
            var Ye = Ce,
              Ve = ze;
            return (
          ...
          return (0, te.jsxs)(te.Fragment, {
            children: [
              ...
              void 0 !== Ze &&
                (0, te.jsx)(y.Z, { variant: 'helperText', color: 'error.main', children: Ue }),
              (0, te.jsxs)(H.m6, {
                gasLimit: d,
                slippageSelector: ge
                  ? null
                  ...
                  (0, te.jsx)(L.W, {
                    ...
                    onChange: function (e) {
                      ...
                      (W.current = r ? z.toString(10) : e),
                        S(e),
                        r && z.eq(Y)
                          ? (U(D.vh.MAX_INPUT_SELECTION, { type: 'withdraw' }), I('-1'))
                          : I(z.toString(10));
                    },
                    symbol: c,
                    assets: [
            ...
            children: function (e) {
              return (0, te.jsx)(s.X, {
                children: function (r) {
                  return (0, te.jsxs)(te.Fragment, {
                    children: [
                      T && !p.txHash && (0, te.jsx)(je, { withdrawType: x, setWithdrawType: y }),
                      x === Oe.WITHDRAW &&
