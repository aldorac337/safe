    ...
    96947: function (e, t, r) {
      ...
      function Y(e) {
        ...
        return v.default.createElement(
          ...
          {
            fn: function (e) {
              return Q({ App: W, err: e }).catch(function (e) {
          ...
          D.loadPage('/_error')
            ...
            .then(function (r) {
              ...
              return Promise.resolve(
                (null == (a = e.props) ? void 0 : a.err) ? e.props : P.loadGetInitialProps(t, c)
              ).then(function (t) {
                return ue(d({}, e, { err: n, Component: o, styleSheets: i, props: t }));
              });
            })
        );
      }
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 9:
                      if (
                        ((e.prev = 9), (e.t0 = e.catch(4)), !(r = R.getProperError(e.t0)).cancelled)
                      ) {
                        e.next = 14;
                        break;
                      }
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 37:
                      if (
                        ((V = e.sent),
                        (s = { App: W, initial: !0, Component: z, props: N.props, err: a }),
        ...
        try {
          ...
          if (b.isDynamicRoute(c.pathname) && c.searchParams && r) {
            var l = P.searchParamsToUrlQuery(c.searchParams),
              ...
              p = d.result,
              h = d.params;
            p && (s = j.formatWithValidation({ pathname: p, hash: c.hash, query: F(l, h) }));
          }
                    ...
                    if (
                      ...
                      if (i.startsWith('/')) {
                        var s = x.parseRelativeUrl(i),
                          l = A.getNextPathnameInfo(s.pathname, { nextConfig: n, parseData: !0 }),
                        ...
                        return Promise.all([
                          ...
                          var n = o(t, 2),
                            i = n[0],
                            u = (n[1].__rewrites, k.addLocale(l.pathname, l.locale));
                          if (
                            b.isDynamicRoute(u) ||
                            (!a &&
                              i.includes(
                                y.normalizeLocalePath(M.removeBasePath(u), r.router.locales)
                                  .pathname
                              ))
                          ) {
                            var c = A.getNextPathnameInfo(x.parseRelativeUrl(e).pathname, {
                              parseData: !0,
                            });
                      ...
                      var h = O.parsePath(e),
                        v = T.formatNextPathnameInfo(
                          c(
                            {},
                            A.getNextPathnameInfo(h.pathname, { nextConfig: n, parseData: !0 }),
                      ...
                      if (m.startsWith('/')) {
                        var g = O.parsePath(m),
                          _ = T.formatNextPathnameInfo(
                            c(
                              {},
                              A.getNextPathnameInfo(g.pathname, { nextConfig: n, parseData: !0 }),
                              { defaultLocale: r.router.defaultLocale, buildId: '' }
                            )
                          );
                        return Promise.resolve({
            ...
            n(this, e),
              ...
              (this.onPopState = function (e) {
                ...
                if (r) {
                  ...
                  i.changeState(
                    'replaceState',
                    j.formatWithValidation({ pathname: C.addBasePath(s), query: l }),
                    _.getURL()
                  );
                }
              });
            ...
            if (
              ...
              this._initialMatchesMiddlewarePromise = B({
                ...
                return (
                  ...
                  i.changeState(
                    'replaceState',
                    e ? S : j.formatWithValidation({ pathname: C.addBasePath(t), query: r }),
                    S,
                    w
                  ),
                  e
            ...
            a(e, [
                            ...
                            switch ((i.prev = i.next)) {
                              ...
                              case 3:
                                if (
                                  ...
                                  (m =
                                    ...
                                    O.parsePath(r).pathname === O.parsePath(n).pathname),
                                  (y = c({}, l.state)),
                                  (g = !0 !== l.isReady),
                                  (l.isReady = !0),
                                  (P = l.isSsr),
                              ...
                              case 25:
                                if (
                                  ...
                                  l._inFlightRoute &&
                                    l.clc &&
                                    (P ||
                                      e.events.emit('routeChangeError', D(), l._inFlightRoute, z),
                                    l.clc(),
                                    (l.clc = null)),
                                  (n = C.addBasePath(
                                    k.addLocale(
                              ...
                              case 43:
                                throw (
                                  ...
                                  v.default(i.t0) &&
                                    i.t0.cancelled &&
                                    e.events.emit('routeChangeError', i.t0, V, z),
                                  i.t0)
                                );
                              case 47:
                                return (
                                  e.events.emit('hashChangeComplete', n, z), i.abrupt('return', !0)
                                );
                              case 49:
                                return (
                              ...
                              case 89:
                                if (
                                  ((ne = R.removeLocale(M.removeBasePath(ne), y.locale)),
                              ...
                              case 111:
                                if (
                                  ('route' in (ve = i.sent) &&
                                    ...
                                    ((Y = ve.route || ie),
                                    (ie = Y),
                                    z.shallow || (J = Object.assign({}, ve.query || {}, J)),
                                    (me = L.hasBasePath(X.pathname)
                                    ...
                                    b.isDynamicRoute(Y) &&
                                      ...
                                      (ge = ye),
                                      L.hasBasePath(ge) && (ge = M.removeBasePath(ge)),
                                      (_e = E.getRouteRegex(Y)),
                                      (be = S.getRouteMatcher(_e)(ge)) && Object.assign(J, be))),
                                  !('type' in ve))
                                ) {
                                  i.next = 120;
                                  break;
                              ...
                              case 120:
                                if (
                                  ...
                                  (je = ve.Component) &&
                                    ...
                                    [].concat(je.unstable_scriptLoader()).forEach(function (e) {
                                ...
                                return (
                                  ((ke = x.parseRelativeUrl(Oe)).pathname = Z(ke.pathname, Q)),
                                  (Re = G(l, Oe, Oe)),
                                  (Me = Re.url),
                                  (Ce = Re.as),
                              ...
                              case 150:
                                if (
                                  ...
                                  (Te =
                                    a.shallow && y.route === (null != (Ae = ve.route) ? Ae : ie)),
                                  (Ie = null != (Ne = a.scroll) ? Ne : !a._h && !Te),
                                  (De = Ie ? { x: 0, y: 0 } : null),
                                  (Be = c({}, y, {
                                    route: ie,
                                    pathname: Y,
                                  ...
                                  (qe = null != s ? s : De),
                                  a._h && !qe && !g && !$ && N.compareRouterStates(Be, l.state))
                                ) {
                                  i.next = 169;
                                  break;
                                }
                          ...
                          for (;;)
                            switch ((i.prev = i.next)) {
                              ...
                              case 21:
                                (i.prev = 21),
                                  (i.t0 = i.catch(15)),
                                  console.error('Error in error page `getInitialProps`: ', i.t0),
                                  (h.props = {});
                              case 25:
                                ...
                                return (
                                  ...
                                  i.abrupt(
                                    ...
                                    s.handleRouteInfoError(
                                      v.default(i.t1) ? i.t1 : new Error(i.t1 + ''),
                                      r,
                                      n,
                                      a,
                                      o,
                            ...
                            switch ((e.prev = e.next)) {
                                ...
                                return (
                                  ...
                                  (E = {
                                    dataHref: m.pageLoader.getDataHref({
                                      href: j.formatWithValidation({ pathname: r, query: n }),
                                      skipInterpolation: !0,
                                      asPath: o,
                                      locale: l,
                                    }),
                              ...
                              case 11:
                                if (
                                  ...
                                  P(),
                                  'redirect-internal' !==
                                    (null == O || null == (_ = O.effect) ? void 0 : _.type) &&
                                    'redirect-external' !==
                              ...
                              case 15:
                                if (
                                  'rewrite' !==
                                  (null == O || null == (x = O.effect) ? void 0 : x.type)
                                ) {
                                  e.next = 23;
                                  break;
                                }
                                if (
                                  ((g = d.removeTrailingSlash(O.effect.resolvedHref)),
                                  (r = O.effect.resolvedHref),
                                  (n = c({}, n, O.effect.parsedAs.query)),
                                  (o = M.removeBasePath(
                                    y.normalizeLocalePath(O.effect.parsedAs.pathname, m.locales)
                                      .pathname
                                  )),
                                  (w = m.components[g]),
                              ...
                              case 53:
                                return (
                                  ...
                                  e.abrupt(
                                    'return',
                                    m.handleRouteInfoError(v.getProperError(e.t1), r, n, a, s)
                                  )
                                );
                              case 56:
                              case 'end':
                        ...
                        for (;;)
                          switch ((a.prev = a.next)) {
                            ...
                            case 13:
                              ...
                              return a.abrupt('return');
                            case 18:
                              (l = R.removeLocale(M.removeBasePath(v.asPath), n.locale)),
                                v.matchedPage &&
                                  v.resolvedHref &&
                                  ((u = v.resolvedHref),
                                  (o.pathname = u),
                            ...
                            case 20:
                              (o.pathname = Z(o.pathname, s)),
                                b.isDynamicRoute(o.pathname) &&
                                  ...
                                  Object.assign(
                                    c,
                                    S.getRouteMatcher(E.getRouteRegex(o.pathname))(
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  return (
                    (t.AppTree = n),
                    _.loadGetInitialProps(r, { AppTree: n, Component: e, router: this, ctx: t })
                  );
                },
              },
              {
                  ...
                  (null !== this.slugName &&
                    a.push.apply(
                      ...
                      n(
                        this.children
                          .get('[]')
                          ._smoosh(''.concat(t, '[').concat(this.slugName, ']/'))
                      )
                    ),
                  !this.placeholder)
                ) {
        ...
        var n,
          ...
          w = function (e, t) {
            ...
            l &&
              ...
              s(function () {
                (i = 0), (P = -1), (o = d('CLS', 0)), (n = v(a, o, r, t.reportAllChanges));
              }));
          },
