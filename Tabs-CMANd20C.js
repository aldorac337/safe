import { r as y, j as t, w as D } from './vendor-BCNtwJ5j.js';
import { b2 as I, h as q, f as w, bg as G, a4 as S, a7 as B, a5 as A } from './index-BInJAZZg.js';
(function () {
  try {
    var e =
        typeof window < 'u'
    ...
    a &&
      ...
      (e._sentryDebugIds[a] = 'adca89d9-9f84-4699-a126-b5a2f074543f'),
      (e._sentryDebugIdIdentifier = 'sentry-dbid-adca89d9-9f84-4699-a126-b5a2f074543f'));
  } catch (s) {}
})();
const N = '_metalGreyGradient_orqyv_9',
  ...
  ae = ({
    ...
    const { width: b } = I(),
      ...
      x = () => {
        if (f.current) {
          const { scrollWidth: l, clientWidth: h, scrollLeft: j } = f.current,
            V = l > h,
            k = Math.ceil(j + h) >= l;
          r(V && !k);
        }
  ...
  ne = ({
    ...
    const [c, b] = y.useState(!1),
      { width: v } = I(),
      p = !d || v >= d,
      f = o ? 'calc(100% / '.concat(n.length, ')') : void 0;
    return t.jsx('div', {
      ...
      children: p
        ...
        : t.jsx(S, {
            ...
            children: t.jsx(A, {
              text: ((u = n.find((r) => r.key === e)) == null ? void 0 : u.label) || n[0].label,
...
//# sourceMappingURL=Tabs-CMANd20C.js.map
