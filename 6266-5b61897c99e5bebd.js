try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = '867bf1c1-7392-4aac-a70a-7cce008ce3af'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-867bf1c1-7392-4aac-a70a-7cce008ce3af'));
} catch (e) {}
('use strict');
    ...
    31560: function (e, t, a) {
      ...
      var x = (0, i.memo)((e) => {
          ...
          let { data: a, statuses: n, variant: l = 'default', className: s } = e,
            ...
            { palette: c } = (0, o.rFV)(),
            { theme: u } = (0, o.TCT)(),
            { borderRadius: h, hideXAxis: x, margins: b, hideBorder: f, hideYAxis: v } = m[l],
