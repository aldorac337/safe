(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [887],
  {
    ...
    50887: (t, e, r) => {
          ...
          switch (t) {
            ...
            case 'base64':
              ...
              return (
                ...
                (f = e),
                (u = r),
                0 === f && u === o.length ? n.fromByteArray(o) : n.fromByteArray(o.slice(f, u))
              );
            case 'ucs2':
            case 'ucs-2':
            case 'utf16le':
      ...
      function S(t, e, r) {
        if (Math.floor(t) !== t)
          throw (_(t, r), new R.ERR_OUT_OF_RANGE(r || 'offset', 'an integer', t));
        if (e < 0) throw new R.ERR_BUFFER_OUT_OF_BOUNDS();
        throw new R.ERR_OUT_OF_RANGE(r || 'offset', `>= ${+!!r} and <= ${e}`, t);
      }
      T(
          ...
          function (t, e, r) {
            ...
            return (
              Number.isInteger(r) && Math.abs(r) > 0x100000000
                ...
                : 'bigint' == typeof r &&
                  ((i = String(r)),
                  (r > BigInt(2) ** BigInt(32) || r < -(BigInt(2) ** BigInt(32))) && (i = O(i)),
                  (i += 'n')),
