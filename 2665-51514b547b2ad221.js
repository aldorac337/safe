(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [2665],
  {
    ...
    5743: function (e, a, n) {
      ...
      let s = async (e) =>
          (
            await fetch('https://api-v2.lens.dev/api/v2/', {
              method: 'POST',
              headers: { 'Content-Type': 'application/json', 'User-Agent': 'spectaql' },
              body: JSON.stringify({
          ...
          ).data.ownedHandles.items,
        i = (e) =>
          (0, t.a)({ queryKey: ['getLensHandlesByAddress', e], queryFn: async () => s(e) });
    },
    7182: function (e, a, n) {
      'use strict';
      n.d(a, {
    ...
    71965: function (e, a, n) {
      ...
      let r = (e) => {
        ...
        let { address: v } = e,
          ...
          { data: j } = (0, i._)(v.toHexString()),
          { data: z } = (0, o.S)(),
          I = (0, l.X)().find((e) => e.address === v.toHexString()),
          _ = z.find((e) => e.ethereumAddress.equals(v)),
          S =
            null !==
              (r =
                null !==
            ...
            null !==
              (w =
                null !== (f = null == I ? void 0 : I.color) && void 0 !== f
                  ...
                  : null == _
                    ? void 0
                    : _.metadata.color) && void 0 !== w
              ? w
              : void 0,
          lensHandles:
            null !== (x = null == j ? void 0 : j.map((e) => e.suggestedFormatted.full)) &&
            void 0 !== x
              ? x
              : [],
        };
        ...
        j = (e) => {
          ...
          return (0, t.jsxs)(o.FR, {
            ...
            children: [
              ...
              null == r ? void 0 : r.map((e, a) => (0, t.jsx)(_, { change: e, network: i }, a)),
            ],
          });
        },
        z = (e) => {
