try {
  ...
  e &&
    ...
    (t._sentryDebugIds[e] = 'f3ff3113-1ac9-4f1a-af18-02545784d413'),
    (t._sentryDebugIdIdentifier = 'sentry-dbid-f3ff3113-1ac9-4f1a-af18-02545784d413'));
} catch (t) {}
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [3239],
  {
      ...
      var e = {
        single_source_shortest_paths: function (t, r, n) {
          ...
          for (d.push(r, 0); !d.empty(); )
            for (a in ((i = (o = d.pop()).value), (s = o.cost), (l = t[i] || {})))
              l.hasOwnProperty(a) &&
                ((u = s + l[a]),
                (c = f[a]),
                (void 0 === f[a] || c > u) && ((f[a] = u), d.push(a, u), (h[a] = i)));
          if (void 0 !== n && void 0 === f[n])
            throw Error(['Could not find a path from ', r, ' to ', n, '.'].join(''));
          return h;
        },
      ...
      function s(t, e, r, i, a) {
        ...
        if (u) {
          ...
          return (
            1 === l
              ? ((r = e), (e = i = void 0))
              : 2 !== l || e.getContext || ((i = r), (r = e), (e = void 0)),
    ...
    87039: function (t, e, r) {
      let n = r(42100).getSymbolSize;
    ...
    78607: function (t, e, r) {
      let n = r(28423),
        o = r(82973);
      function i(t) {
        (this.mode = o.BYTE), 'string' == typeof t && (t = n(t)), (this.data = new Uint8Array(t));
      }
      (i.getBitsLength = function (t) {
        return 8 * t;
      }),
          ...
          for (let l = 0; l < e; l++) {
            ...
            for (let u = 0; u < e; u++) {
              ...
              e === a ? o++ : (o >= 5 && (n += r.N1 + (o - 5)), (a = e), (o = 1)),
                (e = t.get(u, l)) === s ? i++ : (i >= 5 && (n += r.N1 + (i - 5)), (s = e), (i = 1));
            }
        ...
        return (
          ...
          (function (t, e, r, o) {
            ...
            if (Array.isArray(t)) d = p.fromArray(t);
              ...
              d = p.fromString(t, n || 40);
            } else throw Error('Invalid data');
            let y = f.getBestVersionForData(d, r);
            ...
            let w = (function (t, e, r) {
                ...
                let a = (n.getSymbolTotalCodewords(t) - c.getTotalCodewordsCount(t, e)) * 8;
                ...
                return (function (t, e, r) {
                  ...
                  let a = n.getSymbolTotalCodewords(e),
                    s = a - c.getTotalCodewordsCount(e, r),
                    l = c.getBlocksCount(e, r),
                    u = a % l,
                    f = l - u,
                    d = Math.floor(a / l),
                    g = Math.floor(s / l),
                  ...
                  let A = new Uint8Array(a),
                    N = 0;
                  for (o = 0; o < b; o++)
                    for (i = 0; i < l; i++) o < E[i].length && (A[N++] = E[i][o]);
                  for (o = 0; o < m; o++) for (i = 0; i < l; i++) A[N++] = v[i][o];
                  return A;
                })(o, t, e);
              })(e, r, d),
              E = new a(n.getSymbolSize(e));
            return (
              (function (t, e) {
                let r = t.size,
                  n = l.getPositions(e);
              ...
              isNaN(o) && (o = u.getBestMask(E, m.bind(null, E, r))),
              u.applyMask(o, E),
              m(E, r, o),
              { modules: E, version: e, errorCorrectionLevel: r, maskPattern: o, segments: d }
            );
          })(t, r, y, d)
        );
      };
    },
    98392: function (t, e, r) {
      let n = r(72549);
      function o(t) {
    ...
    14748: function (t, e, r) {
      ...
      function d(t) {
        let e, r;
        let o = f(l.NUMERIC, n.NUMERIC, t),
          i = f(l.ALPHANUMERIC, n.ALPHANUMERIC, t);
        return (
          u.isKanjiModeEnabled()
            ? ((e = f(l.BYTE, n.BYTE, t)), (r = f(l.KANJI, n.KANJI, t)))
            : ((e = f(l.BYTE_KANJI, n.BYTE, t)), (r = [])),
          o
            .concat(i, e, r)
            .sort(function (t, e) {
      ...
      function p(t, e) {
        ...
        if ((r = n.from(e, l)) !== n.BYTE && r.bit < l.bit)
          throw Error(
            '"' +
              t +
          ...
          let o = (function (t, e) {
              ...
              for (let a = 0; a < t.length; a++) {
                ...
                for (let t = 0; t < s.length; t++) {
                  let u = s[t],
                    c = '' + a + t;
                  l.push(c), (r[c] = { node: u, lastCount: 0 }), (o[c] = {});
                  for (let t = 0; t < i.length; t++) {
                    let a = i[t];
                    r[a] && r[a].node.mode === u.mode
                      ? ((o[a][c] =
                          g(r[a].lastCount + u.length, u.mode) - g(r[a].lastCount, u.mode)),
                        (r[a].lastCount += u.length))
                      : (r[a] && (r[a].lastCount = u.length),
                        (o[a][c] = g(u.length, u.mode) + 4 + n.getCharCountIndicator(u.mode, e)));
                  }
                }
                i = l;
              }
    ...
    33574: function (t, e, r) {
      ...
      e.render = function (t, e, r) {
        let a = n.getOptions(e),
          ...
          u = s + 2 * a.margin,
          c = a.color.light.a
            ? '<path ' + o(a.color.light, 'fill') + ' d="M0 0h' + u + 'v' + u + 'H0z"/>'
            : '',
          h =
            '<path ' +
              ...
              for (let l = 0; l < t.length; l++) {
                ...
                u || a || (a = !0),
                  t[l]
                    ? (s++,
                      (l > 0 && u > 0 && t[l - 1]) ||
                        ((n += a ? i('M', u + r, 0.5 + c + r) : i('m', o, 0)), (o = 0), (a = !1)),
                      (u + 1 < e && t[l + 1]) || ((n += i('h', s)), (s = 0)))
                    : o++;
              }
              return n;
            })(l, s, a.margin) +
          ...
          for (let e = 0; e < s; e++)
            for (let r = 0; r < s; r++) {
              ...
              e >= l &&
                ...
                e < s - l &&
                r < s - l &&
                (h = u[i[Math.floor((e - l) / a) * o + Math.floor((r - l) / a)] ? 1 : 0]),
                (t[c++] = h.r),
                (t[c++] = h.g),
                (t[c++] = h.b),
                (t[c] = h.a);
    ...
    63239: function (t, e, r) {
      ...
      let s = {
        generate({ uri: t, size: e, logoSize: r, dotColor: o = '#141414' }) {
          let s = [],
            l = (function (t, e) {
              let r = Array.prototype.slice.call(
                  i.create(t, { errorCorrectionLevel: 'Q' }).modules.data,
                  0
                ),
                n = Math.sqrt(r.length);
              return r.reduce(
                (t, e, r) => (r % n == 0 ? t.push([e]) : t[t.length - 1].push(e)) && t,
                []
              );
            })(t, 0),
            u = e / l.length,
          ...
          c.forEach(({ x: t, y: e }) => {
            ...
            <rect
              ...
              width=${0 === t ? e - 5 : e}
              rx= ${0 === t ? (e - 5) * 0.45 : 0.45 * e}
              ry= ${0 === t ? (e - 5) * 0.45 : 0.45 * e}
              stroke=${o}
          ...
          return (
            ...
            Object.entries(p)
              .map(([t, e]) => {
                let r = e.filter((t) => e.every((e) => !a(t, e, u)));
                return [Number(t), r];
              })
              .forEach(([t, e]) => {
                e.forEach((e) => {
                  s.push((0, n.YP)`<circle cx=${t} cy=${e} fill=${o} r=${u / 2.5} />`);
                });
              }),
            Object.entries(p)
              .filter(([t, e]) => e.length > 1)
              .map(([t, e]) => {
                let r = e.filter((t) => e.some((e) => a(t, e, u)));
                return [Number(t), r];
              })
              .map(([t, e]) => {
                e.sort((t, e) => (t < e ? -1 : 1));
                let r = [];
                for (let t of e) {
                  let e = r.find((e) => e.some((e) => a(t, e, u)));
                  e ? e.push(t) : r.push([t]);
                }
...
`,
    ...
    `),
            (0, n.dy)`${this.templateVisual()} ${this.templateSvg()}`
          );
        }
        templateSvg() {
    ...
    `;
        ...
        templateVisual() {
          return this.imageSrc
            ? (0, n.dy)`<wui-image src=${this.imageSrc} alt=${this.alt ?? 'logo'}></wui-image>`
            : this.farcaster
              ? (0, n.dy)`<wui-icon
        class="farcaster"
        size="inherit"
      ...
      ></wui-icon>`
              : (0,
                n.dy)`<wui-icon size="inherit" color="inherit" name="walletConnect"></wui-icon>`;
        }
      };
      (f.styles = [l.ET, c]),
        h([(0, o.Cb)()], f.prototype, 'uri', void 0),
        h([(0, o.Cb)({ type: Number })], f.prototype, 'size', void 0),
        h([(0, o.Cb)()], f.prototype, 'theme', void 0),
        h([(0, o.Cb)()], f.prototype, 'imageSrc', void 0),
        h([(0, o.Cb)()], f.prototype, 'alt', void 0),
        h([(0, o.Cb)()], f.prototype, 'color', void 0),
        h([(0, o.Cb)({ type: Boolean })], f.prototype, 'arenaClear', void 0),
        h([(0, o.Cb)({ type: Boolean })], f.prototype, 'farcaster', void 0),
        h([(0, u.M)('wui-qr-code')], f);
    },
    9708: function (t, e, r) {
      'use strict';
      var n = r(98670),
...
`,
      ...
      (u.styles = [i.ET, i.Bp, s]),
        l([(0, o.Cb)()], u.prototype, 'src', void 0),
        l([(0, o.Cb)()], u.prototype, 'alt', void 0),
        l([(0, o.Cb)()], u.prototype, 'size', void 0),
        l([(0, a.M)('wui-image')], u);
    },
  },
]);
