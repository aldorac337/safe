                ...
                f(this, void 0, void 0, function () {
                  ...
                  return h(this, function (h) {
                    switch (h.label) {
                      ...
                      case 1:
                        for (
                          n = h.sent(), r = { results: {}, blockNumber: n.blockNumber }, a = 0;
                          a < n.results.length;
                          a++
                        ) {
                          for (
                            ...
                            if (
                              ((u = o.methodResults[i]),
                              (l = s.calls[u.contractMethodIndex]),
                              (d = this.findOutputTypesFromAbi(s.abi, l.methodName)),
                              !this._options.tryAggregate || u.result.success)
                            )
                              if (d && d.length > 0)
                                try {
                                  (f = m.defaultAbiCoder.decode(
                                    d,
                                    this.getReturnDataFromResult(u.result)
                                  )),
                                    c.callsReturnContext.push(
                                      p.deepClone({
                                        returnValues: this.formatReturnValues(f),
                                        decoded: !0,
              ...
              return f(this, void 0, void 0, function () {
                ...
                return h(this, function (p) {
                  switch (p.label) {
                    case 0:
                      return (
                        (r = this.getTypedOptions().ethersProvider) ||
                          ...
                          (r = a.nodeUrl ? new u.r(a.nodeUrl) : l.getDefaultProvider())),
                        [4, r.getNetwork()]
                      );
                    case 1:
                      return (
                        ...
                        (i = {}),
                        n.blockNumber && (i = d(d({}, i), { blockTag: Number(n.blockNumber) })),
                        this._options.tryAggregate
                          ? [
                              4,
                    ...
                    case 2:
                    case 4:
                      return (m = p.sent()), [2, this.buildUpAggregateResponse(m, t)];
                    case 3:
                      return [
                        4,
