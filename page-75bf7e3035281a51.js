try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = '9b3ff618-f0a1-4378-800c-3c7e8da944cf'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-9b3ff618-f0a1-4378-800c-3c7e8da944cf'));
} catch (e) {}
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [1299, 4916],
  {
    60922: function (e, t, i) {
    ...
    94646: function (e, t, i) {
      ...
      var R = (0, n.memo)((e) => {
        ...
        let { operations: i, headerActionSlot: Z, onConfirm: x } = e,
          ...
          [q] = (0, y.b)(R, i, M),
          F = (0, m.B)(),
          { activeBundle: E, setActiveBundle: K } = (0, b.H)(),
          [I, V] = (0, n.useState)(),
          [L, , , O] = (0, s.$X)(),
          N = X(R, (0, a.Z)(q)),
          {
            hasRiskyPositions: $,
            isRiskyPositionsAcknowledged: U,
          ...
          G = (0, n.useCallback)(() => {
            ...
            if (R && (null == D ? void 0 : D.address))
              try {
                ...
                K(n, i), S(!1), w((0, r.tZ)(A.Z, {}), { closable: !1 });
              } catch (e) {
                V(e);
              }
          }, [D.address, D.isContract, R, i, F, L, x, K, w, S]),
          ...
          J = (0, n.useMemo)(
            ...
            [W, $, U, D.isWrongChain, null == j ? void 0 : j.isAuthorized, E]
          ),
          ee =
            !!E || W || ($ && !U) || D.isWrongChain || !(null == j ? void 0 : j.isAuthorized) || Q;
        return (0, r.BX)(d.Kqy, {
          direction: 'column',
          gap: 20,
    ...
    72008: function (e, t, i) {
      ...
      var r = i(78286),
        ...
        b = i(57892),
        f = i(38819);
      let Z = (0, f.Z)(s.Kqy, { target: 'e6h8rcj0' })('width:100%;'),
        x = (0, f.Z)(s.Kqy, { target: 'e6h8rcj2' })('width:100%;'),
        w = (0, f.Z)(s.Kqy, { target: 'e6h8rcj3' })('flex:1;'),
        k = (0, f.Z)(s.Kqy, { target: 'e6h8rcj4' })(
          'gap:24px;',
          (e) => {
            let { theme: t } = e;
        ...
        P = (0, f.Z)('div', { target: 'e6h8rcj7' })('flex-shrink:0;margin-left:"auto";');
      function C(e) {
        let { address: t } = e;
        return (0, r.tZ)(P, {
      ...
      var T = i(52234),
        S = i(20624);
      let X = (0, f.Z)('div', { target: 'ekhfi8k0' })(
        'background-color:',
        (e) => {
          let { theme: t } = e;
      ...
      var D = (0, n.memo)((e) => {
        ...
        M = (0, n.memo)(
          (0, h.Z)((e) => {
            var t, i, h, f, P, T, S, X, R, M;
            let { address: q, queryResult: F } = e,
              { targetChainId: E } = (0, v.Z_)(),
              K = (0, s.dD4)(),
              ...
              U = (0, n.useMemo)(() => {
                if (!(0, d.isDefined)($.value)) return null;
                let e = N.toUsd($.value),
              ...
              Q = (0, y.M)(q, null == I ? void 0 : I.state, null == I ? void 0 : I.asset),
              Y = (0, s.vmq)({
                chainId: E,
                vaultAddress: q,
                allocation:
                      ...
                      children: [
                        (null == I ? void 0 : I.name)
                          ? (0, r.BX)(k, {
                              wrap: 'wrap',
                              children: [
                                (0, r.tZ)(B, { children: G.first }),
                                (0, r.tZ)(B, { color: 'text.tertiary', children: G.rest }),
                              ],
                            })
                          : (0, r.tZ)(B, { children: (0, d.formatLongString)(q, 16) }),
                        !K && (0, r.tZ)(C, { address: q }),
                      ],
                    }),
                    (0, r.BX)(A, {
                      gap: 'xs',
                        ...
                        (0, r.BX)(s.Kqy, {
                          ...
                          children: [
                            (0, r.tZ)(s.ZT$, {
                              ...
                              children: U ? '$'.concat(U.value) : '-',
                            }),
                            (0, r.tZ)(s.ZT$, {
                              TextVariant: s.xvT.Title.S,
                              color: 'text.tertiary',
                              isSimulated: $.isSimulated,
                              children: null == U ? void 0 : U.unit,
                            }),
                          ],
                        }),
                        (0, r.tZ)(s.ZT$, {
    ...
    55027: function (e, t, i) {
      ...
      let d = function (e) {
        ...
        let $ =
          ...
          U = e.vaultByAddress,
          z = U.chain.id;
        (null !== (k = (d = $.vaults)[(u = U.address)]) && void 0 !== k) ||
          (d[u] = s.Z.getVault(U)),
          (null !== (B = (c = $.users)[(h = U.address)]) && void 0 !== B) ||
            (c[h] = new a.User({ address: U.address, isBundlerAuthorized: !1, morphoNonce: 0n })),
          (null !== (A = (v = $.tokens)[(p = U.asset.address)]) && void 0 !== A) ||
            (v[p] = s.Z.getToken(U.asset)),
          (null !== (P = (m = $.tokens)[(g = U.address)]) && void 0 !== P) ||
            (m[g] = s.Z.getToken({ ...U, decimals: 18 })),
          (null !==
            (T = (f =
              null !== (C = (y = $.holdings)[(b = U.address)]) && void 0 !== C ? C : (y[b] = {}))[
              (Z = U.asset.address)
            ]) &&
            void 0 !== T) ||
            (f[Z] = new a.Holding({
              user: U.address,
              token: U.asset.address,
              balance: 0n,
          ...
          null === (i = U.state) ||
            ...
            t.forEach((e) => {
              ...
              B &&
                ((null !== (y = (t = $.tokens)[(i = B.address)]) && void 0 !== y) ||
                  (t[i] = s.Z.getToken(B))),
                (null !== (b = (r = $.tokens)[(n = A.address)]) && void 0 !== b) ||
                  (r[n] = s.Z.getToken(A));
              let P = s.Z.getVaultMarketAllocation(U.address, e, U.publicAllocatorConfig);
              (P.position.market.lastUpdate = a.MathLib.min(
                P.position.market.lastUpdate,
                $.block.timestamp
              )),
                (null !== (f = (o = $.markets)[(l = P.marketId)]) && void 0 !== f) ||
                  (o[l] = P.position.market),
                (null !==
                  (x = (c =
                    null !== (Z = (d = $.positions)[(u = U.address)]) && void 0 !== Z
                      ? Z
                      : (d[u] = {}))[(h = P.marketId)]) &&
                  void 0 !== x) ||
                  (c[h] = P.position),
                (null !==
                  (k = (m =
                    null !== (w = (v = $.vaultMarketConfigs)[(p = U.address)]) && void 0 !== w
                      ? w
                      : (v[p] = {}))[(g = P.marketId)]) &&
                  void 0 !== k) ||
                  (m[g] = P.config);
        ...
        for (let e of ((null !== (S = (x = $.users)[(w = _.generalAdapter1)]) && void 0 !== S) ||
          (x[w] = new a.User({
        ...
        (0, o.values)($.tokens)))
          e &&
            ((null !==
              (F = (D =
                null !== (q = (X = $.holdings)[(R = _.generalAdapter1)]) && void 0 !== q
                  ? q
                  : (X[R] = {}))[(M = e.address)]) &&
              void 0 !== F) ||
              (D[M] = new a.Holding({
        ...
        for (let e of (0, o.values)($.markets))
          e &&
            ((null !==
              (O = (I =
                null !== (L = (E = $.positions)[(K = _.generalAdapter1)]) && void 0 !== L
                  ? L
                  : (E[K] = {}))[(V = e.id)]) &&
              void 0 !== O) ||
              (I[V] = new a.Position({
          ...
          let { queryVariables: k, queryResult: B, now: C, positionManagerSlot: T } = e,
            ...
            { positions: z } = (0, y.w)({
              existingPositions: (0, l.isDefined)(null == L ? void 0 : L.vaultPosition)
                ...
                : [],
              missingVaults:
                null !== (w = null == U ? void 0 : U.vaults.items) && void 0 !== w ? w : [],
            }),
            _ = (0, n.useMemo)(
              ...
              (0, r.BX)(o.Kqy, {
                ...
                children: [
                  ...
                  (0, r.BX)(o.Kqy, {
                    ...
                    children: [
                      X
                        ? (0, r.tZ)(o.PhF, { options: H, value: F, onChange: E, disabled: !Y })
                        : (0, r.tZ)(u.E, {
                            variant: 'secondary',
    ...
    99095: function (e, t, i) {
      ...
      t.ZP = (0, n.memo)((e) => {
        ...
        let { legacyMorphoHolding: E } = (0, c.gz)();
        (0, n.useEffect)(() => {
          var e;
          R(
            'legacyMorpho',
            !!(
              (null === (e = E.value) || void 0 === e ? void 0 : e.balance) && E.value.balance > 0n
            )
          );
        }, [null === (t = E.value) || void 0 === t ? void 0 : t.balance, R]),
          (0, n.useEffect)(() => {
        ...
        return (0, r.tZ)(p.Provider, { value: K, children: i });
      });
    },
    3918: function (e, t, i) {
      'use strict';
  ...
  function (e) {
    e.O(
      0,
      [
        9913, 1811, 3261, 3173, 3248, 7287, 6929, 3391, 3515, 6489, 4516, 3613, 92, 5328, 8051,
        7233, 5513, 469, 4655, 825, 8205, 9255, 9510, 7923, 6358, 9225, 6269, 8577, 1744,
      ],
      function () {
        return e((e.s = 60922));
      }
