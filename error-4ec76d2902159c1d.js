try {
  ...
  n &&
    ...
    (e._sentryDebugIds[n] = 'af102414-b171-4488-8507-598c2647dad8'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-af102414-b171-4488-8507-598c2647dad8'));
} catch (e) {}
  ...
  [6321],
  {
    ...
    4841: function (e, n, r) {
      ...
      function l(e) {
        ...
        return (
          (0, a.useEffect)(() => {
            console.error('Route error: '.concat(null == n ? void 0 : n.message, ' on ').concat(f)),
