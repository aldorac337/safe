  ...
  [253],
  {
          ...
          (0, n.jsx)(l.m, {
            ...
            children: (0, n.jsx)(i.A, {
              ...
              sx: (e) => ({
                ...
                ...('mui-sm' === c && (0, a.NI)({ width: u.sm, height: u.sm })),
                ...('mui-md' === c && (0, a.NI)({ width: u.md, height: u.md })),
                ...('xl' === c && (0, a.NI)({ width: u.xl, height: u.xl })),
                ...(0, s.Ms)(g, e),
              }),
            }),
          });
    ...
    50654: (e, r, t) => {
          ...
          return (
            (0, i.useEffect)(() => {
              ...
              (A.current = (0, a.R9)(j.current, {
                layout: {
                  background: { type: a.mE.Solid, color: d(f.backgroundColor) },
              ...
              let n = () => {
                  A.current &&
                    ((I.current = A.current.addSeries(a.ti, {
                    ...
                    (R.current = A.current.addSeries(a.ti, {
                ...
                i = () => {
                  A.current &&
                    ((k.current = A.current.addSeries(a.ti, {
                      topColor: f.rangeColorA25,
                      bottomColor: f.rangeColorA25,
                      lineColor: f.rangeColor,
                      lineWidth: 1,
                    ...
                    (S.current = A.current.addSeries(a.ti, {
                      topColor: f.backgroundColor,
                      bottomColor: f.backgroundColor,
                      lineColor: f.rangeColor,
                      lineWidth: 1,
              ...
              l &&
                ...
                r &&
                  !V.current &&
                  (V.current = A.current.addSeries(a.HD, {
                    priceLineStyle: 2,
                    upColor: '#26a69a',
                    downColor: '#ef5350',
                    borderVisible: !1,
                ...
                t &&
                  !z.current &&
                  ((z.current = A.current.addSeries(a.Ej, {
                ...
                o &&
                  !F.current &&
                  (F.current = A.current.addSeries(a.Im, {
            ...
            }, [f.backgroundColor, f.rangeColorA25Old, f.rangeColorOld, x, q, E, w, l, r, o, m, t]),
            (0, i.useEffect)(
              () => (
      ...
      let V = {
        ...
        z = o.Ay.div.withConfig({ componentId: 'sc-d94fcb67-0' })([
          'display:flex;flex-direction:column;',
        ]),
        F = (0, o.Ay)(l.A).withConfig({ componentId: 'sc-d94fcb67-1' })([
        ...
        P = (0, o.Ay)(l.A).withConfig({ componentId: 'sc-d94fcb67-5' })([
        ...
        L = (0, o.Ay)(l.A).withConfig({ componentId: 'sc-d94fcb67-6' })([
