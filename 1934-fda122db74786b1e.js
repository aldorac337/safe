      ...
      let y = { ease: [0, 0, 0.2, 1], duration: 0.15 },
        v = (e) => {
          let {
              ...
              value: m,
              onValueChange: A,
              skipSuccessAnimation: T = !1,
              tone: S = 'primary',
            } = e,
            k = (0, s.useRef)(null),
            g = (0, s.useRef)(null),
            R = (0, s.useId)(),
            [_, D] = (0, s.useState)(null != m ? m : ''),
            [O, K] = (0, s.useState)(!1);
          return (
            (0, s.useEffect)(() => {
              if (E && g.current) {
            ...
            (0, s.useEffect)(() => {
              !w && g.current && 'success' !== h && g.current.focus();
            }, [w, h]),
            (0, s.useEffect)(() => {
              !1 === w && K(!1);
            }, [w]),
                  ...
                  children: [
                    (0, n.jsx)(a.uZ, {
                      ...
                      containerClassName: '\n            '
                        ...
                        .concat(w ? l().loading : '', '\n            ')
                        .concat(O ? l().fullPaste : '', '\n            ')
                        .concat('success' !== h || T ? '' : l().success, '\n            ')
                        .concat(E ? l().error : '', '\n            ')
                        .concat('danger' === S ? l().danger : '', '\n          '),
                      value: _,
                      onChange: (e) =>
                        (function (e) {
                          let t = e.length - _.length;
                          if (t === d.V2) {
                            let t = e.slice(0, _.length),
                              r = window.setInterval(() => {
                                D((t = e.slice(0, t.length + 1))),
                                  t === e && (window.clearInterval(r), null == A || A(t));
                              }, 25);
                            K(!0);
                          } else -1 === t && O ? K(!1) : (D(e), null == A || A(e));
                        })(e),
                      render: (e) => {
                        let { slots: t } = e;
                        return (0, n.jsxs)(n.Fragment, {
                              ...
                              .map((e, t) =>
                                (0, n.jsx)(
                                  p,
                                  {
                                    index: t,
                                    type: f,
                                    inputLength: _.length,
                                    loading: w,
                                    spinnerState: h,
                                    borderToSpinnerLayoutId: R,
                                    fullPaste: O,
                                    error: !!E,
                                    ...e,
                                    isActive: _.length === t,
                            ...
                            (0, n.jsx)(i.M, {
                              children:
                                ...
                                (0, n.jsx)(o.E.div, {
                                  className: l().spinner,
                                  initial: {
                                    x: 'outlined' === I ? -50 : O ? -25 : 0,
                                    opacity: 'outlined' === I || O ? 0 : 1,
                                  },
                                  animate: { x: 'outlined' === I ? -25 : 0, opacity: 1 },
                                  exit: { opacity: 0 },
                                  transition: { ...y, delay: O ? 0.1 : 0 },
                                }),
                            }),
                          ],
                        });
