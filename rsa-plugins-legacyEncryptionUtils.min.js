import { E as t } from './rsa-plugins-common.min.js';
var e, s, r, n, o;
const i =
  (null === (e = 'undefined' != typeof globalThis ? globalThis : void 0) || void 0 === e
    ? void 0
    : e.crypto) ||
  (null === (s = 'undefined' != typeof global ? global : void 0) || void 0 === s
    ? void 0
    : s.crypto) ||
  (null === (r = 'undefined' != typeof window ? window : void 0) || void 0 === r
    ? void 0
    : r.crypto) ||
  (null === (n = 'undefined' != typeof self ? self : void 0) || void 0 === n ? void 0 : n.crypto) ||
  (null === (o = 'undefined' != typeof frames ? frames : void 0) ||
  void 0 === o ||
  null === (o = o[0]) ||
  void 0 === o
    ? void 0
      ...
      const e = [],
        s = (t) => {
          ...
          return () => {
            ...
            let t = ((s << 16) + e) & r;
            return (t /= 4294967296), (t += 0.5), t * (Math.random() > 0.5 ? 1 : -1);
          };
        };
...
class l extends a {
  ...
  concat(t) {
    ...
    else for (let t = 0; t < n; t += 4) e[(r + t) >>> 2] = s[t >>> 2];
...
const h = {
    ...
    parse(t) {
      const e = t.length,
        s = [];
      for (let r = 0; r < e; r += 2)
        s[r >>> 3] |= parseInt(t.substr(r, 2), 16) << (24 - (r % 8) * 4);
      return new l(s, e / 2);
    },
  },
  d = {
...
class u extends a {
  ...
  _process(t) {
    let e;
    const { _data: s, blockSize: r } = this,
      n = s.words,
      o = s.sigBytes;
    let i = o / (4 * r);
...
const _ = {
    stringify(t) {
      ...
      for (let t = 0; t < s; t += 3) {
        ...
        for (let e = 0; e < 4 && t + 0.75 * e < s; e += 1)
          n.push(r.charAt((o >>> (6 * (3 - e))) & 63));
      }
      const o = r.charAt(64);
      if (o) for (; n.length % 4; ) n.push(o);
      return n.join('');
    },
    parse(t) {
      let e = t.length;
      ...
      return ((t, e, s) => {
        ...
        for (let o = 0; o < e; o += 1)
          if (o % 4) {
            const e =
              (s[t.charCodeAt(o - 1)] << ((o % 4) * 2)) |
              (s[t.charCodeAt(o)] >>> (6 - (o % 4) * 2));
...
class v extends f {
  ...
  _doProcessBlock(t, e) {
    ...
    let x = r[0],
      ...
      O = r[3];
    (x = w(x, b, M, O, n, 7, g[0])),
      (O = w(O, x, b, M, o, 12, g[1])),
      (M = w(M, O, x, b, i, 17, g[2])),
      (b = w(b, M, O, x, c, 22, g[3])),
      (x = w(x, b, M, O, a, 7, g[4])),
      (O = w(O, x, b, M, l, 12, g[5])),
      (M = w(M, O, x, b, h, 17, g[6])),
      (b = w(b, M, O, x, d, 22, g[7])),
      (x = w(x, b, M, O, p, 7, g[8])),
      (O = w(O, x, b, M, u, 12, g[9])),
      (M = w(M, O, x, b, f, 17, g[10])),
      (b = w(b, M, O, x, y, 22, g[11])),
      (x = w(x, b, M, O, _, 7, g[12])),
      (O = w(O, x, b, M, v, 12, g[13])),
      (M = w(M, O, x, b, z, 17, g[14])),
      (b = w(b, M, O, x, S, 22, g[15])),
      (x = m(x, b, M, O, o, 5, g[16])),
      (O = m(O, x, b, M, h, 9, g[17])),
      (M = m(M, O, x, b, y, 14, g[18])),
      (b = m(b, M, O, x, n, 20, g[19])),
      (x = m(x, b, M, O, l, 5, g[20])),
      (O = m(O, x, b, M, f, 9, g[21])),
      (M = m(M, O, x, b, S, 14, g[22])),
      (b = m(b, M, O, x, a, 20, g[23])),
      (x = m(x, b, M, O, u, 5, g[24])),
      (O = m(O, x, b, M, z, 9, g[25])),
      (M = m(M, O, x, b, c, 14, g[26])),
      (b = m(b, M, O, x, p, 20, g[27])),
      (x = m(x, b, M, O, v, 5, g[28])),
      (O = m(O, x, b, M, i, 9, g[29])),
      (M = m(M, O, x, b, d, 14, g[30])),
      (b = m(b, M, O, x, _, 20, g[31])),
      (x = k(x, b, M, O, l, 4, g[32])),
      (O = k(O, x, b, M, p, 11, g[33])),
      (M = k(M, O, x, b, y, 16, g[34])),
      (b = k(b, M, O, x, z, 23, g[35])),
      (x = k(x, b, M, O, o, 4, g[36])),
      (O = k(O, x, b, M, a, 11, g[37])),
      (M = k(M, O, x, b, d, 16, g[38])),
      (b = k(b, M, O, x, f, 23, g[39])),
      (x = k(x, b, M, O, v, 4, g[40])),
      (O = k(O, x, b, M, n, 11, g[41])),
      (M = k(M, O, x, b, c, 16, g[42])),
      (b = k(b, M, O, x, h, 23, g[43])),
      (x = k(x, b, M, O, u, 4, g[44])),
      (O = k(O, x, b, M, _, 11, g[45])),
      (M = k(M, O, x, b, S, 16, g[46])),
      (b = k(b, M, O, x, i, 23, g[47])),
      (x = B(x, b, M, O, n, 6, g[48])),
      (O = B(O, x, b, M, d, 10, g[49])),
      (M = B(M, O, x, b, z, 15, g[50])),
      (b = B(b, M, O, x, l, 21, g[51])),
      (x = B(x, b, M, O, _, 6, g[52])),
      (O = B(O, x, b, M, c, 10, g[53])),
      (M = B(M, O, x, b, f, 15, g[54])),
      (b = B(b, M, O, x, o, 21, g[55])),
      (x = B(x, b, M, O, p, 6, g[56])),
      (O = B(O, x, b, M, S, 10, g[57])),
      (M = B(M, O, x, b, h, 15, g[58])),
      (b = B(b, M, O, x, v, 21, g[59])),
      (x = B(x, b, M, O, a, 6, g[60])),
      (O = B(O, x, b, M, y, 10, g[61])),
      (M = B(M, O, x, b, i, 15, g[62])),
      (b = B(b, M, O, x, u, 21, g[63])),
      (r[0] = (r[0] + x) | 0),
      (r[1] = (r[1] + b) | 0),
      (r[2] = (r[2] + M) | 0),
      (r[3] = (r[3] + O) | 0);
...
class z extends a {
  constructor(t) {
    super(), (this.cfg = Object.assign(new a(), { keySize: 4, hasher: v, iterations: 1 }, t));
  }
  compute(t, e) {
    let s;
    const { cfg: r } = this,
...
class R extends x {
  constructor(t, e, s) {
    super(t, e, S({ mode: O, padding: E }, s)), (this.blockSize = 4);
  }
  reset() {
    let t;
    ...
    this._xformMode === this.constructor._ENC_XFORM_MODE
      ...
      (this._mode = t.call(r, this, s && s.words)),
...
const C = {
  ...
  parse(t) {
    ...
    return (
      1398893684 === r[0] &&
        1701076831 === r[1] &&
        ((e = l.create(r.slice(2, 4))), r.splice(0, 4), (s.sigBytes -= 16)),
      A.create({ ciphertext: s, salt: e })
    );
  },
};
class D extends a {
...
const j = {
  execute(t, e, s, r, n) {
    ...
    i || (i = l.random(8)),
      (o = n
        ? z.create({ keySize: e + s, hasher: n }).compute(t, i)
        : z.create({ keySize: e + s }).compute(t, i));
    const c = l.create(o.words.slice(e), 4 * s);
    return (o.sigBytes = 4 * e), A.create({ key: o, iv: c, salt: i });
  },
};
class F extends D {
  static encrypt(t, e, s, r) {
...
for (let t = 0; t < 256; t += 1) {
  ...
  (K[$] = (n << 24) | (n >>> 8)),
    ...
    (X[$] = (n << 8) | (n >>> 24)),
    (H[$] = n),
    (n = (16843009 * r) ^ (65537 * s) ^ (257 * e) ^ (16843008 * $)),
    (N[t] = (n << 24) | (n >>> 8)),
    (T[t] = (n << 16) | (n >>> 16)),
    (L[t] = (n << 8) | (n >>> 24)),
    (V[t] = n),
    $ ? (($ = e ^ W[W[W[r ^ e]]]), (q ^= W[W[q]])) : ((q = 1), ($ = q));
}
...
class J extends R {
    ...
    for (let e = 0; e < n; e += 1) {
      ...
      (t = e % 4 ? o[s] : o[s - 4]),
        (i[e] =
          e < 4 || s <= 4
            ? t
            : N[U[t >>> 24]] ^ T[U[(t >>> 16) & 255]] ^ L[U[(t >>> 8) & 255]] ^ V[U[255 & t]]);
    }
  }
  encryptBlock(t, e) {
  ...
  decryptBlock(t, e) {
    ...
    (s[e + 1] = s[e + 3]),
      (s[e + 3] = r),
      this._doCryptBlock(s, e, this._invKeySchedule, N, T, L, V, I),
      (r = s[e + 1]),
      (s[e + 1] = s[e + 3]),
      (s[e + 3] = r);
  }
  _doCryptBlock(t, e, s, r, n, o, i, c) {
    ...
    const y =
      ((c[h >>> 24] << 24) | (c[(d >>> 16) & 255] << 16) | (c[(p >>> 8) & 255] << 8) | c[255 & u]) ^
      s[f];
    f += 1;
    const _ =
      ((c[d >>> 24] << 24) | (c[(p >>> 16) & 255] << 16) | (c[(u >>> 8) & 255] << 8) | c[255 & h]) ^
      s[f];
    f += 1;
    const g =
      ((c[p >>> 24] << 24) | (c[(u >>> 16) & 255] << 16) | (c[(h >>> 8) & 255] << 8) | c[255 & d]) ^
      s[f];
    f += 1;
    const w =
      ((c[u >>> 24] << 24) | (c[(h >>> 16) & 255] << 16) | (c[(d >>> 8) & 255] << 8) | c[255 & p]) ^
      s[f];
    (f += 1), (a[e] = y), (a[e + 1] = _), (a[e + 2] = g), (a[e + 3] = w);
  }
}
J.keySize = 8;
const Q = R._createHelper(J),
  Y = 'RudderEncrypt:',
  Z = 'Rudder',
  tt = (t) => `${Y}${Q.encrypt(t, Z).toString()}`,
  et = (t) => (t.startsWith(Y) ? Q.decrypt(t.substring(14), Z).toString(p) : t);
export { et as d, tt as e };
