try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = '4e6073b7-7078-4b01-9b89-10fb43e18728'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-4e6073b7-7078-4b01-9b89-10fb43e18728'));
} catch (e) {}
('use strict');
  ...
  [6909, 242, 9286],
  {
              ...
              (0, i.BX)(l.Kqy, {
                ...
                children: [
                  (0, i.BX)(l.Kqy, {
                    ...
                    children: [
                      t
                        ? (0, i.tZ)(l.OdW, { width: '280px', height: '45px', borderRadius: '20px' })
                        : (0, i.tZ)(l.ZT$, {
                            TextVariant: b ? l.xvT.Title.XS : l.xvT.Title.S,
                            children: a,
                          }),
                      (0, i.BX)(l.Kqy, {
                        direction: 'row',
                  ...
                  b && !(0, n.isDefined)(v) && !t && o,
                  (0, n.isDefined)(v) && c,
                ],
              }),
              (0, n.isDefined)(v)
                ? (0, i.tZ)(l.SKT, { height: '500px', text: v })
                : (0, i.BX)(l.Kqy, {
                    direction: 'column',
                    gap: 'm',
                    children: [
                      (0, i.BX)(l.Kqy, {
                        ...
                        children: [
                          d,
                          (0, i.tZ)(l.Z0O, { style: { marginBlock: '3px' } }),
                          (0, i.tZ)(l.Kqy, {
                            fullWidth: !0,
                            gap: 'm',
        ...
        return (0, i.BX)(l.Kqy, {
          ...
          children: [
            ...
            (0, i.BX)(l.Kqy, {
              ...
              gap: 's',
              children: [
                (0, i.tZ)(l.xvT.Title.XS, {
                  textAlign: 'center',
                  children: 'Something went wrong.',
                }),
                (0, i.tZ)(l.xvT.Body.XS.Regular, {
    ...
    88506: function (e, t, a) {
      ...
      var o = a(40252),
        ...
        n = a(22683);
      let s = (e, t, a) => {
        let { account: s } = (0, l.Z_)(),
          { bundlerConfiguration: d } = (0, n.N)(),
          u = {
    ...
    23033: function (e, t, a) {
      ...
      let l = (e, t) => {
        ...
        return {
          operation: l,
          initialState: (0, r.f)(n),
          finalState: (0, r.f)(n + 1),
          isNew: s,
          index: n,
        };
      };
      ...
      t.Z = (e, t, a) =>
        (0, o.useMemo)(() => {
          ...
          let [l, n] = a,
            ...
            u = l.tryGetAccrualPosition(t, e),
            p = null == n ? void 0 : n.tryGetAccrualPosition(t, e);
          return {
            initialData: {
    ...
    91622: function (e, t, a) {
      ...
      let c = (e, t, a) => {
        ...
        return (0, o.useMemo)(() => {
          ...
          let l = t.tryGetAccrualPosition(i.address, e),
            n = null == l ? void 0 : l.market;
          if (!n) return;
          ...
          let d =
            null == n
              ? void 0
              : n.getRepayCapacityLimit(
                  null !== (o = null == l ? void 0 : l.borrowShares) && void 0 !== o ? o : 0n,
                  s
                );
          return d.limiter === r.CapacityLimitReason.position
            ? { assets: d.value, shares: l.borrowShares }
      ...
      let f = (e, t, a, o) => {
        let { account: i } = (0, u.Z_)(),
          n = t && i.address && t.tryGetAccrualPosition(i.address, e),
          s = null == n ? void 0 : n.market,
        ...
        let p = o || s.toBorrowShares(a),
          c = s.getWithdrawCollateralCapacityLimit(
            { borrowShares: n.borrowShares - p, collateral: n.collateral },
            { maxLtv: r.MathLib.wMulDown(d, l.JC) }
          );
      ...
      let b = function (e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          [O, , , D, P] = (0, l.$X)(v.options.disabledPeripheralTokens),
          E = (0, o.useMemo)(() => {
            var t;
          ...
          R = (0, o.useMemo)(() => {
            ...
            if (l)
              return (0, n.values)(l.allocations)
                .filter(n.isDefined)
        ...
        return (
          ...
          (0, o.useEffect)(() => {
            z ||
              ('bundler' !== v.options.origin && K(v.collateralAssets > 0n), k(v.collateralAssets));
          ...
          (0, o.useEffect)(() => {
            z || G || P(v.options.disabledPeripheralTokens);
          }, [z, G, v.options.disabledPeripheralTokens, P]),
          (0, o.useEffect)(() => {
            if (G || z) return;
    ...
    18721: function (e, t, a) {
      ...
      let v = (e, t, a) => {
        ...
        return (0, o.useMemo)(() => {
          ...
          if (!o) return;
          let l = t.getBundleMaxBalance(
            i.address,
            o.params.collateralToken,
            r.DEFAULT_SLIPPAGE_TOLERANCE,
            a
          );
          if (void 0 !== l) return { assets: l, shares: 0n };
        }, [i.address, t, e, a]);
      };
      var f = a(23033),
        h = a(77458);
      let y = function (e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          [O, D] = (0, o.useState)(y.options.isMax.includes(d.H.InterfaceOperationType.borrow)),
          [P, , , E, Z] = (0, l.$X)(y.options.disabledPeripheralTokens),
          B = v(e, null == b ? void 0 : b.data, P),
          ...
          L = (0, o.useMemo)(() => {
            ...
            return t || a || o;
          }, [g, P, S, y.collateralAssets, y.options.disabledPeripheralTokens, y.options.isMax]),
          R = (0, o.useMemo)(() => {
          ...
          q = (0, o.useMemo)(
            () => ({
              ...
              options: {
                ...
                disabledPeripheralTokens: P,
              },
            }),
            [e, g, x, y.id, t.origin, S, O, P]
          ),
          ...
          }, [a.address, P, null == b ? void 0 : b.data, e]),
          G = 'position-manager' === t.origin,
          [N, X] = (0, o.useState)(m || G),
          [K, W] = (0, o.useState)(m || G),
          F = (0, o.useCallback)((e) => {
            I(!1), k(e);
          }, []),
          V = (0, o.useCallback)((e) => {
        ...
        return (
          ...
          (0, o.useEffect)(() => {
            K || ('bundler' !== y.options.origin && T(y.loanAssets > 0n), C(y.loanAssets));
          }, [K, y.loanAssets, y.loanShares, y.options.origin]),
          (0, o.useEffect)(() => {
            ee(S);
          }, [S, ee]),
          (0, o.useEffect)(() => {
          ...
          (0, o.useEffect)(() => {
            K || N || Z(y.options.disabledPeripheralTokens);
          }, [K, N, y.options.disabledPeripheralTokens, Z]),
          (0, o.useEffect)(() => {
            if (K || N) return;
      ...
      let y = (e) => {
          let { marketFrom: t, marketTo: a, operationId: i } = e,
            ...
            { operations: l } = (0, d.N)(),
            {
              ...
              let e = l.findIndex((e) => e.type === p.H.InterfaceOperationType.zap && e.id === i);
              if (!(0, s.isDefined)(a))
                return {
              ...
              if (e >= 0) return { index: e, operation: l[e], isNew: !1 };
              let o = {
                id: crypto.randomUUID(),
              ...
              return { isNew: !0, index: l.length, operation: o, isLoading: !1 };
            }, [t, a, l, r, i]);
          return {
            operation: n,
        ...
        m = (e) => {
          ...
          let { marketFrom: x, marketTo: C, initialOperation: S, options: I } = e,
            { account: O, targetChainId: D } = (0, v.Z_)(),
            { updateOperation: P } = (0, d.N)(),
            ...
            Q = (0, o.useMemo)(() => {
              ...
              return V.liquidity + l.MathLib.wDivDown(e, l.MathLib.WAD + b);
            }, [J, V]),
            Y = (0, o.useMemo)(() => {
                ...
                ? {
                    ...
                    options: {
                      isMax: [
                        ...
                        ...(W ? [p.H.InterfaceOperationType.zap] : []),
                      ],
            ...
            }, [R, z, G, W, X, null == Z ? void 0 : Z.id, x, C, D]),
            ...
            ei = (0, o.useCallback)(
              (e) => {
                e && (null == $ ? void 0 : $.collateral) && q($.collateral), K(e);
              },
          ...
          return (
            (0, o.useEffect)(() => {
              (null == I ? void 0 : I.autoConfirm) && el();
            }, [null == I ? void 0 : I.autoConfirm, el]),
            {
              index: L,
              isNew: _,
