import { R as c, dh as O, aX as N, di as I, bz as w } from './vendor-S4AjIOSE.js';
(function () {
  try {
    var s =
        typeof window < 'u'
    ...
    a &&
      ...
      (s._sentryDebugIds[a] = '953ba5aa-4622-4214-8735-38a4e07dadf9'),
      (s._sentryDebugIdIdentifier = 'sentry-dbid-953ba5aa-4622-4214-8735-38a4e07dadf9'));
  } catch (u) {}
})();
function P(s, a) {
  return s.classList
...
export { M as C, $ as S };
//# sourceMappingURL=SwitchTransition-BJInJwTQ.js.map
