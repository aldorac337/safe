  ...
  [104],
  {
    1334: (e, t, r) => {
      ...
      var l = r(54568),
        ...
        v = r(87401),
        w = r(36074);
      let b = ({ isBeta: e, setIsBeta: t, open: r, openBetaSnackbar: s, onClose: n }) =>
        (0, l.jsx)(m.A, {
          open: r,
          onClose: n,
            ...
            children: [
              (0, l.jsx)(g.A, {
                ...
                title: (0, l.jsx)(v.A, {
                  ...
                  color: 'textSecondary',
                  children: e ? (0, w.t)`Disable Beta Features` : (0, w.t)`Enable Beta Features`,
                }),
              }),
              (0, l.jsx)(x.A, {
                sx: {
                ...
                children: [
                  (0,
                  w.t)`Get early access to upcoming features and UI experiments before they go live.`,
                  (0,
                  w.t)`These are work-in-progress tools meant for testing, feedback, and iteration. You might experience minor bugs or visual inconsistencies — but your funds remain safe, and core functionality is unaffected.`,
                  (0,
                  w.t)`By enabling beta mode, you help shape the future of the Curve interface.`,
                  (0, w.t)`You can turn this off at any time.`,
                ].map((e) => (0, l.jsx)(v.A, { color: 'textSecondary', children: e }, e)),
              }),
              (0, l.jsx)(p.A, {
      ...
      var L = r(24388),
        ...
        D = r(15984),
        y = r(72415);
      let B = ({ isBeta: e, open: t, onClose: r, headerHeight: s }) =>
        (0, l.jsx)(D.A, {
          open: t,
          onClose: r,
          autoHideDuration: y.dw.Snackbar,
          ...
          children: (0, l.jsxs)(L.A, {
            ...
            children: [
              (0, l.jsx)(j.A, {
                children: e ? (0, w.t)`Beta Features On` : (0, w.t)`Beta Features Off`,
              }),
              e
                ? (0, w.t)`You have successfully enabled beta features.`
                : (0, w.t)`You have successfully disabled beta features.`,
            ],
          }),
        });
      var Q = r(51121),
        H = r(26055);
      let { IconSize: M, Spacing: Z, FontWeight: U } = C.B,
        k = () =>
          (0, l.jsxs)(s.A, {
            ...
            children: [
              (0, l.jsxs)(Q.A, {
                href: '/',
                sx: { display: 'flex', alignItems: 'center', textDecoration: 'none', gap: Z.xs },
                children: [
                  (0, l.jsx)(H.A, {
                    sx: { width: M.xxl, height: M.xxl, margin: Z.sm },
                    children: (0, l.jsx)(o.$J, {}),
                  }),
                  (0, l.jsx)(v.A, {
                    color: 'textPrimary',
                    sx: { '&': { fontSize: y.XQ[600] }, fontWeight: U.Bold },
                    children: 'Curve',
                  }),
                ],
              }),
              (0, l.jsx)(v.A, {
                ...
                sx: { textWrap: 'balance' },
                children: (0,
                w.t)`Curve DAO is building the software that powers the future world economy: decentralised, trustless, inclusive and autonomous.`,
              }),
            ],
          });
      var V = r(27261),
        O = r.n(V);
      let P = ({ label: e, href: t, icon: r, target: s = '_blank', appName: n, networkId: i }) =>
          (0, l.jsx)(h.A, {
            ...(t.startsWith('http')
              ? { component: Q.A, href: t, target: s, rel: 'noreferrer' }
              : { component: O(), href: `/${n}/${i}/${t}` }),
            color: 'ghost',
            variant: 'link',
            startIcon: r,
            children: e,
          }),
        S = ({ title: e, links: t, networkId: r, appName: s, isTiny: i }) =>
          (0, l.jsxs)(n.A, {
            container: !0,
            spacing: 1,
            children: [
              ...
              t.map((e) =>
                (0, l.jsx)(
                  n.A,
                  {
                    ...
                    children: (0, l.jsx)(P, { ...e, appName: s, networkId: r }),
                  },
                  e.href
                )
              ),
      ...
      let q = (0, J.A)(
        ...
        el = (e) => [
          {
            ...
            links: [
              ...
              {
                label: (0, w.t)`Announcements`,
                href: 'https://t.me/curvefiann',
                icon: (0, l.jsx)(ee, {}),
              },
              { label: (0, w.t)`Telegram`, href: 'https://t.me/curvefi', icon: (0, l.jsx)(ee, {}) },
              {
                label: (0, w.t)`Telegram (CN)`,
                href: 'https://t.me/curveficn',
                icon: (0, l.jsx)($, {}),
              },
              {
                label: (0, w.t)`Telegram (RU)`,
          ...
          },
          {
            ...
            links: [
              ...
              {
                label: (0, w.t)`User Docs`,
                href: 'https://resources.curve.finance/',
                icon: (0, l.jsx)(E.A, {}),
              },
              { label: (0, w.t)`Integrations`, href: 'integrations/', icon: (0, l.jsx)(Y, {}) },
              {
                label: (0, w.t)`Technical Docs`,
          ...
          },
          {
            ...
            links: [
              ...
              {
                label: (0, w.t)`Bug Bounty`,
                href: 'https://docs.curve.finance/security/security/#bug-bounty',
                icon: (0, l.jsx)(z.A, {}),
              },
              {
                label: (0, w.t)`Curve Monitor`,
                href: 'https://curvemonitor.com/',
                icon: (0, l.jsx)(F, {}),
              },
              { label: (0, w.t)`CrvHub`, href: 'https://crvhub.com/', icon: (0, l.jsx)(K, {}) },
              {
                label: (0, w.t)`Dune Analytics`,
                href: 'https://dune.com/mrblock_buidl/Curve.fi',
                icon: (0, l.jsx)(G, {}),
              },
              {
                label: (0, w.t)`API Status`,
        ...
        es = o.NC.src,
        en = (0, i.Ay)('img')({ alt: 'Llama', position: 'absolute' }),
        ei = ({ appName: e, networkId: t, headerHeight: r }) => {
          ...
          return (0, l.jsx)(s.A, {
            ...
            children: (0, l.jsxs)(n.A, {
              ...
              children: [
                (0, l.jsx)(n.A, { size: { mobile: 12, desktop: 3 }, children: (0, l.jsx)(k, {}) }),
                el(e).map((r) =>
                  (0, l.jsx)(
                    n.A,
                    {
                      size: { mobile: 12, tablet: 4, desktop: 3 },
                      children: (0, l.jsx)(S, { ...r, networkId: t, appName: e, isTiny: m }),
                    },
                    r.title
                  )
                ),
                ...
                null != h && (0, l.jsx)(B, { open: h, onClose: p, headerHeight: r, isBeta: x }),
              ],
            }),
          });
        };
    ...
    86895: (e, t, r) => {
      ...
      let N = (0, d.x)({
        ...
        E = (0, d.x)({
          ...
          name: 'MEGA Testnet',
          testnet: !0,
          nativeCurrency: S.r.nativeCurrency,
        ...
        T = (0, d.x)({
          ...
          rpcUrls: {
            default: { http: ['https://stratareth3666f0713.devnet-annapurna.stratabtc.org'] },
          },
          blockExplorers: {
            default: {
      ...
      let W = { 2390: 8 },
        _ = C()(
          (e) => {
            let t = Object.fromEntries(J.map((e) => [e.id, e])),
            ...
            return (0, X.Z)({
              chains: r.map(([e, r]) => {
                ...
                return (0, d.x)({
                  id: e,
                  testnet: r.isTestnet,
                  nativeCurrency: { name: r.symbol, symbol: r.symbol, decimals: W[e] ?? 18 },
                  ...l,
                  name: r.name,
                  rpcUrls: {
                    default: { http: A()([r.rpcUrl, ...(l?.rpcUrls.default.http ?? [])]) },
                  },
                  ...(r.explorerUrl && {
                    blockExplorers: {
              ...
              connectors: Object.values(F.t),
              transports: Object.fromEntries(
                r.map(([e]) => [
                  e,
                  (0, q.N)([(0, G.l)(K.b), (0, Y.L)(void 0, { batch: { batchSize: 3 } })]),
                ])
              ),
      ...
      var $ = r(75911),
        ...
        el = r(82099),
        es = r(54152);
      function en({ children: e, persister: t, queryClient: r }) {
        return ((e = (0, l.jsxs)(l.Fragment, { children: [e, !et.OC && (0, l.jsx)(el.E, {})] })), t)
          ? (0, l.jsx)(es.t, { client: r, persistOptions: { persister: t }, children: e })
          : (0, l.jsx)(er.QueryClientProvider, { client: r, children: e });
      }
      var ei = r(74043),
        eo = r(41265);
      let ea = ({ children: e, loading: t, networks: r }) => {
        let a = (0, $.nv)((e) => e.theme),
          A = (0, s.useMemo)(() => !t && _(r), [r, t]);
        return (0, l.jsxs)('div', {
          ...
          children: [
            ...
            (0, l.jsx)(ei.NP, {
              theme: a,
              children: (0, l.jsx)(o.so, {
                children: (0, l.jsx)(en, {
                  persister: ee.a,
                  queryClient: ee.q,
                  children: A && (0, l.jsx)(n.x, { config: A, children: e }),
                }),
              }),
            }),
          ],
