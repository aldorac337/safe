try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = 'd6565e76-b706-4d0a-a4ce-9e3cf351c68c'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-d6565e76-b706-4d0a-a4ce-9e3cf351c68c'));
} catch (e) {}
('use strict');
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [7567],
  {
    94646: function (e, t, n) {
      ...
      var T = n(35047);
      let B = (e, t) => {
        let { account: n, targetChainId: r } = (0, H.Z_)();
        return (0, i.useMemo)(() => {
            ...
            ? (0, T.values)(t.tokens)
                ...
                .map((n) => {
                  ...
                  let a = e.getBundleBalance(i, n.address),
                    s = t.getBundleBalance(i, n.address);
      ...
      var A = (0, i.memo)((e) => {
        ...
        let { operations: n, headerActionSlot: Z, onConfirm: V } = e,
          ...
          [O] = (0, f.b)(A, n, D),
          P = (0, y.B)(),
          { activeBundle: R, setActiveBundle: I } = (0, g.H)(),
          [S, _] = (0, i.useState)(),
          [z, , , E] = (0, l.$X)(),
          W = B(A, (0, a.Z)(O)),
          {
          ...
          G = (0, i.useCallback)(() => {
            ...
            if (A && (null == X ? void 0 : X.address))
              try {
                let e = (0, m.b)(n, A, X.address, P, X.isContract),
                  ...
                  i = (0, s.encodeBundle)(t, A, !X.isContract);
                I(i, n), T(!1), b((0, r.tZ)(v.Z, {}), { closable: !1 });
              } catch (e) {
                _(e);
              }
          }, [X.address, X.isContract, A, n, P, z, V, I, b, T]),
          { value: j, loading: J } = k(null == X ? void 0 : X.address),
          Y = (0, i.useMemo)(
            () =>
              n.some(
                (e) =>
          ...
          Q = (0, i.useMemo)(
            ...
            [$, q, F, X.isWrongChain, null == j ? void 0 : j.isAuthorized, R]
          ),
          ee =
            !!R || $ || (q && !F) || X.isWrongChain || !(null == j ? void 0 : j.isAuthorized) || J;
        return (0, r.BX)(d.Kqy, {
          direction: 'column',
          gap: 20,
      ...
      var r = n(94646),
        ...
        Z = (0, a.memo)((e) => {
          let {} = e,
            ...
            { account: n, targetChainId: r } = (0, h.Z_)(),
            {
            ...
            M = (0, f.g)(y.rr.legacyMorphoToken),
            v = (0, a.useMemo)(() => {
              if (!n.address) return;
              let e = n.address;
              if (Z && n.address) {
                let t = Z.flatMap((t) => {
                  ...
                  a = k[y.rr.legacyMorphoToken];
                if (a && M.value) {
                  let o = (0, m.S)({
                    amount: a,
                    userAddress: e,
                    supportsSignatures: !n.isContract,
                    bundlerAllowance: M.value.erc20Allowances['bundler3.generalAdapter1'],
                    erc2612Nonce: M.value.erc2612Nonce,
                    chainId: r,
                  });
                  o &&
                    (t.push(...o.actions),
            ...
            }, [n.address, n.isContract, Z, k, M, r]),
            L = !!V || n.isWrongChain,
            x = (0, a.useCallback)(() => {
              v &&
                (b(v, [
          ...
          return (0, i.BX)(s.Kqy, {
            ...
            children: [
              (0, i.BX)(s.Kqy, {
                ...
                gap: 16,
                children: [
                  (0, i.tZ)(s.xvT.Title.S, { children: 'Review' }),
                  (0, i.tZ)(s.zxk, {
                    iconAlone: 'ClosePlain20',
                    onClick: () => t(!1),
                    variant: 'secondary',
              ...
              (0, i.BX)(u.Z, {
                ...
                children: [
                  (0, i.tZ)(g.F, {
                    children: (0, i.tZ)(H.Z, { mode: 'Review', rewardMode: 'MORPHO' }),
                  }),
                  (0, i.tZ)(s._Lo, {
                    onClick: x,
                    height: 47,
        ...
        let {} = e,
          ...
          Z = (0, a.useMemo)(() => {
            ...
            let e = new o.ActionBundleRequirements(),
              ...
              a = [];
            for (let e of y)
              e.token && (t.push(e.token.address), i.push(BigInt(e.amount)), a.push(e.proofs));
            let s = t.length;
            if (i.length != s || a.length != s)
              throw Error('Invalid arguments, must have same length');
            let l = new o.ActionBundle(r, [], e);
            return (
              (l.tx = () => ({
                to: b.FW.getMerklAddress(r),
                data: (0, V.R)({
                  abi: k,
                  functionName: 'claim',
                  args: [Array(s).fill(n.address), t, i, a],
                }),
                value: 0n,
              })),
              l
        ...
        return (0, i.BX)(s.Kqy, {
          ...
          children: [
            ...
            (0, i.BX)(u.Z, {
              ...
              children: [
                (0, i.tZ)(g.F, {
                  children: (0, i.tZ)(H.Z, { mode: 'Review', rewardMode: 'MERKL' }),
                }),
    ...
    47567: function (e, t, n) {
      ...
      let d = (e) => {
        let [t, n] = (0, i.useState)(!1),
          ...
          o = (0, i.useCallback)(
            (n) => {
              n.preventDefault(), t && (r || (0, s.aM)(e), a());
            },
            [r, t, e, a]
          );
        return {
      ...
      let p = (0, c.Z)('div', { target: 'e1fucke70' })(
        ...
        k = (0, c.Z)(o.xvT.Body.L.Regular, { target: 'e1fucke711' })(
          'color:',
          (e) => {
            let { theme: t } = e;
            return t.colors.text.primary;
        ...
        A = (0, c.Z)('form', { target: 'e1fucke718' })(
      ...
      function z(e) {
        let { transform: t, rotation: n, fill: i, stroke: a = S.colors.half } = e;
        return (0, r.tZ)('g', {
          stroke: a,
          strokeWidth: '0.75',
          strokeMiterlimit: '10',
      ...
      function E(e) {
        let { selected: t, fillColor: n } = e,
          i = t ? S.opacities.full : S.opacities.hidden;
        return (0, r.BX)('g', {
          fill: n,
          opacity: i,
          style: S.transitions,
              ...
              children: [
                (0, r.BX)('g', {
                  children: [
                    ...
                    (0, r.tZ)(E, { selected: 0 === o, fillColor: 0 === o ? S.colors.full : d }),
                  ],
                }),
                (0, r.BX)('g', {
                  children: [
      ...
      var J = (0, i.memo)(
        (0, i.forwardRef)(function (e, t) {
          ...
          return (0, r.BX)('svg', {
            ...
            children: [
              (0, r.BX)('g', {
                opacity: 0 === o ? j.opacities.full : j.opacities.hidden,
                style: j.transitions,
                children: [
                  (0, r.tZ)('path', {
                  ...
                  (0, r.tZ)('path', {
                    d: 'M276 66L117 66',
                    stroke: d,
                    strokeWidth: j.labels.dashWidth,
                    strokeLinecap: 'round',
                  }),
                ],
              }),
              ...
              (0, r.BX)('g', {
                opacity: 0 === o || 1 === o ? j.opacities.full : j.opacities.hidden,
                style: j.transitions,
                children: [
                  (0, r.tZ)('path', {
              ...
              (0, r.BX)('g', {
                opacity: 2 === o ? j.opacities.full : j.opacities.hidden,
                style: j.transitions,
              ...
              (0, r.BX)('g', {
                opacity: 1 === o ? j.opacities.full : j.opacities.hidden,
                style: j.transitions,
                children: [
                  (0, r.tZ)('path', {
              ...
              (0, r.tZ)('circle', { fill: s, r: '57', transform: 'translate(268 820)' }),
              (0, r.tZ)('circle', { fill: s, r: '57', transform: 'translate(76 820)' }),
              (0, r.tZ)('circle', { fill: s, r: '57', transform: 'translate(460 820)' }),
              (0, r.tZ)('circle', { fill: s, r: '46', transform: 'translate(268 1138)' }),
              (0, r.tZ)('circle', { fill: s, r: '40', transform: 'translate(268 1303)' }),
              (0, r.BX)('g', {
                opacity: 0 === o ? j.opacities.full : j.opacities.hidden,
                style: j.transitions,
                children: [
              ...
              (0, r.BX)('g', {
                opacity: 1 === o || 2 === o ? j.opacities.full : j.opacities.hidden,
                style: j.transitions,
                children: [
                  (0, r.tZ)('image', {
                    href: ''.concat(a, '/coinstack.png'),
        ...
        return (
          ...
          (0, r.BX)(K, {
            children: [
              ...
              (0, r.tZ)(G, { position: 'top' }),
              (0, r.tZ)(G, { position: 'bottom' }),
            ],
          })
        );
      });
      let ee = (e) => {
        ...
        return (
          ...
          (0, o.rr1)(() => {
            H(), clearTimeout(C.current), (C.current = setTimeout(H, 300));
          }),
          {
      ...
      var et = (0, i.memo)((e) => {
        let { type: t, title: n, steps: i, terms: s } = e,
        ...
        function G() {
          return (0, r.BX)(A, {
            children: [
              (0, r.BX)(X, {
                children: [
                  (0, r.tZ)(O, { onChange: () => I((e) => !e), checked: T, variant: 'square' }),
                  (0, r.tZ)('p', {
                    children: (0, r.BX)(D, {
                      onMouseDown: $,
                      children: [
        ...
        return (0, r.BX)(p, {
          children: [
            u &&
              (0, r.BX)(r.HY, {
                children: [
                  ...
                  (0, r.tZ)(B, {
                    children: (0, r.tZ)('p', { dangerouslySetInnerHTML: { __html: s } }),
                  }),
                  !c && G(),
                  (0, r.tZ)(w, {}),
                ],
            ...
            (0, r.BX)(C, {
              ref: z,
              children: [
                'earn' === t && (0, r.tZ)(Q, { animationStep: E, base: W }),
                'borrow' === t && (0, r.tZ)(F, { animationStep: E, base: W }),
              ],
            }),
            (0, r.tZ)(h, {
              children: u
                        ...
                        children: i.map((e, t) =>
                          (0, r.BX)(
                            H,
                            {
                              ...
                              selected: t === E,
                              children: [
                                (0, r.tZ)('h4', { children: (0, r.tZ)(Z, { children: e.title }) }),
                                (0, r.tZ)('p', {
                            ...
                            V,
                            {
                              ...
                              children: [
                                ...
                                (0, r.BX)(M, {
                                  ...
                                  children: [
                                    (0, r.tZ)('h4', {
                                      children: (0, r.tZ)(k, { children: e.title }),
                                    }),
                                    (0, r.tZ)('p', {
                                      children: (0, r.tZ)(v, { children: e.description }),
                                    }),
            ...
            (0, r.BX)(o.Kqy, {
              ...
              children: [
                ...
                (0, r.BX)(o.Kqy, {
                  ...
                  gap: 8,
                  children: [
                    (0, r.tZ)(o.qEK, { size: 'small', padding: 0, src: h }),
                    (0, r.BX)(o.xvT.Body.M.Regular, {
                      lineHeight: 'normal',
                      children: [p(f.morpho), ' MORPHO'],
                    }),
                    (0, r.tZ)(o.qEK, { size: 'small', padding: 0, src: y }),
                    (0, r.BX)(o.xvT.Body.M.Regular, {
                      lineHeight: 'normal',
        ...
        return (0, r.BX)(s.Kqy, {
          ...
          children: [
            ...
            (0, r.BX)(s.Kqy, {
              ...
              align: 'center',
              children: [
                (0, r.tZ)(s.JO$, { icon: 'MorphoShade20', size: 30, padding: 0 }),
                (0, r.tZ)(s.JO$, {
                  icon: 'ClosePlain20',
                  size: 24,
                  padding: 0,
                ...
                (0, r.tZ)(s.JO$, { icon: 'CoinbaseOnePlain20', size: 30, padding: 0 }),
              ],
            }),
            (0, r.BX)(s.Kqy, {
              direction: 'column',
              ...
              gap: 20,
              children: [
                (0, r.tZ)(s.xvT.Title.S, { children: 'Coinbase One Rewards' }),
                ...
                (0, r.tZ)(s.zxk, {
                  size: 'big',
                  onClick: h,
                  children: (0, r.tZ)(s.xvT.Body.S.Regular, { children: 'View Vaults' }),
                }),
              ],
            }),
          ],
    ...
    58321: function (e, t, n) {
      ...
      var r = n(78286),
        ...
        y = n(75638),
        m = n(89991);
      let f = (0, i.lazy)(() => n.e(242).then(n.bind(n, 90242))),
        g = (0, i.lazy)(() => n.e(9286).then(n.bind(n, 29286))),
        H = (0, i.lazy)(() => Promise.resolve().then(n.bind(n, 1072))),
        Z = (0, i.lazy)(() => Promise.resolve().then(n.bind(n, 30957))),
        V = (0, i.lazy)(() => Promise.resolve().then(n.bind(n, 52242))),
        b = (0, i.lazy)(() => n.e(4930).then(n.bind(n, 94930))),
      ...
      t.ZP = (e) => {
        let { children: t } = e,
          { account: n, targetChain: M } = (0, m.Z_)(),
          ...
          B = (0, i.useMemo)(() => n.isConnected && n.attestations.base.coinbaseOne, [n]),
          A = (0, i.useMemo)(() => {
          ...
          O = (0, i.useMemo)(() => ({ dialogs: D }), [D]);
        return (0, r.tZ)(k.Provider, { value: O, children: t });
      };
    },
    34895: function (e, t, n) {
      ...
      let { NEXT_PUBLIC_FUUL_API_KEY: h } = c.clientEnvs,
        ...
        g = (e) => 'morpho.referrer.accepted.'.concat(e),
        H = 'fuul.referrer',
      ...
      t.ZP = (0, i.memo)((e) => {
        let { children: t } = e,
          ...
          x = (0, i.useMemo)(() => {
            if (!b || !h || !(null == n ? void 0 : n.address) || !(0, u.isDefined)(M)) return !1;
            let e = (0, p.wB)(f(n.address)),
              t = (0, p.kY)(g(n.address));
            return !e && !t;
          }, [b, null == n ? void 0 : n.address, M]),
        ...
        return (0, r.tZ)(Z.Provider, { value: T, children: t });
      });
    },
    55694: function (e, t, n) {
      ...
      let L = (0, i.createContext)({
        ...
        T = (0, i.memo)((e) => {
          let { children: t } = e,
            { account: n, targetChainId: C } = (0, v.Z_)(),
            h = (0, o.usePublicClient)(),
            m = (0, M.nh)(M.TP.MIGRATION_BORROW),
            {
              data: f,
              isLoading: g,
              error: H,
            } = (0, s.a)({
              queryKey: ['migratablePositions', n.address, C],
              queryFn: () =>
                h && n.address
                  ? (0, u.fetchMigratablePositions)(n.address, h, { protocols: w })
                  : null,
            ...
            }),
            {
              ...
              if (!f) return { supplyTokens: [], loanTokens: [], collateralTokens: [] };
              let e = new Set(),
                t = new Set(),
                n = new Set();
              return (
                Object.values(f).forEach((r) => {
                  r.forEach((r) => {
                    r instanceof u.MigratableSupplyPosition
                      ? e.add(r.loanToken)
            ...
            }, [f]),
            {
              ...
              variables: (0, i.useMemo)(
                () => ({
                  ...
                  whereVaults: {
                    chainId_in: [C],
                    assetAddress_in: Z.length > 0 ? Z : void 0,
                    whitelisted: !0,
                  },
                  firstMarkets: 1e3,
                  whereMarkets: {
                    ...
                    loanAssetAddress_in: V.length > 0 ? V : void 0,
                  },
                }),
                [x, V, Z, C]
              ),
              skip: 0 === Z.length && 0 === x.length && 0 === V.length,
            }),
            X = (0, i.useMemo)(() => {
              var e;
              if (!(null == T ? void 0 : T.vaults.items)) return new Map();
              let t = new Map();
              return (
                null === (e = T.vaults.items) ||
                  void 0 === e ||
                  e.forEach((e) => {
                    var n;
            ...
            D = (0, i.useMemo)(() => {
              var e;
              if (!(null == T ? void 0 : T.markets.items)) return new Map();
              let t = new Map();
              return (
                null === (e = T.markets.items) ||
                  void 0 === e ||
                  e.forEach((e) => {
                    var n, r;
                    if (
                  ...
                  return [
                    ...
                    n
                      ...
                      .map((e) => {
                        ...
                        if (m && e instanceof c.MigratableBorrowPosition) {
                          let t = O(e),
                            i = null == t ? void 0 : t[0],
                            a = (0, d.wk)(null == i ? void 0 : i.collateralAsset),
                            o = (0, d.wk)(null == i ? void 0 : i.loanAsset);
                          if (!i || !a || !o) return;
                          let s = null !== (n = a.toUsd(e.collateral)) && void 0 !== n ? n : 0n,
                            l = null !== (r = o.toUsd(e.borrow)) && void 0 !== r ? r : 0n;
                          return {
                            migratablePosition: e,
                            equityUsd: s - l,
                            compatibleMarkets:
            ...
            z = (0, i.useMemo)(
              () => ({
                ...
                isLoading: g || B,
                error: (0, p.isDefined)(H) || (0, p.isDefined)(A),
                hasMigratablePositions: S,
                migratablePositionCount: _,
              }),
              [I, g, B, H, A, S, _]
            );
          return (0, r.tZ)(L.Provider, { value: z, children: t });
        });
      T.displayName = 'MigrationContextProvider';
      var B = (0, i.memo)(T);
    },
    ...
    75638: function (e, t, n) {
      ...
      let u = () => {
        let e = (0, i.usePathname)(),
          ...
          [c, p] = (0, r.useState)((0, d.BG)(e)),
          { migratablePositionCount: C } = (0, s.w)(),
          h = (0, r.useMemo)(() => {
            let e = a.FW.getNameById(t.id);
            return (0, d.ge)({
              chainName: e,
              flags: { isUiKitAppEnabled: n, isMigrationPageEnabled: u },
              migratablePositionCount: C,
            });
          }, [t.id, n, u, C]);
        return (
          (0, r.useEffect)(() => {
