...
var Pl = (e, t, n) =>
  t in e ? bl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n);
var Pe = (e, t, n) => Pl(e, typeof t != 'symbol' ? t + '' : t, n);
import { j as G, a as Tl } from './phantomUi-BnOIPQCj.js';
import { r as x, b as wl, c as Sl, R as io } from './react-6iN9_IA6.js';
import { z as xr } from './phantomUiDeps-DRT5vvX7.js';
/**
...
const El = new Set(['lazy', 'caseSensitive', 'path', 'id', 'index', 'children']);
function Ml(e) {
  return e.index === !0;
}
function _t(e, t, n, i) {
  return (
    ...
    e.map((r, o) => {
      ...
      if (
        ...
        return (i[a] = l), r.children && (l.children = _t(r.children, t, s, i)), l;
      }
    })
  );
}
...
function so(e, t, n, i) {
  ...
  let r = (o, s, a) => {
    ...
    o.children &&
      ...
      so(o.children, t, u, c)),
      !(o.path == null && !o.index) && t.push({ path: c, score: Il(c, o.index), routesMeta: u });
  };
  return (
    e.forEach((o, s) => {
      var a;
...
function Il(e, t) {
  ...
  return (
    n.some(br) && (i += jl),
    t && (i += Ll),
    n.filter((r) => !br(r)).reduce((r, o) => r + (Dl.test(o) ? Vl : o === '' ? Fl : kl), i)
  );
}
function Ol(e, t) {
  ...
  for (let a = 0; a < i.length; ++a) {
    ...
    Object.assign(r, h.params),
      s.push({
        ...
        pathnameBase: Kl(lt([o, h.pathnameBase])),
        route: d,
      }),
...
function Pr(e, t) {
  ...
  let [n, i] = Ul(e.path, e.caseSensitive, e.end),
    r = t.match(n);
  if (!r) return null;
  let o = r[0],
    s = o.replace(/(.)\/+$/, '$1'),
...
function _l(e, t) {
  ...
  return { pathname: n ? (n.startsWith('/') ? n : $l(n, t)) : t, search: Hl(i), hash: Gl(r) };
}
function $l(e, t) {
...
const lt = (e) => e.join('/').replace(/\/\/+/g, '/'),
  Kl = (e) => e.replace(/\/+$/, '').replace(/^\/*/, '/'),
  Hl = (e) => (!e || e === '?' ? '' : e.startsWith('?') ? e : '?' + e),
  Gl = (e) => (!e || e === '#' ? '' : e.startsWith('#') ? e : '#' + e);
class ii {
  constructor(t, n, i, r) {
    r === void 0 && (r = !1),
      (this.status = t),
...
const lo = ['post', 'put', 'patch', 'delete'],
  ...
  Xl = ['get', ...lo],
  ql = new Set(Xl),
  Zl = new Set([301, 302, 303, 307, 308]),
  Jl = new Set([307, 308]),
  _n = {
    state: 'idle',
    location: void 0,
  ...
  Vt = { state: 'unblocked', proceed: void 0, reset: void 0, location: void 0 },
  wi = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  ec = (e) => ({ hasErrorBoundary: !!e.hasErrorBoundary }),
...
function tc(e) {
  ...
  let o = {},
    s = _t(e.routes, r, void 0, o),
    a,
    l = e.basename || '/',
    c = e.unstable_dataStrategy || ac,
  ...
  function ft(f, m, y) {
    ...
    let L = m.loaderData ? Mr(g.loaderData, m.loaderData, m.matches || [], m.errors) : g.loaderData,
      A = g.blockers;
    A.size > 0 && ((A = new Map(A)), A.forEach((W, Y) => A.set(Y, Vt)));
    let D =
      O === !0 ||
      (g.navigation.formMethod != null &&
        we(g.navigation.formMethod) &&
  ...
  async function et(f, m, y) {
    ...
    if (y && y.pendingError) A = [gt(V).route.id, { type: K.error, error: y.pendingError }];
      ...
      let $ = await al(L, m, y.submission, V, R.active, { replace: y.replace, flushSync: I });
  ...
  async function al(f, m, y, T, E, V) {
    ...
    else if (((R = (await At('action', g, f, [L], T, null))[L.route.id]), f.signal.aborted))
  ...
  async function ll(f, m, y, T, E, V, I, R, L, A, D) {
    let z = E || $n(m, V),
      W = V || I || Lr(z),
    ...
    if (Y) {
      ...
      oe.length > 0 && (B.fetchers = cl(oe)), fe(B, { flushSync: A });
    }
    oe.forEach((B) => {
      q.has(B.key) && $e(B.key), B.controller && q.set(B.key, B.controller);
    });
    let Dt = () => oe.forEach((B) => $e(B.key));
    U && U.signal.addEventListener('abort', Dt);
    let { loaderResults: Ve, fetcherResults: pt } = await lr(g, y, ae, oe, f);
    if (f.signal.aborted) return { shortCircuited: !0 };
    U && U.signal.removeEventListener('abort', Dt), oe.forEach((B) => q.delete(B.key));
    let ze = hn(Ve);
  ...
  function ul(f, m, y, T) {
    ...
    if (((O = (T && T.preventScrollReset) === !0), D && we(D.formMethod))) {
      hl(f, m, A, W, R, L.active, E, D);
      return;
    }
    dt.set(f, { routeId: m, path: A }), dl(f, m, A, W, R, L.active, E, D);
  }
  async function hl(f, m, y, T, E, V, I, R) {
    ...
    if (V) {
      ...
      if (ee.type === 'error') {
        ...
        if (((E = ee.matches), (T = jt(E, y)), L(T))) return;
      } else {
    ...
    q.set(f, D);
    let W = Ne,
      $ = (await At('action', g, z, [T], E, f))[T.route.id];
    if (z.signal.aborted) {
    ...
    if (h.v7_fetcherPersist && Ae.has(f)) {
      ...
      if (ot($))
        if ((q.delete(f), Et > W)) {
          _e(f, We(void 0));
          return;
        } else return Me.add(f), _e(f, Lt(R)), tt(z, $, !1, { fetcherSubmission: R });
      if (ve($)) {
        De(f, m, $.error);
        return;
      }
    ...
    let ae = g.navigation.location || g.location,
      ...
      Dt = a || s,
      Ve = g.navigation.state !== 'idle' ? st(Dt, g.navigation.location, l) : g.matches;
    ...
    Le.filter((ee) => ee.key !== f).forEach((ee) => {
      let Fe = ee.key,
        ...
        xl = Lt(void 0, yr ? yr.data : void 0);
      g.fetchers.set(Fe, xl), q.has(Fe) && $e(Fe), ee.controller && q.set(Fe, ee.controller);
    }),
    ...
    dr(pt),
      g.navigation.state === 'loading' && pt > Et
  ...
  async function dl(f, m, y, T, E, V, I, R) {
    let L = g.fetchers.get(f);
    _e(f, Lt(R, L ? L.data : void 0), { flushSync: I });
    ...
    if (V) {
      ...
      if ($.type === 'error') {
        ...
        return;
      } else if ($.matches) (E = $.matches), (T = jt(E, y));
      else {
        De(f, m, pe(404, { pathname: y }), { flushSync: I });
        return;
      }
    ...
    q.set(f, A);
    let z = Ne,
      Y = (await At('loader', g, D, [T], E, f))[T.route.id];
    if (
  ...
  async function tt(f, m, y, T) {
    ...
    if (n) {
      ...
      if (m.response.headers.has('X-Remix-Reload-Document')) $ = !0;
        ...
        $ = ae.origin !== t.location.origin || Yt(ae.pathname, l) == null;
      }
      if ($) {
    ...
    let Y = E || V;
    if (Jl.has(m.response.status) && Y && we(Y.formMethod))
      await et(A, L, {
  ...
  async function At(f, m, y, T, E, V) {
    let I,
      R = {};
    try {
      I = await lc(c, f, m, y, T, E, V, o, r);
    } catch (L) {
      return (
        T.forEach((A) => {
    ...
    for (let [L, A] of Object.entries(I))
      if (mc(A)) {
        let D = A.result;
        R[L] = { type: K.redirect, response: hc(D, y, L, E, l, h.v7_relativeSplatPath) };
      } else R[L] = await uc(A);
    return R;
  }
  async function lr(f, m, y, T, E) {
    let V = f.matches,
      I = At('loader', f, E, y, m, null),
      R = Promise.all(
        T.map(async (D) => {
    ...
    return (
      await Promise.all([yc(m, L, E.signal, V, f.loaderData), xc(m, A, T)]),
  ...
  function cr(f) {
    return (
      h.v7_fetcherPersist && (Mt.set(f, (Mt.get(f) || 0) + 1), Ae.has(f) && Ae.delete(f)),
      g.fetchers.get(f) || Ql
    );
  }
  function tn(f) {
  ...
  function fl(f) {
    if (h.v7_fetcherPersist) {
      let m = (Mt.get(f) || 0) - 1;
      m <= 0 ? (Mt.delete(f), Ae.add(f)) : Mt.set(f, m);
    } else tn(f);
    fe({ fetchers: new Map(g.fetchers) });
  }
  function $e(f) {
...
function ri(e, t, n, i, r, o, s, a) {
  ...
  let u = Wl(r || '.', zl(l, o), Yt(e.pathname, n) || e.pathname, a === 'path');
  return (
...
function Tr(e, t, n, i) {
  if (!i || !nc(i)) return { path: n };
  if (i.formMethod && !vc(i.formMethod))
...
function wr(e, t, n, i, r, o, s, a, l, c, u, h, d, p, v, b) {
  let P = b ? (ve(b[1]) ? b[1].error : b[1].data) : void 0,
    ...
    re = M.filter((j, O) => {
      ...
      if (rc(t.loaderData, t.matches[O], j) || l.some((J) => J === j.route.id)) return !0;
      let X = t.matches[O],
        ce = j;
      return Sr(
        j,
...
async function sc(e, t, n, i, r, o, s, a) {
...
function ho(e, t, n, i, r) {
  if (e) {
    ...
    let s = _t(t, r, ['patch', String(n.length || '0')], i);
    n.push(...s);
  }
}
...
async function lc(e, t, n, i, r, o, s, a, l, c) {
  let u = o.map((p) => (p.route.lazy ? oc(p.route, l, a) : void 0)),
    h = o.map((p, v) => {
      let b = u[v],
      ...
      return te({}, p, {
        ...
        resolve: async (w) => (
          ...
          P ? cc(t, i, p, b, w, c) : Promise.resolve({ type: K.data, result: void 0 })
        ),
      });
    }),
...
function Er(e, t, n, i, r, o, s, a) {
  let { loaderData: l, errors: c } = dc(t, i, r, a, !1);
  return (
    o.forEach((u) => {
...
function mc(e) {
  return po(e.result) && Zl.has(e.result.status);
}
function He(e) {
...
function vc(e) {
  return ql.has(e.toLowerCase());
}
function we(e) {
  return Yl.has(e.toLowerCase());
}
async function yc(e, t, n, i, r) {
...
function Ec(e, t, n, i) {
  ...
  return t && b
    ? x.createElement(
        ...
        {
          value: {
            location: $t({ pathname: '/', search: '', hash: '', state: null, key: 'default' }, u),
...
const Ac = x.createElement(Mc, null);
...
function Vc(e) {
  ...
  return (
    ...
    x.createElement(Xt.Provider, { value: t }, i)
  );
}
function Lc(e, t, n, i) {
  var r;
  ...
  return s.reduceRight((u, h, d) => {
    ...
    n &&
      ...
      (b = h.route.errorElement || Ac),
      l &&
        (c < 0 && d === 0
          ? (Oc('route-fallback', !1), (v = !0), (P = null))
...
function Bc(e) {
  ...
  let l = t.replace(/^\/*/, '/'),
    c = x.useMemo(
      () => ({ basename: l, navigator: o, static: s, future: $t({ v7_relativeSplatPath: !1 }, a) }),
      [l, a, o, s]
    );
...
function Nc(e, t) {
  return tc({
    ...
    future: $t({}, t == null ? void 0 : t.future, { v7_prependBasename: !0 }),
    history: Cl({
 ...
 */ const _c = '6';
try {
  window.__reactRouterVersion = _c;
} catch {}
const $c = x.createContext({ isTransitioning: !1 }),
  zc = x.createContext(new Map()),
  Wc = 'startTransition',
  kr = wl[Wc],
  Kc = 'flushSync',
  jr = Sl[Kc];
...
function Yc(e) {
  ...
  x.useLayoutEffect(() => n.subscribe(C), [n, C]),
    x.useEffect(() => {
      l.isTransitioning && !l.flushSync && h(new Gc());
    }, [l]),
    x.useEffect(() => {
      if (u && s && n.window) {
        let g = s,
          ...
          x.createElement(
            ...
            x.createElement(
              ...
              r.initialized || n.future.v7_partialHydration
                ? x.createElement(Xc, { routes: n.routes, future: n.future, state: r })
                : t
            )
          )
        )
...
const Po = io.createContext(null),
  Ct = () => oi(x.useContext(Po), 'useStackRouterState must be used within a StackRouterProvider'),
  Up = ({ router: e }) =>
    G.jsx(Po.Provider, { value: e, children: G.jsx(Yc, { router: e.router }) }),
  ai = (e) => ({
    ...
    const { config: t } = Ct(),
      ...
      i = () => {
        e.to
          ? n.to(e.to, e)
          : e.toStack
            ? n.toStack(e.toStack, e)
            : e.toTab
              ? n.toTab(e.toTab)
              : e.pop
                ? n.pop()
                : e.popStack && n.popStack();
      };
    return G.jsx('a', {
      onClick: i,
      className: e.className ?? ((r = t.css) == null ? void 0 : r.link),
      href: '#',
      children: e.children,
    });
  };
...
const {
    ...
    state: le,
    steps: zn,
  } = So(typeof requestAnimationFrame < 'u' ? requestAnimationFrame : de, !0),
  Co = (e, t, n) => (((1 - 3 * n + 3 * t) * e + (3 * n - 6 * t)) * e + 3 * t) * e,
  au = 1e-7,
  lu = 12;
function cu(e, t, n, i, r) {
  let o,
    s,
    a = 0;
  do (s = t + (n - t) / 2), (o = Co(s, i, r) - e), o > 0 ? (n = s) : (t = s);
...
function Zt(e, t, n, i) {
  ...
  return (o) => (o === 0 || o === 1 ? o : Co(r(o), t, i));
}
const Ro = (e) => (t) => (t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2),
  Eo = (e) => (t) => 1 - e(1 - t),
  Mo = Zt(0.33, 1.53, 0.69, 0.99),
  Vi = Eo(Mo),
  Ao = Ro(Vi),
  Do = (e) => ((e *= 2) < 1 ? 0.5 * Vi(e) : 0.5 * (2 - Math.pow(2, -10 * (e - 1)))),
  Li = (e) => 1 - Math.sin(Math.acos(e)),
  Vo = Eo(Li),
  Lo = Ro(Li),
  Fo = (e) => /^0[^.\s]+$/u.test(e);
function uu(e) {
  return typeof e == 'number' ? e === 0 : e !== null ? e === 'none' || e === '0' || Fo(e) : !0;
}
let ko = de;
const jo = (e) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(e),
  Io = (e) => (t) => typeof t == 'string' && t.startsWith(e),
  Oo = Io('--'),
  hu = Io('var(--'),
...
function Bo(e, t, n = 1) {
  ...
  if (o) {
    const s = o.trim();
    return jo(s) ? parseFloat(s) : s;
  }
  return Fi(r) ? Bo(r, t, n + 1) : r;
}
const Ye = (e, t, n) => (n > t ? t : n < e ? e : n),
  Rt = { test: (e) => typeof e == 'number', parse: parseFloat, transform: (e) => e },
  Kt = { ...Rt, transform: (e) => Ye(0, 1, e) },
  fn = { ...Rt, default: 1 },
  Jt = (e) => ({
...
class ki {
  ...
  scheduleResolve() {
    (this.isScheduled = !0),
      this.isAsync
        ? (ct.add(this), ci || ((ci = !0), H.read($o), H.resolveKeyframes(_o)))
...
const Su =
  ...
  Cu = (e) => Ye(0, 255, e),
  Wn = { ...Rt, transform: (e) => Math.round(Cu(e)) },
  at = {
    test: Ii('rgb', 'red'),
    parse: zo('red', 'green', 'blue'),
...
const hi = { test: Ii('#'), parse: Ru, transform: at.transform },
  vt = {
    test: Ii('hsl', 'hue'),
    parse: zo('hue', 'saturation', 'lightness'),
...
function Ht(e) {
  ...
  const a = t
    .replace(
      ...
      (l) => (
        ue.test(l)
          ? (i.color.push(o), r.push(Ko), n.push(ue.parse(l)))
          : l.startsWith(Du)
            ? (i.var.push(o), r.push(Au), n.push(l))
            : (i.number.push(o), r.push(Wo), n.push(parseFloat(l))),
        ++o,
        Kr
      )
    )
...
function Go(e) {
  ...
  return (r) => {
    ...
    for (let s = 0; s < i; s++)
      if (((o += t[s]), r[s] !== void 0)) {
        const a = n[s];
        a === Wo ? (o += Bt(r[s])) : a === Ko ? (o += ue.transform(r[s])) : (o += r[s]);
      }
    return o;
  };
}
...
function Fu(e) {
  const t = Ho(e);
  return Go(e)(t.map(Lu));
}
const Xe = { test: Mu, parse: Ho, createTransformer: Go, getAnimatableNone: Fu },
...
const Iu = /\b([a-z-]*)\(.*?\)/gu,
  ...
  Hr = { ...Rt, transform: Math.round },
  Oi = { ...Ou, ...Bu, zIndex: Hr, size: F, fillOpacity: Kt, strokeOpacity: Kt, numOctaves: Hr },
  Uu = {
    ...Oi,
    color: ue,
    backgroundColor: ue,
...
function _u(e, t, n) {
  ...
  for (; i < e.length && !r; ) {
    const o = e[i];
    typeof o == 'string' && !Nu.has(o) && Ht(o).values.length && (r = e[i]), i++;
  }
  if (r && n) for (const o of t) e[o] = Yo(n, r);
}
class Xo extends ki {
...
function Qo({ keyframes: e, restDelta: t, restSpeed: n, ...i }) {
  const r = e[0],
    o = e[e.length - 1],
    s = { done: !1, value: r },
    {
...
function vh(e, t, { clamp: n = !0, ease: i, mixer: r } = {}) {
  const o = e.length;
  if ((ko(o === t.length), o === 1)) return () => t[0];
...
function Ph(e, t) {
  return e.map(() => t || ea).splice(0, e.length - 1);
}
...
const wh = (e) => {
  ...
  Sh = { decay: Xr, inertia: Xr, tween: Tn, keyframes: Tn, spring: Qo },
  Ch = (e) => e / 100;
class _i extends qo {
  constructor(t) {
    super(t),
  ...
  initPlayback(t) {
    const {
      ...
      a = Ui(n) ? n : Sh[n] || Tn;
    let l, c;
    a !== Tn && typeof t[0] != 'number' && ((l = Oe(Ch, na(t[0], t[1]))), (t = [0, 100]));
...
const It = ([e, t, n, i]) => `cubic-bezier(${e}, ${t}, ${n}, ${i})`,
  mi = {
    linear: 'linear',
    ease: 'ease',
    easeIn: 'ease-in',
...
const Vh = $i(() => Object.hasOwnProperty.call(Element.prototype, 'animate')),
  ...
  Lh = 2e4;
function Fh(e) {
  return Ui(e.type) || e.type === 'spring' || !sa(e.ease);
}
function kh(e, t) {
...
const aa = { anticipate: Do, backInOut: Ao, circInOut: Lo };
function jh(e) {
  return e in aa;
}
class ts extends qo {
  constructor(t) {
    super(t);
    const { name: n, motionValue: i, element: r, keyframes: o } = this.options;
    (this.resolver = new Xo(o, (s, a) => this.onKeyframesResolved(s, a), n, i, r)),
  ...
  initPlayback(t, n) {
    ...
    if ((typeof s == 'string' && wn() && jh(s) && (s = aa[s]), Fh(this.options))) {
...
function ha(e, t, { delay: n = 0, transitionOverride: i, type: r } = {}) {
  var o;
...
function vi(e, t, n = {}) {
  ...
  const s = r ? () => Promise.all(ha(e, r, n)) : () => Promise.resolve(),
    a =
  ...
  function s(l) {
    ...
    for (let P = 0; P < Qh; P++) {
      ...
      if (
        ...
        (w.protectedKeys = { ...p }),
        (!w.isActive && k === null) || (!C && !w.prevProp) || zt(C) || typeof C == 'boolean')
      )
        continue;
...
function Xn({ point: e }, t) {
  return { point: e, delta: ss(e, ma(t)), offset: ss(e, cd(t)), velocity: ud(t, 0.1) };
}
function cd(e) {
  return e[0];
}
...
function Pa({ top: e, left: t, right: n, bottom: i }) {
...
function it(e) {
  return xi(e) || Ta(e) || e.z || e.rotate || e.rotateX || e.rotateY || e.skewX || e.skewY;
}
function Ta(e) {
...
function Cd(e, t, n, i = !1) {
  ...
  for (let a = 0; a < r; a++) {
    ...
    (l && l.props.style && l.props.style.display === 'contents') ||
      ...
      s && ((t.x *= s.x.scale), (t.y *= s.y.scale), wa(e, s)),
...
function Sa(e, t) {
  return Pa(Sd(e.getBoundingClientRect(), t));
}
function Rd(e, t, n) {
  const i = Sa(e, n),
    { scroll: r } = t;
...
const Ca = ({ current: e }) => (e ? e.ownerDocument.defaultView : null),
  Ed = new WeakMap();
class Md {
  constructor(t) {
  ...
  resolveRefConstraints() {
    ...
    if (n) {
      const a = n(wd(s));
      (this.hasMutatedConstraints = !!a), a && (s = Pa(a));
    }
    return s;
  }
  startAnimation(t) {
...
class Vd extends Ze {
  ...
  onPointerDown(t) {
    this.session = new pa(t, this.createPanHandlers(), {
...
const { schedule: Yi, cancel: _p } = So(queueMicrotask, !1);
...
function Ea(e) {
  ...
  return G.jsx(Od, {
    ...e,
    layoutGroup: i,
    switchLayoutGroup: x.useContext(Ra),
    isPresent: t,
    safeToRemove: n,
  });
}
const Bd = {
  ...
  Ma = ['TopLeft', 'TopRight', 'BottomLeft', 'BottomRight'],
  Ud = Ma.length,
...
const rt = {
  ...
  Ot = typeof window < 'u' && window.MotionDebug !== void 0,
  Zn = ['', 'X', 'Y', 'Z'],
...
function La(e) {
  ...
  const { parent: i } = e;
  i && !i.hasCheckedOptimisedAppear && La(i);
}
function Fa({
  ...
  return class {
    constructor(s = {}, a = t == null ? void 0 : t()) {
      (this.id = tf++),
        ...
        (this.updateProjection = () => {
          (this.projectionUpdateScheduled = !1),
            Ot && (rt.totalNodes = rt.resolvedTargetDeltas = rt.recalculatedProjection = 0),
            this.nodes.forEach(sf),
            this.nodes.forEach(uf),
            this.nodes.forEach(hf),
            this.nodes.forEach(of),
            Ot && window.MotionDebug.record(rt);
        }),
          ...
          this.addEventListener(
            ...
            ({ delta: h, hasLayoutChanged: d, hasRelativeTargetChanged: p, layout: v }) => {
              ...
              const b = this.options.transition || u.getDefaultTransition() || gf,
                ...
                w = !this.targetLayout || !Va(this.targetLayout, v) || p,
                C = !d && p;
              if (
    ...
    willUpdate(s = !0) {
      ...
      if (
        (window.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && La(this),
    ...
    resetTransform() {
      ...
      const s = this.isLayoutDirty || this.shouldResetTransform || this.options.alwaysMeasureLayout,
        a = this.projectionDelta && !Da(this.projectionDelta),
        ...
        if (
          ...
          p && p.layout && this.animationProgress !== 1
            ? ((this.relativeParent = p),
              ...
              Nt(this.relativeTargetOrigin, this.layout.layoutBox, p.layout.layoutBox),
          ...
          if (
            ...
            this.animationProgress !== 1
              ? ((this.relativeParent = p),
                ...
                (this.relativeTarget = ne()),
                (this.relativeTargetOrigin = ne()),
                Nt(this.relativeTargetOrigin, this.target, p.target),
                xe(this.relativeTarget, this.relativeTargetOrigin))
              : (this.relativeParent = this.relativeTarget = void 0);
          }
          Ot && rt.resolvedTargetDeltas++;
        }
      }
    }
    getClosestProjectingParent() {
      if (!(!this.parent || xi(this.parent.latestValues) || Ta(this.parent.latestValues)))
    ...
    calcProjection() {
      ...
      !this.projectionDelta || !this.prevProjectionDelta
        ...
        Ut(this.projectionDelta, this.layoutCorrected, v, this.latestValues),
        (this.treeScale.x !== d ||
          this.treeScale.y !== p ||
      ...
      (this.mixTargetDelta = (M) => {
        ...
        Ns(h.x, s.x, k),
          ...
          this.relativeTarget &&
            ...
            (Nt(d, this.layout.layoutBox, this.relativeParent.layout.layoutBox),
    ...
    applyTransformsToTarget() {
      ...
      if (!(!a || !l || !c)) {
        if (
          ...
          this.layout &&
          c &&
          ka(this.options.animationType, this.layout.layoutBox, c.layoutBox)
        ) {
          l = this.target || ne();
        ...
        xe(a, l), Pt(a, u), Ut(this.projectionDeltaWithTransform, this.layoutCorrected, a, u);
      }
    }
...
function rf(e) {
  ...
  if (e.isLead() && e.layout && n && e.hasListeners('didUpdate')) {
    ...
    Ut(a, i, n.layoutBox);
    const l = xt();
    s ? Ut(l, e.applyTransform(r, !0), n.measuredBox) : Ut(l, i, n.layoutBox);
    const c = !Da(a);
    let u = !1;
    if (!e.resumeFrom) {
...
const xf = Fa({
  ...
  bf = { pan: { Feature: Vd }, drag: { Feature: Dd, ProjectionNode: ja, MeasureLayout: Ea } };
function Ks(e, t) {
  const n = t ? 'pointerenter' : 'pointerleave',
    i = t ? 'onHoverStart' : 'onHoverEnd',
    r = (o, s) => {
      if (o.pointerType === 'touch' || ya()) return;
      const a = e.getProps();
...
const Ia = (e, t) => (t ? (e === t ? !0 : Ia(e, t.parentElement)) : !1);
function ei(e, t) {
  if (!t) return;
          ...
          o = Be(
            ...
            (a, l) => {
              ...
              const { onTap: c, onTapCancel: u, globalTapTarget: h } = this.node.getProps(),
                d = !h && !Ia(this.node.current, a.target) ? u : c;
              d && H.update(() => d(a, l));
            },
...
const Vf = {
  ...
  Lf = { layout: { ProjectionNode: ja, MeasureLayout: Ea } },
  Xi = x.createContext({ transformPagePoint: (e) => e, isStatic: !1, reducedMotion: 'never' }),
  jn = x.createContext({}),
  qi = typeof window < 'u',
  Oa = qi ? x.useLayoutEffect : x.useEffect,
  Ba = x.createContext({ strict: !1 });
let Hs = !1;
...
function jf(e, t, n, i) {
  ...
  (e.projection = new n(e.latestValues, t['data-framer-portal-id'] ? void 0 : Ua(e.parent))),
...
function Ua(e) {
  if (e) return e.options.allowProjection !== !1 ? e.projection : Ua(e.parent);
}
function If(e, t, n) {
...
function In(e) {
  return zt(e.animate) || Ai.some((t) => Wt(e[t]));
}
function Na(e) {
...
function Of(e, t) {
  if (In(e)) {
    ...
    return { initial: n === !1 || Wt(n) ? n : void 0, animate: Wt(i) ? i : void 0 };
  }
...
function _a(e, { style: t, vars: n }, i, r) {
...
function za(e, t, n, i) {
  _a(e, t, void 0, i);
  for (const r in t.attrs) e.setAttribute($a.has(r) ? r : Fn(r), t.attrs[r]);
}
...
const er = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} }),
  Ga = () => ({ ...er(), attrs: {} }),
  Ya = (e, t) => (t && typeof e == 'number' ? t.transform(e) : e),
    ...
    useVisualState: Ha({
      ...
      onMount: (e, t, { renderState: n, latestValues: i }) => {
        H.read(() => {
          ...
          H.render(() => {
            nr(n, i, ir(t.tagName), e.transformTemplate), za(t, n);
          });
      },
    }),
  },
...
function Xa(e, t, n) {
  for (const i in t) !he(t[i]) && !Wa(i, n) && (e[i] = t[i]);
}
...
function rp(e, t) {
  const n = e.style || {},
    i = {};
  return Xa(i, n, e), Object.assign(i, ip(e, t)), i;
}
function sp(e, t) {
  const n = {},
    i = rp(e, t);
...
let qa = (e) => !En(e);
function ap(e) {
  e && (qa = (t) => (t.startsWith('on') ? !En(t) : e(t)));
}
try {
...
function cp(e, t, n, i) {
  ...
  if (e.style) {
    const o = {};
    Xa(o, e.style, e), (r.style = { ...o, ...r.style });
  }
  return r;
}
function up(e = !1) {
...
function fp(e, t, n) {
  for (const i in t) {
    ...
    else if (he(o)) e.addValue(i, Gt(r, { owner: e }));
    else if (o !== r)
      if (e.hasValue(i)) {
        ...
        e.addValue(i, Gt(s !== void 0 ? s : r, { owner: e }));
      }
  }
...
class gp {
  ...
  getValue(t, n) {
    ...
    return (
      i === void 0 &&
        n !== void 0 &&
        ((i = Gt(n === null ? void 0 : n, { owner: this })), this.addValue(t, i)),
      i
    );
  }
  readValue(t, n) {
    ...
    return (
      r != null &&
        (typeof r == 'string' && (jo(r) || Fo(r))
          ? (r = parseFloat(r))
          : !mp(r) && Xe.test(n) && (r = Yo(t, n)),
...
class yp extends Ja {
  ...
  readValueFromInstance(t, n) {
    if (qe.has(n)) {
      ...
      const i = vp(t),
        r = (Oo(n) ? i.getPropertyValue(n) : i[n]) || 0;
...
class xp extends Ja {
  ...
  readValueFromInstance(t, n) {
    ...
    return (n = $a.has(n) ? n : Fn(n)), t.getAttribute(n);
  }
  scrapeMotionValuesFromProps(t, n, i) {
    return Ka(t, n, i);
  }
...
function Fp() {
  const e = Rp();
  return G.jsx(Qa, { initial: !1, children: e ? G.jsx(Vp, {}, 'modal') : G.jsx(Lp, {}, 'tabs') });
}
const tl = (e, t = '') =>
    e.flatMap((n) => {
      const i = `${t}/${n.id}`;
...
const Wp = (e) => new kp(e),
  Kp = (e) => e;
export { Np as L, Up as S, zp as a, Wp as b, Kp as c, ai as d, To as u };
