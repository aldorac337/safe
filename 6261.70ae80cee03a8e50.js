  ...
  [6261],
  {
    27320: function (e, t) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.aexists = r),
        (t.aoutput = o);
      const a = { number: n, bytes: s, hash: i, exists: r, output: o };
      t.default = a;
    },
    6873: function (e, t) {
      'use strict';
      ...
      function r(e, t = !1) {
        ...
        for (let r = 0; r < e.length; r++) {
          const { h: o, l: a } = i(e[r], t);
          [n[r], s[r]] = [o, a];
        }
        return [n, s];
      }
      const o = (e, t) => (BigInt(e >>> 0) << s) | BigInt(t >>> 0);
      t.toBig = o;
      const a = (e, t, n) => e >>> n;
      t.shrSH = a;
      const c = (e, t, n) => (e << (32 - n)) | (t >>> n);
      t.shrSL = c;
      ...
      t.rotlSH = g;
      const m = (e, t, n) => (t << n) | (e >>> (32 - n));
      t.rotlSL = m;
      const y = (e, t, n) => (t << (n - 32)) | (e >>> (64 - n));
      t.rotlBH = y;
      const _ = (e, t, n) => (e << (n - 32)) | (t >>> (64 - n));
      function w(e, t, n, s) {
        const i = (t >>> 0) + (s >>> 0);
      ...
      t.add3L = b;
      const v = (e, t, n, s) => (t + n + s + ((e / 2 ** 32) | 0)) | 0;
      t.add3H = v;
      const k = (e, t, n, s) => (e >>> 0) + (t >>> 0) + (n >>> 0) + (s >>> 0);
      t.add4L = k;
      const C = (e, t, n, s, i) => (t + n + s + i + ((e / 2 ** 32) | 0)) | 0;
      t.add4H = C;
      const E = (e, t, n, s, i) => (e >>> 0) + (t >>> 0) + (n >>> 0) + (s >>> 0) + (i >>> 0);
      t.add5L = E;
      const I = (e, t, n, s, i, r) => (t + n + s + i + r + ((e / 2 ** 32) | 0)) | 0;
      t.add5H = I;
      const x = {
        fromBig: i,
        split: r,
    ...
    85426: function (e, t, n) {
      ...
      const s = n(27320),
        ...
        p = BigInt(256),
        f = BigInt(113);
      for (let C = 0, E = u, I = 1, x = 0; C < 24; C++) {
        ([I, x] = [x, (2 * I + 3 * x) % 5]),
          o.push(2 * (5 * x + I)),
          a.push((((C + 1) * (C + 2)) / 2) % 64);
        let e = l;
        for (let t = 0; t < 7; t++)
          (E = ((E << u) ^ ((E >> d) * f)) % p), E & h && (e ^= u << ((u << BigInt(t)) - u));
        c.push(e);
      }
      const [g, m] = (0, i.split)(c, !0),
        y = (e, t, n) => (n > 32 ? (0, i.rotlBH)(e, t, n) : (0, i.rotlSH)(e, t, n)),
        _ = (e, t, n) => (n > 32 ? (0, i.rotlBL)(e, t, n) : (0, i.rotlSL)(e, t, n));
      function w(e, t = 24) {
        ...
        for (let s = 24 - t; s < 24; s++) {
          ...
          for (let s = 0; s < 10; s += 2) {
            const t = (s + 8) % 10,
              ...
              a = y(r, o, 1) ^ n[t],
              c = _(r, o, 1) ^ n[t + 1];
            for (let n = 0; n < 50; n += 10) (e[s + n] ^= a), (e[s + n + 1] ^= c);
          }
          let t = e[2],
            i = e[3];
          for (let n = 0; n < 24; n++) {
            const s = a[n],
              ...
              c = _(t, i, s),
              l = o[n];
            (t = e[l]), (i = e[l + 1]), (e[l] = r), (e[l + 1] = c);
          }
          for (let s = 0; s < 50; s += 10) {
            for (let t = 0; t < 10; t++) n[t] = e[s + t];
            for (let t = 0; t < 10; t++) e[s + t] ^= ~n[(t + 2) % 10] & n[(t + 4) % 10];
          }
          (e[0] ^= g[s]), (e[1] ^= m[s]);
        }
        n.fill(0);
      ...
      class b extends r.Hash {
        ...
        keccak() {
          r.isLE || (0, r.byteSwap32)(this.state32),
        ...
        update(e) {
          ...
          const { blockLen: t, state: n } = this,
            i = (e = (0, r.toBytes)(e)).length;
          for (let s = 0; s < i; ) {
            const r = Math.min(t - this.pos, i - s);
            for (let t = 0; t < r; t++) n[this.pos++] ^= e[s++];
        ...
        writeInto(e) {
          ...
          for (let s = 0, i = e.length; s < i; ) {
            ...
            const r = Math.min(n - this.posOut, i - s);
            e.set(t.subarray(this.posOut, this.posOut + r), s), (this.posOut += r), (s += r);
          }
          return e;
        }
        xofInto(e) {
        ...
        _cloneInto(e) {
          const { blockLen: t, suffix: n, outputLen: s, rounds: i, enableXOF: r } = this;
          return (
            e || (e = new b(t, n, s, r, i)),
      ...
      t.Keccak = b;
      const v = (e, t, n) => (0, r.wrapConstructor)(() => new b(t, e, n));
      ...
      const k = (e, t, n) =>
        (0, r.wrapXOFConstructorWithOpts)(
          (s = {}) => new b(t, e, void 0 === s.dkLen ? n : s.dkLen, !0)
        );
      (t.shake128 = k(31, 168, 16)), (t.shake256 = k(31, 136, 32));
    },
    98089: function (e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.Hash =
          t.nextTick =
        ...
        (t.hexToBytes = function (e) {
          ...
          for (let i = 0, r = 0; i < n; i++, r += 2) {
            const t = d(e.charCodeAt(r)),
              n = d(e.charCodeAt(r + 1));
            if (void 0 === t || void 0 === n) {
              const t = e[r] + e[r + 1];
              throw new Error(
                'hex string expected, got non-hex character "' + t + '" at index ' + r
              );
            }
            s[i] = 16 * t + n;
          }
        ...
        (t.asyncLoop = async function (e, n, s) {
          let i = Date.now();
          for (let r = 0; r < e; r++) {
            s(r);
            const e = Date.now() - i;
        ...
        (t.wrapConstructorWithOpts = function (e) {
          const t = (t, n) => e(n).update(f(t)).digest(),
            n = e({});
          return (
      ...
      function f(e) {
        return 'string' === typeof e && (e = p(e)), (0, i.abytes)(e), e;
      }
      t.nextTick = async () => {};
      t.Hash = class {
        clone() {
    ...
    6400: function (e, t, n) {
      ...
      function k(e, t, n) {
        ...
        if (
          (arguments.length > 2 && (a.children = arguments.length > 3 ? s.call(arguments, 2) : n),
          'function' == typeof e && null != e.defaultProps)
        )
          for (o in e.defaultProps) void 0 === a[o] && (a[o] = e.defaultProps[o]);
        return C(e, a, i, r, null);
      }
      ...
      function M(e) {
        ((!e.__d && (e.__d = !0) && a.push(e) && !A.__r++) || c !== i.debounceRendering) &&
      ...
      function P(e, t, n, s, i, r, o, a, c, l, u) {
        var h,
          d,
          p,
          f,
          ...
          w = (s && s.__k) || y,
          b = t.length;
        for (c = D(n, t, w, c), h = 0; h < b; h++)
          null != (p = n.__k[h]) &&
            ((d = -1 === p.__i ? m : w[p.__i] || m),
            (p.__i = h),
            (_ = H(e, p, d, i, r, o, a, c, l, u)),
            (f = p.__e),
            p.ref && d.ref != p.ref && (d.ref && q(d.ref, null, p), u.push(p.ref, p.__c || f, p)),
            null == g && null != f && (g = f),
            4 & p.__u || d.__k === p.__k
              ? (c = N(p, c, e))
      ...
      function D(e, t, n, s) {
        var i,
          ...
          d = 0;
        for (e.__k = [], i = 0; i < l; i++)
          null != (r = t[i]) && 'boolean' != typeof r && 'function' != typeof r
            ? ((a = i + d),
              ((r = e.__k[i] =
                'string' == typeof r ||
                'number' == typeof r ||
                ...
                r.constructor == String
                  ? C(null, r, null, null, null)
                  : w(r)
                    ? C(I, { children: r }, null, null, null)
                    : void 0 === r.constructor && r.__b > 0
                      ? C(r.type, r.props, r.key, r.ref ? r.ref : null, r.__v)
                      : r).__ = e),
              (r.__b = e.__b + 1),
              (o = null),
              -1 !== (c = r.__i = T(r, n, a, h)) && (h--, (o = n[c]) && (o.__u |= 2)),
              null == o || null === o.__v
                ? (-1 == c && d--, 'function' != typeof r.type && (r.__u |= 4))
                : c !== a &&
                  (c == a - 1 ? d-- : c == a + 1 ? d++ : (c > a ? d-- : d++, (r.__u |= 4))))
            : (r = e.__k[i] = null);
        if (h)
          for (i = 0; i < u; i++)
            null != (o = n[i]) && 0 == (2 & o.__u) && (o.__e == s && (s = S(o)), V(o, o));
        return s;
      }
      function N(e, t, n) {
        var s, i;
        if ('function' == typeof e.type) {
          for (s = e.__k, i = 0; s && i < s.length; i++)
            s[i] && ((s[i].__ = e), (t = N(s[i], t, n)));
          return t;
        }
        e.__e != t &&
          (t && e.type && !n.contains(t) && (t = S(e)),
      ...
      function T(e, t, n, s) {
        var i = e.key,
          ...
          a = n + 1,
          c = t[n];
        if (null === c || (c && i == c.key && r === c.type && 0 == (2 & c.__u))) return n;
        if (('function' != typeof r || r === I || i) && s > (null != c && 0 == (2 & c.__u) ? 1 : 0))
          for (; o >= 0 || a < t.length; ) {
            if (o >= 0) {
              if ((c = t[o]) && 0 == (2 & c.__u) && i == c.key && r === c.type) return o;
              o--;
            }
            if (a < t.length) {
              if ((c = t[a]) && 0 == (2 & c.__u) && i == c.key && r === c.type) return a;
              a++;
            }
          }
        return -1;
      ...
      function U(e, t, n) {
        '-' === t[0]
          ...
          : (e[t] = null == n ? '' : 'number' != typeof n || _.test(t) ? n : n + 'px');
      }
        ...
        e: if ('style' === t)
          if ('string' == typeof n) e.style.cssText = n;
            ...
            if (('string' == typeof s && (e.style.cssText = s = ''), s))
              for (t in s) (n && t in n) || U(e.style, t, '');
            if (n) for (t in n) (s && n[t] === s[t]) || U(e.style, t, n[t]);
          }
        else if ('o' === t[0] && 'n' === t[1])
          (r = t !== (t = t.replace(h, '$1'))),
            (t =
            ...
            n
              ? s
                ? (n.u = s.u)
                : ((n.u = d), e.addEventListener(t, r ? f : p, r))
      ...
      function H(e, t, n, s, r, o, a, c, l, u) {
        var h,
          d,
          p,
          f,
        ...
        128 & n.__u && ((l = !!(32 & n.__u)), (o = [(c = t.__e = n.__e)])), (h = i.__b) && h(t);
        e: if ('function' == typeof R)
          try {
            if (
              ((_ = t.props),
              (k = 'prototype' in R && R.prototype.render),
              (C = (h = R.contextType) && s[h.__c]),
              (E = h ? (C ? C.props.value : h.__) : s),
              n.__c
                ? (y = (d = t.__c = n.__c).__ = d.__E)
                : (k
                    ? (t.__c = d = new R(_, E))
                    : ((t.__c = d = new x(_, E)), (d.constructor = R), (d.render = F)),
                  C && C.sub(d),
                  (d.props = _),
                  d.state || (d.state = {}),
                  (d.context = E),
                  ...
                  (d.__h = []),
                  (d._sb = [])),
              k && null == d.__s && (d.__s = d.state),
              k &&
                null != R.getDerivedStateFromProps &&
                (d.__s == d.state && (d.__s = b({}, d.__s)),
                b(d.__s, R.getDerivedStateFromProps(_, d.__s))),
              (f = d.props),
              (g = d.state),
              (d.__v = t),
              p)
              ...
              k &&
                ...
                k && null != d.componentDidMount && d.__h.push(d.componentDidMount);
            else {
              if (
                (k &&
                  null == R.getDerivedStateFromProps &&
              ...
              null != d.componentWillUpdate && d.componentWillUpdate(_, d.__s, E),
                k &&
            ...
            if (
              ((d.context = E), (d.props = _), (d.__P = e), (d.__e = !1), (L = i.__r), (M = 0), k)
            ) {
              for (
                d.state = d.__s,
                  d.__d = !1,
            ...
            (d.state = d.__s),
              null != d.getChildContext && (s = b(b({}, s), d.getChildContext())),
              k && !p && null != d.getSnapshotBeforeUpdate && (m = d.getSnapshotBeforeUpdate(f, g)),
              (c = P(
                e,
                w((D = null != h && h.type === I && null == h.key ? h.props.children : h))
                  ? D
                  : [D],
                t,
                n,
            ...
            if (((t.__v = null), l || null != o))
              if (e.then) {
                for (t.__u |= l ? 160 : 128; c && 8 === c.nodeType && c.nextSibling; )
                  c = c.nextSibling;
                (o[o.indexOf(c)] = null), (t.__e = c);
              } else for (N = o.length; N--; ) v(o[N]);
          ...
          null == o && t.__v === n.__v
            ...
            : (c = t.__e = B(n.__e, t, n, s, r, o, a, l, u));
        return (h = i.diffed) && h(t), 128 & t.__u ? void 0 : c;
      }
      function W(e, t, n) {
        for (var s = 0; s < n.length; s++) q(n[s], n[++s], n[++s]);
        i.__c && i.__c(t, e),
          e.some(function (t) {
            try {
              (e = t.__h),
      ...
      function B(e, t, n, r, o, a, c, l, u) {
        ...
        if (null == e) {
          ...
          (e = document.createElementNS(o, C, k.is && k)),
            l && (i.__m && i.__m(t, a), (l = !1)),
            (a = null);
        }
        if (null === C) b === k || (l && e.data === k) || (e.data = k);
        else {
          if (((a = a && s.call(e.childNodes)), (b = n.props || m), !l && null != a))
            for (b = {}, h = 0; h < e.attributes.length; h++)
              b[(g = e.attributes[h]).name] = g.value;
          for (h in b)
            if (((g = b[h]), 'children' == h));
            else if ('dangerouslySetInnerHTML' == h) p = g;
            else if (!(h in k)) {
              if (
                ('value' == h && 'defaultValue' in k) ||
                ('checked' == h && 'defaultChecked' in k)
              )
                continue;
              O(e, h, null, g, o);
            }
              ...
              'children' == h
                ...
                : 'dangerouslySetInnerHTML' == h
                  ...
                  : 'value' == h
                    ...
                    : 'checked' == h
                      ? (_ = g)
                      : (l && 'function' != typeof g) || b[h] === g || O(e, h, g, b[h], o);
          if (d)
            l ||
            ...
            for (h = a.length; h--; ) v(a[h]);
          l ||
            ((h = 'value'),
            'progress' === C && null == y
              ? e.removeAttribute('value')
              : void 0 !== y &&
                (y !== e[h] || ('progress' === C && !y) || ('option' === C && y !== b[h])) &&
                O(e, h, y, b[h], o),
            (h = 'checked'),
            void 0 !== _ && _ !== e[h] && O(e, h, _, b[h], o));
        }
        return e;
      }
      function q(e, t, n) {
      ...
      function V(e, t, n) {
        ...
        if (
          ...
          (s = e.ref) && ((s.current && s.current !== e.__e) || q(s, null, t)),
          null != (s = e.__c))
        ) {
        ...
        if ((s = e.__k))
          for (r = 0; r < s.length; r++) s[r] && V(s[r], t, n || 'function' != typeof e.type);
        n || v(e.__e), (e.__c = e.__ = e.__e = void 0);
      }
      function F(e, t, n) {
      ...
      function z(e, t, n) {
        ...
        t === document && (t = document.documentElement),
          ...
          H(
            ...
            m,
            t.namespaceURI,
            !r && n ? [n] : o ? null : t.firstChild ? s.call(t.childNodes) : null,
            a,
      ...
      function K(e, t, n) {
        ...
        return (
          arguments.length > 2 && (c.children = arguments.length > 3 ? s.call(arguments, 2) : n),
          C(e.type, c, i || e.key, r || e.ref, null)
        );
      }
      function $(e, t) {
        var n = {
    ...
    30396: function (e, t, n) {
      ...
      function b(e, t) {
        var n = y(s++, 3);
        !u.__s && T(n.__H, t) && ((n.__ = e), (n.i = t), i.__H.__h.push(n));
      }
      function v(e, t) {
        var n = y(s++, 4);
        !u.__s && T(n.__H, t) && ((n.__ = e), (n.i = t), i.__h.push(n));
      }
      function k(e) {
        return (
          (c = 5),
        ...
        (u.__r = function (e) {
          ...
          t &&
            (r === i
              ...
              : (t.__h.forEach(N), t.__h.forEach(R), (t.__h = []), (s = 0))),
            (r = i);
        }),
        (u.diffed = function (e) {
          p && p(e);
          ...
          t &&
            t.__H &&
            (t.__H.__h.length &&
              ((1 !== l.push(t) && o === u.requestAnimationFrame) ||
                ((o = u.requestAnimationFrame) || D)(A)),
      ...
      function D(e) {
        var t,
          n = function () {
            clearTimeout(s), P && cancelAnimationFrame(t), setTimeout(e);
          },
          s = setTimeout(n, 100);
    ...
    42817: function (e, t, n) {
      ...
      function u(e, t) {
        ...
        if ('bytes' === e)
          return (
            (t = new s(t)),
            (h = s.concat([u('uint256', t.length), t])),
            t.length % 32 !== 0 && (h = s.concat([h, i.zeros(32 - (t.length % 32))])),
            h
          );
        if (e.startsWith('bytes')) {
          if ((n = o(e)) < 1 || n > 32) throw new Error('Invalid bytes<N> width: ' + n);
          return i.setLengthRight(t, 32);
        }
        if (e.startsWith('uint')) {
          if ((n = o(e)) % 8 || n < 8 || n > 256) throw new Error('Invalid uint<N> width: ' + n);
          r = l(t);
          const s = i.bitLengthFromBigInt(r);
          if (s > n) throw new Error('Supplied uint exceeds width: ' + n + ' vs ' + s);
          if (r < 0) throw new Error('Supplied uint is negative');
          return i.bufferBEFromBigInt(r, 32);
        }
        if (e.startsWith('int')) {
          if ((n = o(e)) % 8 || n < 8 || n > 256) throw new Error('Invalid int<N> width: ' + n);
          r = l(t);
          const s = i.bitLengthFromBigInt(r);
          if (s > n) throw new Error('Supplied int exceeds width: ' + n + ' vs ' + s);
          const a = i.twosFromBigInt(r, 256);
          return i.bufferBEFromBigInt(a, 32);
        }
        if (e.startsWith('ufixed')) {
          if (((n = a(e)), (r = l(t)) < 0)) throw new Error('Supplied ufixed is negative');
          return u('uint256', r * BigInt(2) ** BigInt(n[1]));
        }
        if (e.startsWith('fixed')) return (n = a(e)), u('int256', l(t) * BigInt(2) ** BigInt(n[1]));
      ...
      function d(e, t) {
        ...
        for (var n, a, c = [], u = 0; u < e.length; u++) {
          var h = r(e[u]),
            d = t[u];
          if ('bytes' === h) c.push(d);
          else if ('string' === h) c.push(new s(d, 'utf8'));
          else if ('bool' === h) c.push(new s(d ? '01' : '00', 'hex'));
          else if ('address' === h) c.push(i.setLength(d, 20));
          else if (h.startsWith('bytes')) {
            if ((n = o(h)) < 1 || n > 32) throw new Error('Invalid bytes<N> width: ' + n);
            c.push(i.setLengthRight(d, n));
          } else if (h.startsWith('uint')) {
            if ((n = o(h)) % 8 || n < 8 || n > 256) throw new Error('Invalid uint<N> width: ' + n);
            a = l(d);
            const e = i.bitLengthFromBigInt(a);
            if (e > n) throw new Error('Supplied uint exceeds width: ' + n + ' vs ' + e);
            c.push(i.bufferBEFromBigInt(a, n / 8));
          } else {
            if (!h.startsWith('int')) throw new Error('Unsupported or invalid type: ' + h);
            {
              if ((n = o(h)) % 8 || n < 8 || n > 256) throw new Error('Invalid int<N> width: ' + n);
              a = l(d);
              const e = i.bitLengthFromBigInt(a);
              if (e > n) throw new Error('Supplied int exceeds width: ' + n + ' vs ' + e);
              const t = i.twosFromBigInt(a, n);
      ...
      e.exports = {
        rawEncode: function (e, t) {
          ...
          for (var a in e) {
            var c = r(e[a]),
              l = u(c, t[a]);
            h(c) ? (n.push(u('uint256', o)), i.push(l), (o += l.length)) : n.push(l);
          }
        ...
        a = {
          encodeData(e, t, n, o = !0) {
            ...
            if (o) {
                ...
                if (void 0 !== n[t])
                  return [
                    ...
                    null == a
                      ...
                      : i.keccak(this.encodeData(t, a, n, o)),
                  ];
                if (void 0 === a) throw new Error(`missing value for field ${e} of type ${t}`);
                if ('bytes' === t) return ['bytes32', i.keccak(a)];
                if ('string' === t)
                  return 'string' === typeof a && (a = s.from(a, 'utf8')), ['bytes32', i.keccak(a)];
              ...
              for (const s of n[e]) {
                const [e, n] = l(s.name, s.type, t[s.name]);
                a.push(e), c.push(n);
              }
            } else
              for (const r of n[e]) {
                let e = t[r.name];
                if (void 0 !== e)
                  if ('bytes' === r.type) a.push('bytes32'), (e = i.keccak(e)), c.push(e);
                    ...
                    a.push('bytes32'), (e = i.keccak(this.encodeData(r.type, e, n, o))), c.push(e);
                  else {
                    if (r.type.lastIndexOf(']') === r.type.length - 1)
                      throw new Error('Arrays currently unimplemented in encodeData');
                    a.push(r.type), c.push(e);
                  }
              }
            return r.rawEncode(a, c);
          },
          encodeType(e, t) {
            let n = '',
          ...
          findTypeDependencies(e, t, n = []) {
            ...
            n.push(e);
            for (const s of t[e])
              for (const e of this.findTypeDependencies(s.type, t, n)) !n.includes(e) && n.push(e);
            return n;
          },
          ...
          sanitizeData(e) {
            const t = {};
            for (const n in o.properties) e[n] && (t[n] = e[n]);
        ...
        hashForSignTypedDataLegacy: function (e) {
          return (function (e) {
            ...
            return r.soliditySHA3(
              ['bytes32', 'bytes32'],
              [r.soliditySHA3(new Array(e.length).fill('string'), o), r.soliditySHA3(s, n)]
            );
          })(e.data);
        },
    ...
    91488: function (e, t, n) {
      ...
      function o(e, t) {
        let n = e.toString(16);
        n.length % 2 !== 0 && (n = '0' + n);
        const i = n.match(/.{1,2}/g).map((e) => parseInt(e, 16));
      ...
      function c(e) {
        if (!s.isBuffer(e))
          if (Array.isArray(e)) e = s.from(e);
            ...
            e = l(e) ? s.from((t = u(e)).length % 2 ? '0' + t : t, 'hex') : s.from(e);
          else if ('number' === typeof e) e = intToBuffer(e);
          else if (null === e || void 0 === e) e = s.allocUnsafe(0);
          else if ('bigint' === typeof e) e = o(e);
          else {
    ...
    86261: function (e, t, n) {
      ...
      function c(e, t = a) {
        if (e && Number.isInteger(e)) {
          ...
          if (u(e)) return 'Unspecified server error.';
        }
        return t;
      }
      function l(e, { shouldIncludeStack: t = !1 } = {}) {
        const n = {};
        if (
          e &&
          'object' === typeof e &&
          ...
          (n.code = t.code),
            t.message && 'string' === typeof t.message
              ? ((n.message = t.message), d(t, 'data') && (n.data = t.data))
              : ((n.message = c(n.code)), (n.data = { originalError: h(e) }));
        } else
          (n.code = i.internal),
            (n.message = p(e, 'message') ? e.message : a),
            (n.data = { originalError: h(e) });
        return t && (n.stack = p(e, 'stack') ? e.stack : void 0), n;
      }
      function u(e) {
      ...
      const f = {
          parse: (e) => m(i.parse, e),
          invalidRequest: (e) => m(i.invalidRequest, e),
          invalidParams: (e) => m(i.invalidParams, e),
          methodNotFound: (e) => m(i.methodNotFound, e),
          internal: (e) => m(i.internal, e),
          server: (e) => {
          ...
          invalidInput: (e) => m(i.invalidInput, e),
          resourceNotFound: (e) => m(i.resourceNotFound, e),
          resourceUnavailable: (e) => m(i.resourceUnavailable, e),
          transactionRejected: (e) => m(i.transactionRejected, e),
          methodNotSupported: (e) => m(i.methodNotSupported, e),
          limitExceeded: (e) => m(i.limitExceeded, e),
        },
        g = {
          userRejectedRequest: (e) => y(r.userRejectedRequest, e),
          unauthorized: (e) => y(r.unauthorized, e),
          unsupportedMethod: (e) => y(r.unsupportedMethod, e),
          disconnected: (e) => y(r.disconnected, e),
          chainDisconnected: (e) => y(r.chainDisconnected, e),
          unsupportedChain: (e) => y(r.unsupportedChain, e),
          custom: (e) => {
            if (!e || 'object' !== typeof e || Array.isArray(e))
              throw new Error(
      ...
      function m(e, t) {
        const [n, s] = _(t);
        return new w(e, n || c(e), s);
      }
      function y(e, t) {
        const [n, s] = _(t);
        return new b(e, n || c(e), s);
      }
      function _(e) {
        if (e) {
      ...
      function H(e, t = !1) {
        let n = (function (e, t = !1) {
          if ('string' === typeof e) {
            ...
            if (S.test(n)) return v(t ? `0x${n}` : n);
          }
          throw f.invalidParams(`"${String(e)}" is not a hexadecimal string`);
        })(e, !1);
      ...
      function W(e) {
        if ('string' === typeof e) {
          const t = U(e).toLowerCase();
          if (j(t) && 40 === t.length) return k(O(t));
        }
        throw f.invalidParams(`Invalid Ethereum address: ${String(e)}`);
      }
      function B(e) {
        ...
        throw f.invalidParams(`Not binary data: ${String(e)}`);
      }
      function q(e) {
        if ('number' === typeof e && Number.isInteger(e)) return E(e);
        if ('string' === typeof e) {
          if (x.test(e)) return E(Number(e));
          if (j(e)) return E(Number(BigInt(H(e, !0))));
        }
        throw f.invalidParams(`Not an integer: ${String(e)}`);
      }
      function V(e) {
        if (
          null !== e &&
        ...
        if ('number' === typeof e) return BigInt(q(e));
        if ('string' === typeof e) {
          if (x.test(e)) return BigInt(e);
          if (j(e)) return BigInt(H(e, !0));
        }
        throw f.invalidParams(`Not an integer: ${String(e)}`);
      }
      function F(e) {
        ...
        throw f.invalidParams(`Not a JSON string or an object: ${String(e)}`);
      }
      function z() {
        const e =
      ...
      async function G(e, t) {
        return (async function (e, t) {
          ...
          JSON.stringify(e, (e, t) => {
            ...
            const n = t;
            return Object.assign(Object.assign({}, n.code ? { code: n.code } : {}), {
              message: n.message,
            });
          })
        );
      ...
      async function J(e, t) {
        return JSON.parse(
          await (async function (e, { iv: t, cipherText: n }) {
            const s = await crypto.subtle.decrypt({ name: 'AES-GCM', iv: t }, e, n);
            return new TextDecoder().decode(s);
          })(t, e)
        );
      }
      const Y = { storageKey: 'ownPrivateKey', keyType: 'private' },
        Q = { storageKey: 'ownPublicKey', keyType: 'public' },
        X = { storageKey: 'peerPublicKey', keyType: 'public' };
      class ee {
        constructor() {
        ...
        async loadKeysIfNeeded() {
          if (
            ...
            null === this.peerPublicKey && (this.peerPublicKey = await this.loadKey(X)),
            null === this.sharedSecret)
          ) {
            if (null === this.ownPrivateKey || null === this.peerPublicKey) return;
            this.sharedSecret = await (async function (e, t) {
        ...
        async storeKey(e, t) {
          const n = await K(e.keyType, t);
          this.storage.setItem(e.storageKey, n);
        }
      }
      const te = '4.3.0',
        ne = '@coinbase/wallet-sdk';
      async function se(e, t) {
        const n = Object.assign(Object.assign({}, e), { jsonrpc: '2.0', id: crypto.randomUUID() }),
          s = await window.fetch(t, {
            ...
            headers: {
              ...
              'X-Cbw-Sdk-Version': te,
              'X-Cbw-Sdk-Platform': ne,
            },
          }),
      ...
      function ie({ metadata: e, preference: t }) {
        var n, s;
        const { appName: i, appLogoUrl: r, appChainIds: o } = e;
        if ('smartWalletOnly' !== t.options) {
          const e = globalThis.coinbaseWalletExtension;
          if (e) return null === (n = e.setAppInfo) || void 0 === n || n.call(e, i, r, o, t), e;
        }
        const a = (function () {
          var e, t;
          try {
        ...
        if (null === a || void 0 === a ? void 0 : a.isCoinbaseBrowser)
          return null === (s = a.setAppInfo) || void 0 === s || s.call(a, i, r, o, t), a;
      }
      const re = 'accounts',
        oe = 'activeChain',
        ae = 'availableChains',
        ce = 'walletCapabilities';
      class le {
        constructor(e) {
          var t, n, i;
          (this.metadata = e.metadata),
            ...
            (this.keyManager = new ee()),
            (this.storage = new s('CBWSDK', 'SCWStateManager')),
            (this.accounts = null !== (t = this.storage.loadObject(re)) && void 0 !== t ? t : []),
            (this.chain = this.storage.loadObject(oe) || {
              id:
                null !==
        ...
        async handshake(e) {
          ...
          const r = await this.createRequestMessage({
            ...
            o = await this.communicator.postRequestAndWaitForResponse(r);
          if ('failure' in o.content) throw o.content.failure;
          const a = await $('public', o.sender);
          await this.keyManager.setPeerPublicKey(a);
          const c = (await this.decryptResponseMessage(o)).result;
          if ('error' in c) throw c.error;
          switch (e.method) {
            case 'eth_requestAccounts': {
              const e = c.value;
              (this.accounts = e),
                this.storage.storeObject(re, e),
        ...
        async request(e) {
          ...
          switch (e.method) {
            ...
            case 'wallet_getCapabilities':
              return this.storage.loadObject(ce);
            ...
            default:
              if (!this.chain.rpcUrl) throw f.internal('No RPC URL set for chain');
              return se(e, this.chain.rpcUrl);
          }
        }
        ...
        async handleSwitchChainRequest(e) {
          ...
          if (!n || !(null === (t = n[0]) || void 0 === t ? void 0 : t.chainId))
            throw f.invalidParams();
          const s = q(n[0].chainId);
          if (this.updateChain(s)) return null;
          const i = await this.sendRequestToPopup(e);
        ...
        async sendEncryptedRequest(e) {
          ...
          const n = await G({ action: e, chainId: this.chain.id }, t),
        ...
        async createRequestMessage(e) {
          const t = await K('public', await this.keyManager.getOwnPublicKey());
        ...
        async decryptResponseMessage(e) {
          ...
          if (!i) throw g.unauthorized('Invalid session');
          const r = await J(s.encrypted, i),
            o = null === (t = r.data) || void 0 === t ? void 0 : t.chains;
          if (o) {
            const e = Object.entries(o).map(([e, t]) => ({ id: Number(e), rpcUrl: t }));
            this.storage.storeObject(ae, e), this.updateChain(this.chain.id, e);
          }
          const a = null === (n = r.data) || void 0 === n ? void 0 : n.capabilities;
          return a && this.storage.storeObject(ce, a), r;
        }
        updateChain(e, t) {
          var n;
          const s = null !== t && void 0 !== t ? t : this.storage.loadObject(ae),
            i = null === s || void 0 === s ? void 0 : s.find((t) => t.id === e);
          return (
            !!i &&
            (i !== this.chain &&
              ((this.chain = i),
              this.storage.storeObject(oe, i),
              null === (n = this.callback) ||
                void 0 === n ||
                n.call(this, 'chainChanged', R(i.id))),
            !0)
          );
        }
      }
      ...
      class pe {
        ...
        async encrypt(e) {
          ...
          const n = crypto.getRandomValues(new Uint8Array(12)),
            s = await crypto.subtle.importKey('raw', A(t), { name: 'aes-gcm' }, !1, [
              'encrypt',
              'decrypt',
            ]),
            i = new TextEncoder(),
            r = await window.crypto.subtle.encrypt({ name: 'AES-GCM', iv: n }, s, i.encode(e)),
            o = r.slice(r.byteLength - 16),
            a = r.slice(0, r.byteLength - 16),
            c = new Uint8Array(o),
            l = new Uint8Array(a);
        ...
        async decrypt(e) {
          ...
          return new Promise((n, s) => {
            !(async function () {
              const i = await crypto.subtle.importKey('raw', A(t), { name: 'aes-gcm' }, !1, [
                  'encrypt',
                  'decrypt',
                ]),
                r = A(e),
        ...
        constructor({ session: e, linkAPIUrl: t, listener: n }) {
          (this.destroyed = !1),
            ...
            (this.handleMetadataUpdated = async (e, t) => {
              var n;
              const s = await this.cipher.decrypt(t);
            ...
            (this.session = e),
            (this.cipher = new pe(e.secret)),
            (this.listener = n);
          const s = new me(`${t}/rpc`, WebSocket);
          s.setConnectionStateListener(async (e) => {
            ...
            s.setIncomingDataListener((e) => {
              ...
              switch (e.type) {
                ...
                case 'IsLinkedOK':
                case 'Linked': {
                  const t = 'IsLinkedOK' === e.type ? e.linked : void 0;
            ...
            Promise.race([
              ...
              new Promise((e) => {
                this.requestResolutions.set(n, (t) => {
                  clearTimeout(s), e(t), this.requestResolutions.delete(n);
                });
              }),
            ])
          );
      ...
      const ke = (e) => new DataView(e.buffer, e.byteOffset, e.byteLength),
        Ce = (e, t) => (e << (32 - t)) | (e >>> t);
      const Ee = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, '0'));
      function Ie(e) {
        return (
          'string' === typeof e &&
            (e = (function (e) {
      ...
      function xe(e) {
        const t = (t) => e().update(Ie(t)).digest(),
          n = e();
        return (t.outputLen = n.outputLen), (t.blockLen = n.blockLen), (t.create = () => e()), t;
      }
      const Se = (e, t, n) => (e & t) ^ (e & n) ^ (t & n);
      const Le = new Uint32Array([
      ...
      class Pe extends class extends class {
        clone() {
          return this._cloneInto();
        }
      } {
        ...
        digestInto(e) {
          be(this), ve(e, this), (this.finished = !0);
          const { buffer: t, view: n, blockLen: s, isLE: i } = this;
          let { pos: r } = this;
          (t[r++] = 128),
            this.buffer.subarray(r).fill(0),
            this.padOffset > s - r && (this.process(n, 0), (r = 0));
          for (let u = r; u < s; u++) t[u] = 0;
          !(function (e, t, n, s) {
        ...
        _cloneInto(e) {
          ...
          const { blockLen: t, buffer: n, length: s, finished: i, destroyed: r, pos: o } = this;
          return (
            (e.length = s),
            (e.pos = o),
            (e.finished = i),
        ...
        get() {
          const { A: e, B: t, C: n, D: s, E: i, F: r, G: o, H: a } = this;
          return [e, t, n, s, i, r, o, a];
        }
        set(e, t, n, s, i, r, o, a) {
          (this.A = 0 | e),
            (this.B = 0 | t),
        ...
        process(e, t) {
          for (let h = 0; h < 16; h++, t += 4) Ae[h] = e.getUint32(t, !1);
          for (let h = 16; h < 64; h++) {
            const e = Ae[h - 15],
              t = Ae[h - 2],
              n = Ce(e, 7) ^ Ce(e, 18) ^ (e >>> 3),
              s = Ce(t, 17) ^ Ce(t, 19) ^ (t >>> 10);
            Ae[h] = (s + Ae[h - 7] + n + Ae[h - 16]) | 0;
          }
          let { A: n, B: s, C: i, D: r, E: o, F: a, G: c, H: l } = this;
          for (let h = 0; h < 64; h++) {
            const e =
                (l +
                  (Ce(o, 6) ^ Ce(o, 11) ^ Ce(o, 25)) +
                  (((u = o) & a) ^ (~u & c)) +
                  Le[h] +
                  Ae[h]) |
                0,
              t = ((Ce(n, 2) ^ Ce(n, 13) ^ Ce(n, 22)) + Se(n, s, i)) | 0;
            (l = c),
              (c = a),
              (a = o),
              (o = (r + e) | 0),
      ...
      class Ue {
        constructor(e, t, n, s = !1) {
          (this.storage = e),
            ...
            (this.key = (function (e) {
              we(e);
              let t = '';
              for (let n = 0; n < e.length; n++) t += Ee[e[n]];
              return t;
            })(De(`${t}, ${n} WalletLink`))),
            (this._linked = !!s);
        }
        static create(e) {
          const t = L(16),
            n = L(32);
          return new Ue(e, t, n).save();
        }
        static load(e) {
          const t = e.getItem(Ne),
            n = e.getItem(Te),
            s = e.getItem(Re);
          return t && s ? new Ue(e, t, s, '1' === n) : null;
        }
        get linked() {
          return this._linked;
        }
        ...
        save() {
          return (
            this.storage.setItem(Ne, this.id),
            this.storage.setItem(Re, this.secret),
            this.persistLinked(),
            this
          );
        }
        persistLinked() {
          this.storage.setItem(Te, this._linked ? '1' : '0');
        }
      }
      function Oe() {
        try {
      ...
      function je() {
        ...
        return (
          null !==
            (t =
              null === (e = null === window || void 0 === window ? void 0 : window.matchMedia) ||
              void 0 === e
                ? void 0
              ...
              (0, Be.h)(
                ...
                (0, Be.h)(
                  ...
                  Array.from(this.items.entries()).map(([e, t]) =>
                    (0, Be.h)(ze, Object.assign({}, t, { key: e }))
                  )
                )
              ),
              this.root
      ...
      const Fe = (e) =>
          (0, Be.h)(
            'div',
            { class: (0, We.clsx)('-cbwsdk-snackbar-container') },
            (0, Be.h)(
              'style',
              null,
            ...
            (0, Be.h)('div', { class: '-cbwsdk-snackbar' }, e.children)
          ),
        ze = ({ autoExpand: e, message: t, menuItems: n }) => {
          const [s, i] = (0, qe.useState)(!0),
            [r, o] = (0, qe.useState)(null !== e && void 0 !== e && e);
          (0, qe.useEffect)(() => {
            const e = [
              window.setTimeout(() => {
                i(!1);
          ...
          return (0, Be.h)(
            ...
            (0, Be.h)(
              ...
              ' ',
              (0, Be.h)('div', { class: '-cbwsdk-snackbar-instance-header-message' }, t),
              (0, Be.h)(
                'div',
                ...
                !r &&
                  (0, Be.h)(
                    ...
                    (0, Be.h)('circle', { cx: '12', cy: '12', r: '12', fill: '#F5F7F8' })
                  ),
                (0, Be.h)('img', {
      ...
      class Ze {
        constructor() {
          (this.attached = !1), (this.snackbar = new Ve());
        }
        attach() {
      ...
      class Ke {
        constructor() {
          (this.root = null), (this.darkMode = je());
        }
        attach() {
          const e = document.documentElement;
          (this.root = document.createElement('div')),
      ...
      const $e = ({ title: e, buttonText: t, darkMode: n, onButtonClick: s, onDismiss: i }) => {
          ...
          return (0, Be.h)(
            ...
            (0, Be.h)(
              ...
              (0, Be.h)('div', { class: '-cbwsdk-redirect-dialog-backdrop', onClick: i }),
              (0, Be.h)(
                'div',
                { class: (0, We.clsx)('-cbwsdk-redirect-dialog-box', r) },
                (0, Be.h)('p', null, e),
                (0, Be.h)('button', { onClick: s }, t)
              )
            )
          );
        },
        Ge = 'https://www.walletlink.org';
      class Je {
        constructor() {
          (this.attached = !1), (this.redirectDialog = new Ke());
        }
        attach() {
          if (this.attached) throw new Error('Coinbase Wallet SDK UI is already attached');
        ...
        redirectToCoinbaseWallet(e) {
          ...
          t.searchParams.append('redirect_url', Oe().href), e && t.searchParams.append('wl_url', e);
      ...
      class Ye {
        constructor(e) {
          (this.chainCallbackParams = { chainId: '', jsonRpcUrl: '' }),
            ...
            (this.linkedUpdated = (e) => {
              this.isLinked = e;
              const t = this.storage.getItem(he);
            ...
            (this.accountUpdated = (e) => {
              this.accountsCallback && this.accountsCallback([e]),
                Ye.accountRequestCallbackIds.size > 0 &&
                  (Array.from(Ye.accountRequestCallbackIds.values()).forEach((t) => {
                    this.invokeCallback(t, { method: 'requestEthereumAccounts', result: [e] });
                  }),
                  Ye.accountRequestCallbackIds.clear());
            }),
          ...
          (this._session = t),
            (this.connection = s),
            (this.relayEventManager = new _e()),
            (this.ui = n),
            this.ui.attach();
        }
        subscribe() {
          const e = Ue.load(this.storage) || Ue.create(this.storage),
            { linkAPIUrl: t } = this,
            n = new ye({ session: e, linkAPIUrl: t, listener: this }),
            s = this.isMobileWeb ? new Je() : new Ze();
        ...
        resetAndReload() {
          this.connection
            .destroy()
            .then(() => {
              const e = Ue.load(this.storage);
              (null === e || void 0 === e ? void 0 : e.id) === this._session.id && s.clearAll(),
        ...
        signAndSubmitEthereumTransaction(e) {
          return this.sendRequest({
            ...
            params: {
              ...
              maxPriorityFeePerGas: e.maxPriorityFeePerGas ? N(e.maxPriorityFeePerGas) : null,
              gasLimit: e.gasLimit ? N(e.gasLimit) : null,
              chainId: e.chainId,
              shouldSubmit: !0,
            },
          ...
          return new Promise((i, r) => {
            (t = this.ui.showConnecting({
              ...
              this.relayEventManager.callbacks.set(n, (e) => {
                if ((null === t || void 0 === t || t(), de(e))) return r(new Error(e.errorMessage));
                i(e);
              }),
        ...
        handleWeb3ResponseMessage(e, t) {
          if ('requestEthereumAccounts' === t.method)
            return (
              Ye.accountRequestCallbackIds.forEach((e) => this.invokeCallback(e, t)),
              void Ye.accountRequestCallbackIds.clear()
            );
        ...
        handleErrorResponse(e, t, n) {
          var s;
          const i =
            null !== (s = null === n || void 0 === n ? void 0 : n.message) && void 0 !== s
              ? s
        ...
        requestEthereumAccounts() {
          ...
          return new Promise((e, t) => {
            this.relayEventManager.callbacks.set(s, (n) => {
              if (de(n)) return t(new Error(n.errorMessage));
              e(n);
            }),
              Ye.accountRequestCallbackIds.add(s),
          ...
          return (
            ...
            new Promise((e, t) => {
              this.relayEventManager.callbacks.set(c, (n) => {
                if ((null === a || void 0 === a || a(), de(n))) return t(new Error(n.errorMessage));
                e(n);
              }),
      ...
      Ye.accountRequestCallbackIds = new Set();
      var Qe = n(48764).Buffer;
      ...
      class tt {
        constructor(e) {
          (this._relay = null),
            (this._addresses = []),
            (this.metadata = e.metadata),
            (this._storage = new s('walletlink', Ge)),
            (this.callback = e.callback || null);
          const t = this._storage.getItem(he);
          if (t) {
            const e = t.split(' ');
        ...
        get jsonRpcUrl() {
          var e;
          return null !== (e = this._storage.getItem(et)) && void 0 !== e ? e : void 0;
        }
        set jsonRpcUrl(e) {
        ...
        updateProviderInfo(e, t) {
          ...
          this._storage.setItem(Xe, t.toString(10));
          q(t) !== s &&
            (null === (n = this.callback) || void 0 === n || n.call(this, 'chainChanged', R(t)));
        }
        async watchAsset(e) {
          const t = Array.isArray(e) ? e[0] : e;
          if (!t.type) throw f.invalidParams('Type is required');
          if ('ERC20' !== (null === t || void 0 === t ? void 0 : t.type))
            throw f.invalidParams(`Asset of type '${t.type}' is not supported`);
          if (!(null === t || void 0 === t ? void 0 : t.options))
            throw f.invalidParams('Options are required');
          if (!(null === t || void 0 === t ? void 0 : t.options.address))
            throw f.invalidParams('Address is required');
          const n = this.getChainId(),
            { address: s, symbol: i, image: r, decimals: o } = t.options,
            a = this.initializeRelay(),
            c = await a.watchAsset(
              t.type,
              s,
              i,
              o,
          ...
          return !de(c) && !!c.result;
        }
        async addEthereumChain(e) {
          var t, n;
          const s = e[0];
          if (0 === (null === (t = s.rpcUrls) || void 0 === t ? void 0 : t.length))
            throw f.invalidParams('please pass in at least 1 rpcUrl');
          if (!s.chainName || '' === s.chainName.trim())
            throw f.invalidParams('chainName is a required field');
          if (!s.nativeCurrency) throw f.invalidParams('nativeCurrency is a required field');
          const i = Number.parseInt(s.chainId, 16);
          ...
          const r = this.initializeRelay(),
            ...
            h = await r.addEthereumChain(i.toString(), o, l, a, c, u);
          if (de(h)) return !1;
          if (!0 === (null === (n = h.result) || void 0 === n ? void 0 : n.isApproved))
            return this.updateProviderInfo(o[0], i), null;
          throw f.internal('unable to add ethereum chain');
        }
        async switchEthereumChain(e) {
          const t = e[0],
            n = Number.parseInt(t.chainId, 16),
            s = this.initializeRelay(),
            i = await s.switchEthereumChain(n.toString(10), this.selectedAddress || void 0);
          if (de(i)) throw i;
          const r = i.result;
          return r.isApproved && r.rpcUrl.length > 0 && this.updateProviderInfo(r.rpcUrl, n), null;
        }
        async cleanup() {
          (this.callback = null),
        ...
        _setAddresses(e, t) {
          ...
          JSON.stringify(s) !== JSON.stringify(this._addresses) &&
            ...
            this._storage.setItem(he, s.join(' ')));
        }
        async request(e) {
          const t = e.params || [];
          switch (e.method) {
            ...
            default:
              if (!this.jsonRpcUrl) throw f.internal('No RPC URL set for chain');
              return se(e, this.jsonRpcUrl);
          }
        }
        ...
        _prepareTransactionParams(e) {
          const t = e.from ? W(e.from) : this.selectedAddress;
          if (!t) throw new Error('Ethereum address is unavailable');
          this._ensureKnownAddress(t);
          return {
            fromAddress: t,
            toAddress: e.to ? W(e.to) : null,
            weiValue: null != e.value ? V(e.value) : BigInt(0),
            data: e.data ? B(e.data) : Qe.alloc(0),
            nonce: null != e.nonce ? q(e.nonce) : null,
            gasPriceInWei: null != e.gasPrice ? V(e.gasPrice) : null,
            maxFeePerGas: null != e.maxFeePerGas ? V(e.maxFeePerGas) : null,
            maxPriorityFeePerGas: null != e.maxPriorityFeePerGas ? V(e.maxPriorityFeePerGas) : null,
            gasLimit: null != e.gas ? V(e.gas) : null,
            chainId: e.chainId ? q(e.chainId) : this.getChainId(),
          };
        }
        async ecRecover(e) {
          const { method: t, params: n } = e;
          if (!Array.isArray(n)) throw f.invalidParams();
        ...
        getChainId() {
          ...
          return Number.parseInt(
            null !== (e = this._storage.getItem(Xe)) && void 0 !== e ? e : '1',
            10
          );
        }
        ...
        async personalSign({ params: e }) {
          if (!Array.isArray(e)) throw f.invalidParams();
          const t = e[1],
            n = e[0];
          this._ensureKnownAddress(t);
          const s = this.initializeRelay(),
            i = await s.sendRequest({
              ...
              params: { address: W(t), message: D(n), addPrefix: !0, typedDataJson: null },
            });
          if (de(i)) throw i;
          return i.result;
        }
        ...
        async signTypedData(e) {
          const { method: t, params: n } = e;
          if (!Array.isArray(n)) throw f.invalidParams();
          const s = n['eth_signTypedData_v1' === t ? 1 : 0],
            i = n['eth_signTypedData_v1' === t ? 0 : 1];
          this._ensureKnownAddress(s);
          const r = this.initializeRelay(),
            o = await r.sendRequest({
              method: 'signEthereumMessage',
              params: {
                address: W(s),
                message:
                  ...
                  P(
                    {
                      eth_signTypedData_v1: ue.hashForSignTypedDataLegacy,
                      eth_signTypedData_v3: ue.hashForSignTypedData_v3,
                      eth_signTypedData_v4: ue.hashForSignTypedData_v4,
                      eth_signTypedData: ue.hashForSignTypedData_v4,
                    }[t]({ data: F(a) }),
                    !0
                  )),
      ...
      const nt = 'SignerType',
        st = new s('CBWSDK', 'SignerConfigurator');
      async function it(e) {
        const { communicator: t, metadata: n, handshakeRequest: s, callback: i } = e;
        (async function (e, t, n) {
          await e.onMessage(({ event: e }) => 'WalletLinkSessionRequest' === e);
          const s = new tt({ metadata: t, callback: n });
        ...
        const r = {
          ...
          { data: o } = await t.postRequestAndWaitForResponse(r);
        return o;
      }
      const { checkCrossOriginOpenerPolicy: rt, getCrossOriginOpenerPolicy: ot } = (() => {
        let e;
        return {
      ...
      function at(e) {
        ...
        !(function (e) {
          const t = { sdkName: ne, sdkVersion: te, origin: window.location.origin, coop: ot() };
          for (const [n, s] of Object.entries(t)) e.searchParams.append(n, s.toString());
        })(e);
        const s = `wallet_${crypto.randomUUID()}`,
          i = window.open(e, s, `width=420, height=540, left=${t}, top=${n}`);
        if ((null === i || void 0 === i || i.focus(), !i))
          throw f.internal('Pop up window failed to open');
        return i;
      }
      class ct {
        constructor({ url: e = 'https://keys.coinbase.com/connect', metadata: t, preference: n }) {
          (this.popup = null),
            ...
            (this.postRequestAndWaitForResponse = async (e) => {
              const t = this.onMessage(({ requestId: t }) => t === e.id);
            ...
            (this.disconnect = () => {
              ...
              (e = this.popup) && !e.closed && e.close(),
                ...
                this.listeners.forEach(({ reject: e }, t) => {
                  e(g.userRejectedRequest('Request rejected')),
              ...
              this.popup && !this.popup.closed
                ...
                : ((this.popup = at(this.url)),
                  ...
                  this.onMessage(({ event: e }) => 'PopupLoaded' === e)
                    ...
                    .then(() => {
                      if (!this.popup) throw f.internal();
                      return this.popup;
                    }))),
            (this.url = new URL(e)),
            (this.metadata = t),
      ...
      function lt(e) {
        const t = l(
            (function (e) {
              var t;
              if ('string' === typeof e) return { message: e, code: i.internal };
              if (de(e)) {
      ...
      class pt extends ht {
        constructor(e) {
          ...
          super(),
            ...
            (this.metadata = t),
            (this.preference = i),
            (this.communicator = new ct({ url: s, metadata: t, preference: i }));
          const r = st.getItem(nt);
            ...
            if (
              ...
              switch (e.method) {
                ...
                case 'wallet_sendCalls': {
                  ...
                  const n = await t.request(e);
                  return await t.cleanup(), n;
                }
                case 'wallet_getCallsStatus':
                  return se(e, 'http://rpc.wallet.coinbase.com');
                case 'net_version':
                  return 1;
                case 'eth_chainId':
                  return R(1);
                default:
                  throw g.unauthorized("Must call 'eth_requestAccounts' before other methods");
              }
            return await this.signer.request(e);
          } catch (t) {
            const { code: e } = t;
            return e === r.unauthorized && this.disconnect(), Promise.reject(lt(t));
          }
        }
        async enable() {
          return (
        ...
        async disconnect() {
          ...
          await (null === (e = this.signer) || void 0 === e ? void 0 : e.cleanup()),
            (this.signer = null),
            s.clearAll(),
            this.emit('disconnect', g.disconnected('User initiated disconnection'));
        }
        ...
        initSigner(e) {
          return (function (e) {
            const { signerType: t, metadata: n, communicator: s, callback: i } = e;
            switch (t) {
              case 'scw':
                return new le({ metadata: n, callback: i, communicator: s });
              case 'walletlink':
                return new tt({ metadata: n, callback: i });
            }
          })({
            signerType: e,
            metadata: this.metadata,
      ...
      function ft(e) {
        if (e) {
          ...
          if (e.attribution && void 0 !== e.attribution.auto && void 0 !== e.attribution.dataSuffix)
      ...
      class gt {
        ...
        makeWeb3Provider(e = { options: 'all' }) {
          ...
          return null !== (t = ie(n)) && void 0 !== t ? t : new pt(n);
        }
        ...
        storeLatestVersion() {
          new s('CBWSDK').setItem('VERSION', te);
        }
      }
      const mt = { options: 'all' };
      function yt(e) {
        var t;
        new s('CBWSDK').setItem('VERSION', te), rt();
        const n = {
          metadata: {
            appName: e.appName || 'Dapp',
          ...
          preference: Object.assign(mt, null !== (t = e.preference) && void 0 !== t ? t : {}),
        };
        ft(n.preference);
        let i = null;
        return {
