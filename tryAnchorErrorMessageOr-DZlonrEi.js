...
var S = (r, e, t) =>
    e in r ? F(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (r[e] = t),
  g = (r, e) => {
...
import { J as L, f as sr } from './transactions-CiIB2wJI.js';
(function () {
  try {
    var r =
        typeof window < 'u'
    ...
    e &&
      ...
      (r._sentryDebugIds[e] = 'd52650a8-6c63-453e-962d-15c20c8a070a'),
      (r._sentryDebugIdIdentifier = 'sentry-dbid-d52650a8-6c63-453e-962d-15c20c8a070a'));
  } catch (t) {}
})();
const x = async (r) =>
    new Promise((e) => {
...
async function lr({
  ...
  const c = P(t) ? T.encode(a) : T.encode(M.Buffer.from(a));
  let p = !1;
  const N = M.Buffer.from(t.serialize()),
    b = [r, ...e],
  ...
  const U = await r.getLatestBlockhashAndContext(n),
    V = async (l) => {
      try {
        for (; !p; ) await l.sendRawTransaction(N, g(g({}, v), o)), await x(ur);
      } catch (W) {
        await y(W, { extra: { rpcEndpoint: l.rpcEndpoint } });
      }
    };
  b.map(V);
  const f = await Promise.race((i ? b : [r]).map((l) => dr(c, U, l, n, s)));
  p = !0;
  const E = (A = f == null ? void 0 : f.value) == null ? void 0 : A.err;
  return (
    E && fr({ error: E, mainConnection: r, signature: c, signedTx: t, mixpanel: s }),
...
const mr = (r, e, t) => {
    if (r === _.toString()) return e === d.code ? new d(t) : $(e, t);
    if (r === R.WHIRLPOOL_PROGRAM_ID.toString()) return Y(e, t);
...
function br(r) {
  ...
  if (r && r.logs) {
    ...
    const { code: a, instructionInd: c } = _r(r.err.toString());
...
export { Er as T, lr as a, ar as b, Ar as c, fr as h, cr as r, Mr as s, kr as t, dr as w };
//# sourceMappingURL=tryAnchorErrorMessageOr-DZlonrEi.js.map
