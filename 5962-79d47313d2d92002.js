try {
  ...
  n &&
    ...
    (e._sentryDebugIds[n] = '795572e3-9116-4c37-bf09-c77059f8c666'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-795572e3-9116-4c37-bf09-c77059f8c666'));
} catch (e) {}
('use strict');
  ...
  [5962],
  {
    ...
    27349: function (e, n, t) {
      ...
      var r = t(78286),
        ...
        E = t(16586),
        d = t(38819);
      let T = (0, d.Z)('div', { target: 'e1x7on5g0' })(
          'width:',
          (e) => {
            let { theme: n } = e;
            return n.padding.s;
      ...
      let R = {
        ...
        g = _.$0l.percent.digits(2).unit('%').default('-');
      var L = (0, i.memo)((e) => {
        let {
            rewards: n,
            netApy: t,
          ...
          { theme: p } = (0, _.TCT)(),
          h = (0, i.useMemo)(
            () => _.$0l.percent.trailingZero(!1).digits(2).unit('%').default('0').of(L, 18),
            [L]
          ),
          S = (0, i.useMemo)(() => {
            if (!(0, c.isDefined)(L)) return L;
            if (!(0, c.isDefined)(d)) return d;
            let e = o.MathLib.wMulDown(-L, d);
            return 0n === e ? '0.00%' : g.sign().of(e, 18);
          }, [L, d]),
          U = (0, i.useCallback)(
            (e) => {
              ...
              return (0, r.tZ)(_.ua7, {
                ...
                children: (0, r.BX)(_.Kqy, {
                  ...
                  align: 'center',
                  children: [
                    c.format.short.digits(2).sign().of(e.proportional.rate, n),
                    (0, r.tZ)(_.JO$, {
          ...
          f = (0, i.useMemo)(() => {
            switch (P) {
              ...
              case 'market':
                return (0, A.yz)({ rewards: n, netRate: t });
              case 'supply':
                return (0, A.Ji)({ rewards: n, netApy: t });
              default:
                return d;
            }
          }, [n, t, d, L, M, P]);
        if (!(0, c.isDefined)(d)) return null;
        let y = 'vault' === P;
        return (0, r.BX)(_.Kqy, {
          style: { padding: ''.concat(p.spacing.s, ' 0') },
          direction: 'column',
          children: [
            (0, r.BX)(u, {
              children: [
                (0, r.BX)(_.Kqy, {
                  ...
                  children: [
                    ...
                    (0, r.tZ)(_.xvT.Body.XXS.Regular, {
                      color: 'text.body',
                      children: 'Native '.concat(N[P]),
                    }),
                  ],
                }),
                (0, r.tZ)(_.xvT.Body.XXS.Regular, { color: 'text.body', children: g.of(f, 18) }),
              ],
            }),
            M instanceof a.YK && y && (0, r.tZ)(O, { asset: M, isVault: !0 }),
            null == n
              ? void 0
              : n.map((e) => {
                  var n, t;
                  return (0, r.BX)(
                    u,
                    {
                      children: [
                        ...
                        (0, r.tZ)(_.xvT.Body.XXS.Regular, { color: 'text.body', children: U(e) }),
                      ],
                    },
            ...
            (M instanceof a.YK && !y) || (null == v ? void 0 : v.length)
              ? (0, r.tZ)(s, { children: (0, r.tZ)(_.Z0O, {}) })
              : null,
            M instanceof a.YK && !y && (0, r.tZ)(O, { asset: M }),
            v &&
              v.length > 0 &&
              (null == v
                ? void 0
    ...
    26726: function (e, n, t) {
      ...
      let T = {
          ...
          AUTO_DELEVERAGE:
            null !== (c = d.clientEnvs.NEXT_PUBLIC_AUTO_DELEVERAGE_FEATURE_FLAG) &&
            void 0 !== c &&
            c,
      ...
      n.ZP = (0, E.memo)((e) => {
        let { children: n } = e,
          [t, r] = (0, E.useState)(T),
          i = (0, E.useCallback)((e, n) => r((t) => ({ ...t, [e]: n })), [r]);
        return (0, A.tZ)(u.Provider, {
    ...
    964: function (e, n, t) {
      ...
      let a = (e) => {
          var n, t;
          let { rewards: a, netApy: _, nativeApy: c, performanceFee: A, asset: E } = e;
          if (!(0, o.isDefined)(c)) return c;
          ...
          let d =
              null !==
                ...
                ? n
                : 0n,
            T = r.MathLib.wMulDown(null != A ? A : 0n, null != c ? c : 0n),
            u =
              E instanceof l.YK
                ? (0, i.safeParseNumber)(null !== (t = E.yield) && void 0 !== t ? t : 0)
                : 0n;
          return r.MathLib.max(_ + T - d - u, 0n);
        },
        _ = (e) => {
          var n;
          let { rewards: t, netApy: r } = e;
    ...
    6423: function (e, n, t) {
      ...
      let d = (e) => {
        ...
        T = (e) => {
          ...
          return A(''.concat(n.trim(), '-').concat(t.trim()));
        };
      ((i = o || (o = {})).Market = 'market'),
      ...
      let u = (e) => {
          ...
          return '/'
            ...
            .concat(t, '/')
            .concat(T({ collateralSymbol: r, loanSymbol: i }))
