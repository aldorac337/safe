    ...
    70946: function (e, t, r) {
      ...
      var h = function (e) {
        var t = e.loading,
          ...
          m = (0, a.Z)(e, f),
          h = new u.O(r).minus(n),
          x = n && '0' !== n ? h.dividedBy(n).times(100).toFixed(2) : '0';
        '-0.00' === x && (x = '0.00');
        var g = Math.abs(Number(x)) > 10;
        return (0, d.jsx)(
          p.G,
          v(
            v(
      ...
      var n = r(80854),
        ...
        x = function (e) {
          var t,
            ...
            I = _.isWrongNetwork,
            L = _.requiredChainId;
          if (S && S.blocking) return (0, h.jsx)(v.D, { txError: S });
          ...
          return (0, h.jsxs)(i.hv, {
            asset: B,
            children: [
              !E.success && (0, h.jsx)(f.E, { title: b, symbol: x ? void 0 : R }),
              I &&
                !A &&
                (0, h.jsx)(m.I, {
    ...
    87886: function (e, t, r) {
      ...
      var n,
        ...
        b =
          ...
          (0, s.Z)(n, u.a_.base, { paraswap: w(u.a_.base), feeTarget: h.y$ }),
          (0, s.Z)(n, u.a_.bnb, { paraswap: w(u.a_.bnb), feeTarget: x.y$ }),
      ...
      function O(e) {
        ...
        return e in A
          ...
          : (null ===
              ...
              ? void 0
              : t.message) || 'There was an issue fetching data from Paraswap';
      }
              ...
              {},
              {
                children: (0, j.jsxs)(j.Fragment, {
                  children: [
                    t &&
                      (0, j.jsxs)(j.Fragment, {
                        children: [t, (0, j.jsx)(x.Z, { sx: { my: 2 } })],
                      }),
