try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = '3a236d86-1876-4363-968d-8f687465d781'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-3a236d86-1876-4363-968d-8f687465d781'));
} catch (e) {}
('use strict');
            ...
            children: [
              (0, n.BX)(i.Kqy, {
                ...
                children: [
                  ...
                  m && !(0, l.isDefined)(v) && !t && o,
                  (0, l.isDefined)(v) && c,
                ],
              }),
              (0, l.isDefined)(v)
                ? (0, n.tZ)(i.SKT, { height: '500px', text: v })
                : (0, n.BX)(i.Kqy, {
                    direction: 'column',
                    gap: 'm',
                    children: [
      ...
      let p = r.MathLib.MAX_UINT_160,
        c = function (e, t, a) {
          ...
          let v = !(arguments.length > 3) || void 0 === arguments[3] || arguments[3],
            { account: f } = (0, s.Z_)(),
            h =
              null !== (c = null == f ? void 0 : f.address) && void 0 !== c
                ? c
            ...
            }, [t.options.disabledPeripheralTokens, v, h, b]);
          return [k, w, h, g];
        };
    },
    ...
    91622: function (e, t, a) {
      ...
      let m = function (e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          [w, k] = (0, o.useState)(v.collateralAssets),
          [g, A] = (0, o.useState)(v.loanAssets),
          [T, M] = (0, o.useState)(v.loanShares),
          [x, I] = (0, o.useState)(
            v.options.isMax.includes(d.H.InterfaceOperationType.withdrawCollateral)
          ),
          [C, S] = (0, o.useState)(v.options.isMax.includes(d.H.InterfaceOperationType.repay)),
          [O, , , E, H] = (0, i.$X)(v.options.disabledPeripheralTokens),
          D = (0, o.useMemo)(() => {
            var t;
          ...
          B = f(e, null == m ? void 0 : m.data, D, T),
          Z = (0, y.Z)(
            a.isConnected,
          ...
          V = (0, o.useMemo)(() => {
            var e;
            let t = C !== v.options.isMax.includes(d.H.InterfaceOperationType.repay),
              a = !(0, n.Z)(
                Array.from(O),
                Array.from(
              ...
              o = g !== v.loanAssets;
            return t || a || o;
          }, [O, C, g, v.loanAssets, v.options.disabledPeripheralTokens, v.options.isMax]),
          j = (0, o.useMemo)(() => {
            let e = x !== v.options.isMax.includes(d.H.InterfaceOperationType.withdrawCollateral),
              t = w !== v.collateralAssets;
            return e || t;
          }, [w, x, v.collateralAssets, v.options.isMax]),
          $ = (0, o.useCallback)((e) => {
            I(!1), k(e);
          }, []),
          J = (0, o.useCallback)((e) => {
          ...
          et = (0, o.useCallback)(() => {
            ...
            L(_.id, () => ({
              ...v,
              collateralAssets: 0n,
              options: { ...v.options, isMax: [...(C ? [d.H.InterfaceOperationType.repay] : [])] },
            }));
          }, [_, L, v, C]),
          ea = (0, o.useCallback)(() => {
            if (0n === v.loanAssets || 0n === v.collateralAssets) {
        ...
        return (
          ...
          (0, o.useEffect)(() => {
            z ||
              ('bundler' !== v.options.origin && F(v.collateralAssets > 0n), k(v.collateralAssets));
          }, [z, v.collateralAssets, v.options.origin]),
          (0, o.useEffect)(() => {
            N ||
              ('bundler' !== v.options.origin && W(v.loanAssets > 0n),
              A(v.loanAssets),
              M(v.loanShares));
          }, [N, v.loanAssets, v.loanShares, v.options.origin]),
          (0, o.useEffect)(() => {
            eo(x);
          }, [x, eo]),
          (0, o.useEffect)(() => {
          ...
          (0, o.useEffect)(() => {
            z || N || H(v.options.disabledPeripheralTokens);
          }, [z, N, v.options.disabledPeripheralTokens, H]),
          (0, o.useEffect)(() => {
            if (N || z) return;
      ...
      let y = (e) => {
        ...
        b = (e) => {
          ...
          let { marketFrom: x, marketTo: I, initialOperation: C, options: S } = e,
            { account: O, targetChainId: E } = (0, v.Z_)(),
