try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = 'ac94ba69-7232-4c30-88ed-63811b03b7a8'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-ac94ba69-7232-4c30-88ed-63811b03b7a8'));
} catch (e) {}
('use strict');
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [7567],
  {
    94646: function (e, t, n) {
          ...
          let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
            ...
            { value: a } = (0, s.ib)(
              async (n) => {
                if (e && !t) {
                  r(!0);
                  let t = await k(e, { signal: n.signal });
                  return r(!1), t;
                }
              },
              [e, t]
      ...
      var L = n(4205),
        v = n(82078);
      let b = (0, n(38819).Z)(d.Kqy, { target: 'ewutvgm0' })(
      ...
      var B = n(35047);
      let A = (e, t) => {
        let { account: n, targetChainId: r } = (0, V.Z_)();
        return (0, i.useMemo)(() => {
          let i = null == n ? void 0 : n.address;
          return i && e && t
            ? (0, B.values)(t.tokens)
                .filter((e) => e instanceof o.WrappedToken)
                .map((n) => {
                  if (
                    !e.getHolding(o.addressesRegistry[r].bundler3.generalAdapter1, n.address)
                      .canTransfer
                  )
                    return;
                  let a = e.getBundleBalance(i, n.address),
                    l = t.getBundleBalance(i, n.address);
                  if (null == l || null == a) return;
                  let s = l - a;
                  if (!(s <= 10)) return { token: n, unwrappableAmount: s };
                })
                .filter(B.isDefined)
            : [];
        }, [n.address, e, t, r]);
      ...
      var T = (0, i.memo)((e) => {
        var t;
        let { operations: n, headerActionSlot: m, onConfirm: y } = e,
          { toggleDialog: k } = (0, d.DAv)(),
          { toggleRightPanel: B } = (0, d.s8G)(),
          { data: T } = (0, L.f)(0),
          { account: X } = (0, V.Z_)(),
          { bundlerConfiguration: P } = (0, h.N)(),
          [O] = (0, g.b)(T, n, P),
          D = (0, f.B)(),
          { activeBundle: S, setActiveBundle: I } = (0, Z.H)(),
          [R, _] = (0, i.useState)(),
          [z, , , W] = (0, s.$X)(),
          E = A(T, (0, a.Z)(O)),
          {
            hasRiskyPositions: q,
            isRiskyPositionsAcknowledged: F,
            setIsRiskyPositionsAcknowledged: U,
            markPositionsAsRisky: $,
            hasLiquidatablePositions: N,
            markPositionsAsLiquidatable: K,
          } = w(),
          j = (0, i.useCallback)(() => {
            if (y) {
              y();
            ...
            if (T && (null == X ? void 0 : X.address))
              try {
                let e = (0, H.b)(n, T, X.address, D, X.isContract),
                  ...
                  i = (0, l.encodeBundle)(t, T, !X.isContract);
                I(i, n), B(!1), k((0, r.tZ)(v.Z, {}), { closable: !1 });
              } catch (e) {
                _(e);
              }
          }, [X.address, X.isContract, T, n, D, z, y, I, k, B]),
          { value: G, loading: Y } = M(null == X ? void 0 : X.address),
          J = (0, i.useMemo)(
            () =>
              n.some(
                (e) =>
                ...
                : N
                  ...
                  : q && !F
                    ...
                    : X.isWrongChain
                      ...
                      : (null == G ? void 0 : G.isAuthorized)
                        ? null
                        : 'User is not allowed to perform this action.',
            [N, q, F, X.isWrongChain, null == G ? void 0 : G.isAuthorized, S]
          ),
          ee =
            !!S || N || (q && !F) || X.isWrongChain || !(null == G ? void 0 : G.isAuthorized) || Y;
        return (0, r.BX)(d.Kqy, {
          direction: 'column',
          gap: 20,
                  ...
                  : (null == G ? void 0 : G.isAuthorized)
                    ...
                    : (0, r.BX)(d.xvT.Body.XXXS.Regular, {
                        ...
                        children: [
                          'User is not allowed to perform this action:',
                          ' ',
                          null !== (t = null == G ? void 0 : G.riskReason) && void 0 !== t
                            ? t
                            : 'unknown reason',
                          '.',
                          ' ',
    ...
    99971: function (e, t, n) {
      ...
      var r = n(94646),
        ...
        m = (0, a.memo)((e) => {
          let {} = e,
            { toggleDialog: t } = (0, l.DAv)(),
            { account: n, targetChainId: r } = (0, p.Z_)(),
            {
              txData: { distributions: m },
            } = (0, C.D2)(),
            { activeBundle: y, setActiveBundle: k } = (0, h.HT)(),
            M = (0, a.useMemo)(
              () =>
                m.reduce((e, t) => {
                  var n;
                  let { claimable: r, asset: i } = t;
                  return (
                    0n === r ||
                      (e[i.address] = (null !== (n = e[i.address]) && void 0 !== n ? n : 0n) + r),
                    e
                  );
                }, {}),
              [m]
            ),
            L = (0, g.g)(f.rr.legacyMorphoToken),
            v = (0, a.useMemo)(() => {
              if (!n.address) return;
              let e = n.address;
              if (m && n.address) {
                let t = m.flatMap((t) => {
                    ...
                    return { type: 'urdClaim', args: [n, e, i, r, a, !1] };
                  }),
                  i = new o.ActionBundleRequirements(),
                  a = M[f.rr.legacyMorphoToken];
                if (a && L.value) {
                  let o = (0, H.S)({
                    amount: a,
                    userAddress: e,
                    supportsSignatures: !n.isContract,
                    bundlerAllowance: L.value.erc20Allowances['bundler3.generalAdapter1'],
                    erc2612Nonce: L.value.erc2612Nonce,
                    chainId: r,
                  });
                  o &&
                    (t.push(...o.actions),
                    i.signatures.push(...o.requirements.signatures),
                    i.txs.push(...o.requirements.txs));
                }
                return new o.ActionBundle(r, t, i);
              }
            }, [n.address, n.isContract, m, M, L, r]),
            b = !!y || n.isWrongChain,
            x = (0, a.useCallback)(() => {
              v &&
                (k(v, [
                  {
                    id: 'claim',
                    type: u.H.InterfaceOperationType.claimMorpho,
                    options: { isMax: [], disabledPeripheralTokens: new Set() },
                  },
                ]),
                t((0, i.tZ)(s.h, {}), { closable: !1 }));
            }, [v, k, t]);
          return (0, i.BX)(l.Kqy, {
            direction: 'column',
            gap: 20,
            ...
            children: [
              (0, i.BX)(l.Kqy, {
                ...
                gap: 16,
                children: [
                  (0, i.tZ)(l.xvT.Title.S, { children: 'Review' }),
                  (0, i.tZ)(l.zxk, {
                    iconAlone: 'ClosePlain20',
                    onClick: () => t(!1),
                    variant: 'secondary',
              ...
              (0, i.BX)(c.Z, {
                ...
                children: [
                  (0, i.tZ)(Z.F, {
                    children: (0, i.tZ)(V.Z, { mode: 'Review', rewardMode: 'MORPHO' }),
                  }),
                  (0, i.tZ)(l._Lo, {
                    onClick: x,
                    height: 47,
    ...
    47567: function (e, t, n) {
      ...
      let d = (e) => {
        let [t, n] = (0, i.useState)(!1),
          ...
          o = (0, i.useCallback)(
            (n) => {
              n.preventDefault(), t && (r || (0, l.aM)(e), a());
            },
            [r, t, e, a]
          );
        return {
          ...
          setIsChecked: n,
          onClickConfirm: o,
          onClickContinue: (0, i.useCallback)(
            (e) => {
              e.preventDefault(), a();
            },
            [a]
      ...
      var c = n(23567),
        C = n(38819);
      let u = (0, C.Z)('div', { target: 'e1fucke70' })(
        ...
        g = (0, C.Z)('button', { target: 'e1fucke75' })(
        ...
        m = (0, C.Z)(o.xvT.Body.M.Regular, { target: 'e1fucke78' })(),
        y = (0, C.Z)('div', { target: 'e1fucke79' })(
        ...
        k = (0, C.Z)(o.xvT.Body.S.Regular, { target: 'e1fucke710' })(
          'color:',
          (e) => {
            let { theme: t } = e;
        ...
        b = (0, C.Z)(o.xvT.Body.L.Regular, { target: 'e1fucke714' })(),
        ...
        A = (0, C.Z)(o.xvT.Body.XXS.Regular, { target: 'e1fucke717' })(
          'color:',
          (e) => {
            let { theme: t } = e;
            return t.colors.text.secondary;
        ...
        T = (0, C.Z)('form', { target: 'e1fucke718' })(
        ...
        D = (0, C.Z)(o.zxk, { target: 'e1fucke722' })(
          'align-self:flex-end;',
          (e) => {
            let { theme: t } = e;
            return t.breakpoints.down('m');
        ...
        S = (0, C.Z)(o.zxk, { target: 'e1fucke723' })(
          ...
          (0, r.BX)(
            'g',
            {
              children: [
                ...
                (0, r.tZ)('animateMotion', {
                  dur: ''.concat(a, 's'),
                  begin: ''.concat(-((i / a) * t), 's'),
                  rotate: 'auto',
                  repeatCount: 'indefinite',
                  keyPoints: l ? '1;0' : '0;1',
                  keyTimes: '0;1',
                  children: (0, r.tZ)('mpath', { href: '#'.concat(n) }),
                }),
              ],
            },
            t
      ...
      function z(e) {
        let { transform: t, rotation: n, fill: i, stroke: a = R.colors.half } = e;
        return (0, r.tZ)('g', {
          stroke: a,
          strokeWidth: '0.75',
          strokeMiterlimit: '10',
      ...
      function W(e) {
        let { selected: t, fillColor: n } = e,
          i = t ? R.opacities.full : R.opacities.hidden;
        return (0, r.BX)('g', {
          fill: n,
          opacity: i,
          style: R.transitions,
      ...
      var q = (0, i.memo)(
            ...
            return (0, r.BX)('svg', {
              ...
              children: [
                (0, r.BX)('g', {
                  children: [
                    (0, r.BX)('g', {
                      opacity: 0 === o ? R.opacities.full : R.opacities.hidden,
                      style: R.transitions,
                      children: [
                        (0, r.tZ)('path', {
                        ...
                        (0, r.tZ)('path', {
                          ...
                          stroke: d,
                          strokeWidth: R.labels.dashWidth,
                          strokeLinecap: 'round',
                        }),
                      ],
                    }),
                    ...
                    (0, r.tZ)(W, { selected: 0 === o, fillColor: 0 === o ? R.colors.full : d }),
                  ],
                }),
                (0, r.BX)('g', {
                  children: [
                    (0, r.BX)('g', {
                      opacity: o % 2 == 1 ? R.opacities.full : R.opacities.hidden,
                      style: R.transitions,
                      children: [
                        (0, r.tZ)('path', {
                    ...
                    (0, r.tZ)(E, {
                      selected: o % 2 == 1,
                      fillColor: o % 2 == 1 ? R.colors.full : d,
                    }),
                    (0, r.tZ)('g', {
                      style: R.transitions,
                      opacity: 3 === o ? 1 : 0,
                      transform: 3 === o ? '' : 'translate(-6, 2)',
                      children: (0, r.tZ)('image', {
                        width: '50',
                        height: '45',
                        x: '270',
                        y: '180',
                        href: ''.concat(a, '/yield-').concat(c, '.png'),
                ...
                (0, r.BX)('g', {
                  children: [
                    (0, r.BX)('g', {
                      opacity: 2 != o ? R.opacities.full : R.opacities.hidden,
                      children: [
                        (0, r.tZ)('path', {
        ...
        F = (0, i.memo)((e) => {
          let { animationStep: t, base: n } = e,
            { theme: i, themeMode: a } = (0, o.TCT)();
          return (0, r.tZ)(I, {
            children: (0, r.tZ)(q, {
              base: n,
              selectedPart: t,
              backgroundFillColor: i.colors.background.bloc,
              textFillColor: i.colors.text.primary,
              pathsFillColor: i.colors.icon.primary,
              themeMode: a,
            }),
          });
        }),
      ...
      let K = (0, C.Z)('div', { target: 'e5bt3va0' })(
        ...
        j = (0, C.Z)('div', { target: 'e5bt3va1' })(
          'position:absolute;',
          (e) => {
            let { position: t } = e;
            return 'top' === t ? (0, c.iv)($()) : (0, c.iv)(N());
          },
      ...
      var Y = (0, i.memo)(
        (0, i.forwardRef)(function (e, t) {
          ...
          return (0, r.BX)('svg', {
            ...
            children: [
              (0, r.BX)('g', {
                opacity: 0 === o ? G.opacities.full : G.opacities.hidden,
                style: G.transitions,
                children: [
                  (0, r.tZ)('path', {
                  ...
                  (0, r.tZ)('path', {
                    d: 'M276 66L117 66',
                    stroke: d,
                    strokeWidth: G.labels.dashWidth,
                    strokeLinecap: 'round',
                  }),
                ],
              }),
              ...
              (0, r.BX)('g', {
                opacity: 0 === o || 1 === o ? G.opacities.full : G.opacities.hidden,
                style: G.transitions,
                children: [
                  (0, r.tZ)('path', {
              ...
              (0, r.BX)('g', {
                opacity: 2 === o ? G.opacities.full : G.opacities.hidden,
                style: G.transitions,
                  ...
                  (0, r.BX)('g', {
                    children: [
                      ...
                      (0, r.tZ)('animateMotion', {
                        ...
                        rotate: 'auto',
                        repeatCount: 'indefinite',
                        children: (0, r.tZ)('mpath', { href: '#first-path' }),
                      }),
                    ],
                  }),
                  (0, r.BX)('g', {
              ...
              (0, r.BX)('g', {
                opacity: 1 === o ? G.opacities.full : G.opacities.hidden,
                style: G.transitions,
                children: [
                  (0, r.tZ)('path', {
                  ...
                  (0, r.BX)('g', {
                    children: [
                      ...
                      (0, r.tZ)('animateMotion', {
                        ...
                        rotate: 'auto',
                        repeatCount: 'indefinite',
                        children: (0, r.tZ)('mpath', { href: '#second-path-long-vertical' }),
                      }),
                    ],
                  }),
                  (0, r.BX)('g', {
                    children: [
                      ...
                      (0, r.tZ)('animateMotion', {
                        ...
                        rotate: 'auto',
                        repeatCount: 'indefinite',
                        children: (0, r.tZ)('mpath', { href: '#second-path-right-part' }),
                      }),
                    ],
                  }),
                  (0, r.BX)('g', {
                    children: [
                      ...
                      (0, r.tZ)('animateMotion', {
                        ...
                        rotate: 'auto',
                        repeatCount: 'indefinite',
                        children: (0, r.tZ)('mpath', { href: '#second-path-left-part' }),
                      }),
                    ],
                  }),
                ],
                  ...
                  (0, r.BX)('g', {
                    children: [
                      ...
                      (0, r.tZ)('animateMotion', {
                        ...
                        rotate: 'auto',
                        repeatCount: 'indefinite',
                        children: (0, r.tZ)('mpath', { href: '#third-path-vertical-part' }),
                      }),
                    ],
                  }),
                  (0, r.BX)('g', {
                    children: [
                      ...
                      (0, r.tZ)('animateMotion', {
                        ...
                        rotate: 'auto',
                        repeatCount: 'indefinite',
                        children: (0, r.tZ)('mpath', { href: '#third-path-left-part' }),
                      }),
                    ],
                  }),
                  (0, r.BX)('g', {
                    children: [
                      ...
                      (0, r.tZ)('animateMotion', {
                        ...
                        rotate: 'auto',
                        repeatCount: 'indefinite',
                        children: (0, r.tZ)('mpath', { href: '#third-path-right-part' }),
                      }),
                    ],
                  }),
                ],
              ...
              (0, r.tZ)('circle', { fill: l, r: '57', transform: 'translate(268 820)' }),
              (0, r.tZ)('circle', { fill: l, r: '57', transform: 'translate(76 820)' }),
              (0, r.tZ)('circle', { fill: l, r: '57', transform: 'translate(460 820)' }),
              (0, r.tZ)('circle', { fill: l, r: '46', transform: 'translate(268 1138)' }),
              (0, r.tZ)('circle', { fill: l, r: '40', transform: 'translate(268 1303)' }),
              (0, r.BX)('g', {
                opacity: 0 === o ? G.opacities.full : G.opacities.hidden,
                style: G.transitions,
                children: [
              ...
              (0, r.BX)('g', {
                opacity: 1 === o || 2 === o ? G.opacities.full : G.opacities.hidden,
                style: G.transitions,
                children: [
                  (0, r.tZ)('image', {
                    href: ''.concat(a, '/coinstack.png'),
      ...
      var Q = (0, i.memo)((e) => {
        let { animationStep: t, base: n } = e,
          ...
          s = (0, i.useRef)(-7);
        function d() {
          a.current && (a.current.style.transform = 'translate3d(0, '.concat(-s.current, '%, 0)'));
        }
        return (
          (0, i.useLayoutEffect)(() => {
            var e;
            d(),
              (0, o.ifp)(
                s,
                { current: null !== (e = J[t]) && void 0 !== e ? e : 0 },
          ...
          (0, r.BX)(K, {
            children: [
              (0, r.tZ)(Y, {
                ...
                base: n,
                selectedPart: t,
                backgroundFillColor: l.colors.background.bloc,
                textFillColor: l.colors.text.primary,
                pathsFillColor: l.colors.icon.primary,
              }),
              (0, r.tZ)(j, { position: 'top' }),
              (0, r.tZ)(j, { position: 'bottom' }),
            ],
          })
        );
      });
      let ee = (e) => {
        let { steps: t } = e,
          ...
          u = (0, i.useRef)(null),
          h = (0, i.useRef)(),
          p = (0, a.$B)('v2/assets/animations-assets'),
          f = (0, i.useCallback)((e) => {
            ...
            (e) => {
              ...
              (0, o.ifp)(
                ...
                { current: i.height },
                {
                  ...
                  duration: e ? 0 : 0.4,
                  onUpdate() {
                    s.current && (s.current.style.height = ''.concat(c.current, 'px'));
                  },
                }
              );
            },
          ...
          Z = (0, i.useCallback)(
            (e) => {
              ...
              let a = i.changedTouches.item(0),
                o = null === (n = C.current) || void 0 === n ? void 0 : n.changedTouches.item(0);
              if (!a || !o) return;
              let s = a.clientX - o.clientX;
              if (Math.abs(s) > Math.abs(a.clientY - o.clientY)) {
                let n = s > 0 ? r - 1 : r + 1;
                l((n = Math.max(0, Math.min(n, t.length - 1)))), e.preventDefault();
              }
            },
            [r, t.length]
          ),
          V = (0, i.useCallback)(() => {
            ...
            let n = e.getBoundingClientRect(),
              ...
              i = n.width / n.height > r.width / r.height,
              a = i ? (n.width - r.width) / 2 : 0,
              o = i ? 0 : (n.height - r.height) / 2;
        ...
        return (
          ...
          (0, o.rr1)(() => {
            V(), clearTimeout(h.current), (h.current = setTimeout(V, 300));
          }),
          {
            animationContainer: u,
            animationStep: r,
            mobileStepsContainer: s,
            mediaBase: p,
            getMobileStepRef: H,
            setAnimationStep: l,
            preventDoubleClickToSelect: f,
            onTouchStep: Z,
          }
        );
      };
      var et = (0, i.memo)((e) => {
        let { type: t, title: n, steps: i, terms: l } = e,
          ...
          } = d(t),
          {
            ...
            animationStep: W,
            mediaBase: E,
            mobileStepsContainer: q,
            setAnimationStep: U,
            onTouchStep: $,
            preventDoubleClickToSelect: N,
            getMobileStepRef: K,
          } = ee({ steps: i });
        function j() {
          return (0, r.BX)(T, {
            children: [
              (0, r.BX)(X, {
                children: [
                  (0, r.tZ)(O, { onChange: () => I((e) => !e), checked: B, variant: 'square' }),
                  (0, r.tZ)('p', {
                    children: (0, r.BX)(P, {
                      onMouseDown: N,
                      children: [
        ...
        return (0, r.BX)(u, {
          children: [
            c &&
              (0, r.BX)(r.HY, {
                children: [
                  (0, r.tZ)(x, { textAlign: 'center', children: n }),
                  (0, r.tZ)(A, {
                    children: (0, r.tZ)('p', { dangerouslySetInnerHTML: { __html: l } }),
                  }),
                  !C && j(),
                  (0, r.tZ)(w, {}),
                ],
            ...
            (0, r.BX)(h, {
              ref: z,
              children: [
                'earn' === t && (0, r.tZ)(Q, { animationStep: W, base: E }),
                'borrow' === t && (0, r.tZ)(F, { animationStep: W, base: E }),
              ],
            }),
            (0, r.tZ)(p, {
              children: c
                        ...
                        children: i.map((e, t) =>
                          (0, r.tZ)(
                            g,
                            {
                              onClick: () => U(t),
                              selected: t === W,
                              children: (0, r.tZ)(o.xvT.Body.M.Regular, {
                                children: '0' + (t + 1),
                              }),
                            },
                            t
                        ...
                        children: i.map((e, t) =>
                          (0, r.BX)(
                            V,
                            {
                              ...
                              selected: t === W,
                              children: [
                                (0, r.tZ)('h4', { children: (0, r.tZ)(m, { children: e.title }) }),
                                (0, r.tZ)('p', {
                                  children: (0, r.tZ)(v, { children: e.description }),
                                }),
                              ],
                            },
                            t
                        ...
                        children: i.map((e, t) =>
                          (0, r.BX)(
                            y,
                            {
                              ...
                              children: [
                                (0, r.tZ)(k, {
                                  children: (0, r.tZ)('span', { children: '0' + (t + 1) }),
                                }),
                                (0, r.BX)(L, {
                                  onMouseDown: N,
                                  children: [
                                    (0, r.tZ)('h4', {
                                      children: (0, r.tZ)(M, { children: e.title }),
                                    }),
                                    (0, r.tZ)('p', {
                                      children: (0, r.tZ)(v, { children: e.description }),
                                    }),
        ...
        return (0, r.BX)(a.Kqy, {
          ...
          children: [
            ...
            (0, r.BX)(a.Kqy, {
              ...
              align: 'center',
              children: [
                (0, r.tZ)(a.JO$, { icon: 'MorphoShade20', size: 30, padding: 0 }),
                (0, r.tZ)(a.JO$, {
                  icon: 'ClosePlain20',
                  size: 24,
                  padding: 0,
                ...
                (0, r.tZ)(a.JO$, { icon: 'CoinbaseOnePlain20', size: 30, padding: 0 }),
              ],
            }),
            (0, r.BX)(a.Kqy, {
              direction: 'column',
              ...
              gap: 20,
              children: [
                (0, r.tZ)(a.xvT.Title.S, { children: 'Coinbase One Rewards' }),
                ...
                (0, r.tZ)(a.zxk, {
                  size: 'big',
                  onClick: n,
                  children: (0, r.tZ)(a.xvT.Body.S.Regular, { children: 'Explore the App' }),
                }),
              ],
            }),
          ],
    ...
    52242: function (e, t, n) {
      ...
      var r = n(78286),
        ...
        c = n(67024),
        C = n(58404);
      let u = (e) => o.$0l.short.default('0.00').digits(2).of(e, 18),
        h = 'morpho.viewed.cb1-recap',
        p = (0, a.$B)('assets/logos/morpho.svg'),
        f = (0, a.$B)('assets/logos/well.svg');
      t.default = (0, i.memo)((e) => {
        let {} = e,
          ...
          H = (0, i.useCallback)(() => {
            (0, C.po)(h, 'true'), t((0, r.tZ)(l.ar, {}));
          }, [t]),
          g = (0, i.useMemo)(
            () => ({ morpho: (0, c.I)(n, d.id.morphoToken), well: (0, c.I)(n, d.id.wellToken) }),
            [n]
          );
        return (0, r.BX)(o.Kqy, {
          direction: 'column',
          ...
          children: [
            ...
            (0, r.BX)(o.Kqy, {
              ...
              align: 'center',
              children: [
                (0, r.tZ)(o.JO$, { icon: 'MorphoShade20', size: 30, padding: 0 }),
                (0, r.tZ)(o.JO$, {
                  icon: 'ClosePlain20',
                  size: 24,
                  padding: 0,
                ...
                (0, r.tZ)(o.JO$, { icon: 'CoinbaseOnePlain20', size: 30, padding: 0 }),
              ],
            }),
            (0, r.BX)(o.Kqy, {
              direction: 'column',
              ...
              children: [
                (0, r.BX)(o.Kqy, {
                  ...
                  gap: 'xs',
                  children: [
                    (0, r.tZ)(o.xvT.Title.S, { children: 'Coinbase One Rewards' }),
                ...
                (0, r.BX)(o.Kqy, {
                  ...
                  gap: 8,
                  children: [
                    (0, r.tZ)(o.qEK, { size: 'small', padding: 0, src: p }),
                    (0, r.BX)(o.xvT.Body.M.Regular, {
                      lineHeight: 'normal',
                      children: [u(g.morpho), ' MORPHO'],
                    }),
                    (0, r.tZ)(o.qEK, { size: 'small', padding: 0, src: f }),
                    (0, r.BX)(o.xvT.Body.M.Regular, {
                      lineHeight: 'normal',
                      children: [u(g.well), ' WELL'],
                    }),
                  ],
                }),
                (0, r.tZ)(o.zxk, {
                  size: 'big',
                  onClick: H,
                  children: (0, r.tZ)(o.xvT.Body.S.Regular, { children: 'Claim Rewards' }),
                }),
              ],
            }),
          ],
    ...
    58321: function (e, t, n) {
      ...
      var r = n(78286),
        ...
        u = n(75638),
        h = n(89991);
      let p = (0, i.lazy)(() => n.e(242).then(n.bind(n, 90242))),
        f = (0, i.lazy)(() => n.e(9286).then(n.bind(n, 29286))),
        H = (0, i.lazy)(() => Promise.resolve().then(n.bind(n, 30957))),
        g = (0, i.lazy)(() => Promise.resolve().then(n.bind(n, 52242))),
        Z = (0, i.lazy)(() => n.e(5353).then(n.bind(n, 65353))),
      ...
      t.ZP = (e) => {
        let { children: t } = e,
          { account: n } = (0, h.Z_)(),
          { navigationValue: m } = (0, u.v)(),
          {
            display: { rewardsMorpho: y },
          } = (0, s.D2)(),
          { shouldAskForReferrerConfirmation: k, referrerDialogViewedSessionKey: M } = (0, l.sf)(),
          L = (0, i.useMemo)(() => n.isConnected && n.attestations.base.coinbaseOne, [n]),
          v = (0, i.useMemo)(() => {
            let e = (0, C.I)(y, d.id.morphoToken),
              t = (0, C.I)(y, d.id.wellToken);
            return e > 0n || t > 0n;
          }, [y]),
          b = (0, i.useMemo)(
            () => [
              {
                ...
                condition: n.isConnected && 'earn' === m,
                store: 'local',
              ...
              },
              {
                ...
                condition: n.isConnected && 'borrow' === m,
                store: 'local',
                dialogOptions: { fullSize: !0, closable: !1 },
              },
              {
              ...
              {
                component: (0, r.tZ)(H, {}),
                keyStore: a.COINBASE_ONE_END_DIALOG_ID,
                condition: L,
                store: 'local',
              ...
              {
                component: (0, r.tZ)(g, {}),
                keyStore: o.COINBASE_ONE_RECAP_DIALOG_ID,
                condition: L && v,
                store: 'local',
          ...
          x = (0, i.useMemo)(() => ({ dialogs: b }), [b]);
        return (0, r.tZ)(V.Provider, { value: x, children: t });
      };
    },
    34895: function (e, t, n) {
      ...
      var r = n(78286),
        ...
        u = n(58404),
        h = n(89991);
      let { NEXT_PUBLIC_FUUL_API_KEY: p } = C.clientEnvs,
        f = 'Accept affiliate on '.concat(new Date().toISOString()),
        H = [
        ...
        g = (e) => 'morpho.referrer.viewed.'.concat(e),
        Z = (e) => 'morpho.referrer.accepted.'.concat(e),
        V = 'fuul.referrer',
      ...
      t.ZP = (0, i.memo)((e) => {
        let { children: t } = e,
          ...
          [k, M] = (0, i.useState)(!1),
          L = (0, i.useMemo)(() => {
            let e = y.get('referrer') || y.get('af'),
              t = (0, u.G)(V);
            return e && (0, u.t_)(V, e), t || e;
          }, [y]),
          v = (0, i.useMemo)(() => {
            if (null == n ? void 0 : n.address) return g(n.address);
          }, [n]),
          b = (0, i.useMemo)(() => {
            if (null == n ? void 0 : n.address) return Z(n.address);
          }, [n]),
          x = (0, i.useMemo)(() => {
            if (!k || !p || !(null == n ? void 0 : n.address) || !(0, c.isDefined)(L)) return !1;
            let e = (0, u.wB)(g(n.address)),
              t = (0, u.kY)(Z(n.address));
            return !e && !t;
          }, [k, null == n ? void 0 : n.address, L]),
          w = (0, l.useSignMessage)({
            mutation: {
              async onSuccess(e, t) {
                let { message: r } = t;
                (null == n ? void 0 : n.address) &&
                  (await (0, o.n)({ address: n.address, message: r, signature: e })) &&
                  ((0, d._try)(
                    async () =>
                      await s.ix.sendConnectWallet(
                        { address: n.address, signature: e, message: r.toString() },
                        H
                      )
                  ),
                  b && (0, u.po)(b, 'true'));
        ...
        (0, i.useEffect)(() => {
          p &&
            !k &&
            (0, d._try)(() => {
              s.ix.init({ apiKey: p }), M(!0);
            });
        }, [k]),
          (0, i.useEffect)(() => {
            p && k && (0, d._try)(async () => await s.ix.sendPageview(C, H));
          }, [C, k]);
        let B = (0, i.useMemo)(
          () => ({
            isFuulInitialized: k,
            acceptReferralMessage: f,
            shouldAskForReferrerConfirmation: x,
            referrer: L,
            referrerDialogViewedSessionKey: v,
            referrerAcceptedLocalKey: b,
            trackConnectWallet: w,
          }),
          [k, L, v, b, x, w]
        );
        return (0, r.tZ)(m.Provider, { value: B, children: t });
      });
    },
    55694: function (e, t, n) {
      n.d(t, {
        Z: function () {
          return A;
        },
      ...
      function y() {
        let e = (0, h._)([
          '\n  query GetVaultsAndMarkets(\n    $firstVaults: Int\n    $skipVaults: Int\n    $orderByVaults: VaultOrderBy\n    $orderDirectionVaults: OrderDirection\n    $whereVaults: VaultFilters\n    $firstMarkets: Int\n    $skipMarkets: Int\n    $orderByMarkets: MarketOrderBy\n    $orderDirectionMarkets: OrderDirection\n    $whereMarkets: MarketFilters\n  ) {\n    vaults(\n      first: $firstVaults\n      skip: $skipVaults\n      orderBy: $orderByVaults\n      orderDirection: $orderDirectionVaults\n      where: $whereVaults\n    ) {\n      items {\n        ...simpleVaultFields\n        creatorAddress\n        address\n        name\n        symbol\n        asset {\n          ...simpleAssetFields\n        }\n        chain {\n          id\n        }\n        metadata {\n          curators {\n            name\n            image\n          }\n        }\n        warnings {\n          type\n          level\n        }\n        state {\n          id\n          fee\n          totalAssets\n          totalAssetsUsd\n          dailyApy\n          dailyNetApy\n          rewards {\n            asset {\n              ...simpleAssetFields\n            }\n            amountPerSuppliedToken\n            supplyApr\n          }\n          allocation {\n            id\n            supplyAssets\n            supplyAssetsUsd\n            market {\n              id\n              uniqueKey\n              lltv\n              ...collateralExposuresFields\n              loanAsset {\n                id\n                name\n                address\n                ...sdkTokenFields\n              }\n              collateralAsset {\n                id\n                name\n                address\n                ...sdkTokenFields\n              }\n              state {\n                id\n                rewards {\n                  asset {\n                    ...simpleAssetFields\n                  }\n                  supplyApr\n                  amountPerSuppliedToken\n                }\n              }\n            }\n          }\n        }\n      }\n      pageInfo {\n        countTotal\n        count\n        limit\n        skip\n      }\n    }\n    markets(\n      first: $firstMarkets\n      skip: $skipMarkets\n      orderBy: $orderByMarkets\n      orderDirection: $orderDirectionMarkets\n      where: $whereMarkets\n    ) {\n      items {\n        id\n        uniqueKey\n        oracleAddress\n        lltv\n        reallocatableLiquidityAssets\n        oracleFeed {\n          baseVault\n          baseFeedOneAddress\n          baseFeedOneDescription\n          baseFeedOneVendor\n          baseFeedTwoAddress\n          baseFeedTwoDescription\n          baseFeedTwoVendor\n          quoteVault\n          quoteFeedOneAddress\n          quoteFeedOneDescription\n          quoteFeedOneVendor\n          quoteFeedTwoAddress\n          quoteFeedTwoDescription\n          quoteFeedTwoVendor\n        }\n        warnings {\n          type\n          level\n        }\n        collateralAsset {\n          id\n          address\n          symbol\n          name\n          decimals\n          priceUsd\n          tags\n          logoURI\n          chain {\n            id\n          }\n        }\n        loanAsset {\n          id\n          address\n          symbol\n          name\n          decimals\n          priceUsd\n          tags\n          logoURI\n          chain {\n            id\n          }\n        }\n        state {\n          id\n          fee\n          dailyNetBorrowApy\n          dailyBorrowApy\n          liquidityAssets\n          liquidityAssetsUsd\n          rewards {\n            asset {\n              id\n              address\n              symbol\n              name\n              decimals\n              priceUsd\n              tags\n              logoURI\n              chain {\n                id\n              }\n            }\n            borrowApr\n            amountPerSuppliedToken\n            amountPerBorrowedToken\n          }\n        }\n        publicAllocatorSharedLiquidity {\n          id\n          vault {\n            id\n            address\n            asset {\n              id\n              address\n            }\n            publicAllocatorConfig {\n              flowCaps {\n                market {\n                  id\n                  uniqueKey\n                  loanAsset {\n                    id\n                    address\n                  }\n                  collateralAsset {\n                    id\n                    address\n                  }\n                }\n              }\n            }\n          }\n        }\n      }\n      pageInfo {\n        countTotal\n        count\n        limit\n        skip\n      }\n    }\n  }\n  ',
          '\n  ',
          '\n  ',
          '\n  ',
          '\n',
      ...
      let b = (0, i.createContext)({
        ...
        w = [
          c.MigratableProtocol.aaveV2,
          c.MigratableProtocol.aaveV3,
          c.MigratableProtocol.aaveV3Optimizer,
          c.MigratableProtocol.compoundV2,
          c.MigratableProtocol.compoundV3,
        ],
        B = (0, i.memo)((e) => {
          let { children: t } = e,
            { account: n, targetChainId: h } = (0, v.Z_)(),
            p = (0, o.usePublicClient)(),
            H = (0, L.nh)(L.TP.MIGRATION_BORROW),
            {
              data: g,
              isLoading: Z,
              error: V,
            } = (0, l.a)({
              queryKey: ['migratablePositions', n.address, h],
              queryFn: () =>
                p && n.address
                  ? (0, c.fetchMigratablePositions)(n.address, p, { protocols: w })
                  : null,
            ...
            }),
            {
              ...
              if (!g) return { supplyTokens: [], loanTokens: [], collateralTokens: [] };
              let e = new Set(),
                t = new Set(),
                n = new Set();
              return (
                Object.values(g).forEach((r) => {
                  r.forEach((r) => {
                    r instanceof c.MigratableSupplyPosition
                      ? e.add(r.loanToken)
                      : r instanceof C.MigratableBorrowPosition &&
                        (n.add(r.collateralToken.address), t.add(r.loanToken.address));
                  });
                }),
                {
                  supplyTokens: Array.from(e),
                  loanTokens: Array.from(t),
                  collateralTokens: Array.from(n),
                }
              );
            }, [g]),
            {
              ...
              variables: (0, i.useMemo)(
                () => ({
                  firstVaults: 1e3,
                  whereVaults: {
                    chainId_in: [h],
                    assetAddress_in: m.length > 0 ? m : void 0,
                    whitelisted: !0,
                  },
                  firstMarkets: 1e3,
                  whereMarkets: {
                    chainId_in: [h],
                    collateralAssetAddress_in: x.length > 0 ? x : void 0,
                    loanAssetAddress_in: y.length > 0 ? y : void 0,
                    whitelisted: !0,
                  },
                }),
                [x, y, m, h]
              ),
              skip: 0 === m.length && 0 === x.length && 0 === y.length,
            }),
            X = (0, i.useMemo)(() => {
              var e;
              if (!(null == B ? void 0 : B.vaults.items)) return new Map();
              let t = new Map();
              return (
                null === (e = B.vaults.items) ||
                  void 0 === e ||
                  e.forEach((e) => {
                    var n;
                    let r = e.asset.address;
                    t.has(r) || t.set(r, []), null === (n = t.get(r)) || void 0 === n || n.push(e);
                  }),
                t
              );
            }, [B]),
            P = (0, i.useMemo)(() => {
              var e;
              if (!(null == B ? void 0 : B.markets.items)) return new Map();
              let t = new Map();
              return (
                null === (e = B.markets.items) ||
                  void 0 === e ||
                  e.forEach((e) => {
                    var n, r;
                    if (
                      !(null === (n = e.collateralAsset) || void 0 === n ? void 0 : n.address) ||
                      !e.loanAsset.address
                    )
                      return;
                    let i = ''
                      .concat(
                        null === (r = e.collateralAsset) || void 0 === r ? void 0 : r.address,
                        '-'
                      )
                      .concat(e.loanAsset.address);
            ...
            O = (0, i.useCallback)(
              (e) => {
                let t = P.get(
                  ''.concat(e.collateralToken.address, '-').concat(e.loanToken.address)
                );
                return null == t
                  ? void 0
                  : t.sort(
                      (0, u.bigIntComparator)((e) => {
                        var t;
                        return null === (t = e.state) || void 0 === t ? void 0 : t.liquidityAssets;
                      }, 'desc')
                    );
              },
              [P]
            ...
            D = (0, i.useCallback)(
              (e) => {
                let t = X.get(e.loanToken);
                return (
                  e.chainId === s.ChainId.BaseMainnet &&
                    e.protocol === c.MigratableProtocol.compoundV2 &&
                    (t = d.e8[e.chainId]
                  ...
                  null == t
                    ...
                    : t
                        ...
                        .sort(
                          (0, u.bigIntComparator)((e) => {
                            var t;
                            return null === (t = e.state) || void 0 === t ? void 0 : t.totalAssets;
                          }, 'desc')
                        )
                );
              },
            ...
            S = (0, i.useCallback)(
              (e) => {
                if (e instanceof c.MigratableSupplyPosition && 0n !== e.max.value) {
                  let t = D(e);
                  return !!t && t.length > 0;
                }
                if (e instanceof C.MigratableBorrowPosition && 0n !== e.maxRepay.value) {
                  let t = O(e);
                  return !!t && t.length > 0;
                }
                return !1;
            ...
            I = (0, i.useMemo)(() => {
                ...
                Object.entries(g).map((e) => {
                  ...
                  return [
                    ...
                    n
                      ...
                      .map((e) => {
                        var t, n, r;
                        if (e instanceof c.MigratableSupplyPosition) {
                          let n = D(e),
                            r = null == n ? void 0 : n[0],
                            i = (0, d.wk)(null == r ? void 0 : r.asset);
                          if (!r || !i) return;
                          return {
                            migratablePosition: e,
                            maxUsdValue:
                              null !== (t = i.toUsd(e.max.value)) && void 0 !== t ? t : null,
                            compatibleVaults:
                              null == n
                                ? void 0
                                : n.sort(
                        ...
                        if (H && e instanceof C.MigratableBorrowPosition) {
                          let t = O(e),
                            i = null == t ? void 0 : t[0],
                            a = (0, d.wk)(null == i ? void 0 : i.collateralAsset),
                            o = (0, d.wk)(null == i ? void 0 : i.loanAsset);
                          if (!i || !a || !o) return;
                          let l = null !== (n = a.toUsd(e.collateral)) && void 0 !== n ? n : 0n,
                            s = null !== (r = o.toUsd(e.borrow)) && void 0 !== r ? r : 0n;
                          return {
                            migratablePosition: e,
                            equityUsd: l - s,
                            compatibleMarkets:
              ...
              return w.reduce((t, n) => {
                var r;
                return { ...t, [n]: null !== (r = e[n]) && void 0 !== r ? r : [] };
              }, {});
            }, [B, g, S, O, D, H]),
            R = (0, i.useMemo)(
              () => Object.values(null != I ? I : {}).some((e) => e.length > 0),
              [I]
            ),
            _ = (0, i.useMemo)(
              () => Object.values(null != I ? I : {}).reduce((e, t) => e + t.length, 0),
              [I]
            ),
            z = (0, i.useMemo)(
              () => ({
                migratablePositionsByProtocol: I,
                isLoading: Z || A,
                error: (0, u.isDefined)(V) || (0, u.isDefined)(T),
                hasMigratablePositions: R,
                migratablePositionCount: _,
              }),
              [I, Z, A, V, T, R, _]
            );
          return (0, r.tZ)(b.Provider, { value: z, children: t });
        });
      B.displayName = 'MigrationContextProvider';
      var A = (0, i.memo)(B);
    },
    ...
    34097: function (e, t, n) {
      ...
      var r,
        i,
        a = n(58404);
      ((r = i || (i = {})).Earn = 'earn'), (r.Borrow = 'borrow');
    ...
    67024: function (e, t, n) {
      ...
      let r = (e) =>
          e.reduce((e, t) => {
            ...
            return (
              e +
              (null !== (r = null === (n = t.claimable) || void 0 === n ? void 0 : n.amountUsd) &&
              void 0 !== r
                ? r
                : 0n)
            );
        ...
        i = (e, t) =>
          e
            ...
            .reduce((e, t) => {
              ...
              return (
                e +
                (null !== (r = null === (n = t.claimable) || void 0 === n ? void 0 : n.amount) &&
                void 0 !== r
                  ? r
                  : 0n)
              );
    ...
    75638: function (e, t, n) {
      ...
      let c = () => {
        let e = (0, i.usePathname)(),
          ...
          c = (0, o.nh)(o.TP.MIGRATION_PAGE),
          [C, u] = (0, r.useState)((0, d.BG)(e)),
          { migratablePositionCount: h } = (0, l.w)(),
          p = (0, r.useMemo)(() => {
            let e = a.FW.getNameById(t.id);
            return (0, d.ge)({
              chainName: e,
              flags: { isUiKitAppEnabled: n, isMigrationPageEnabled: c },
              migratablePositionCount: h,
            });
          }, [t.id, n, c, h]);
        return (
          (0, r.useEffect)(() => {
          ...
          { navigationValue: C, navigationOptions: p, onNavigationValueChange: u }
        );
      };
    },
