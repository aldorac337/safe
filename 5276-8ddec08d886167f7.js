  ...
  [5276],
  {
    5276: function (e, o, n) {
      ...
      var t,
        ...
        y = n(25074),
        E = new Map([
          [''.concat(y.el.proto_mainnet_v3, '-').concat(x.UQ.supply, '-weETH'), 3],
          [''.concat(y.el.proto_mainnet_v3, '-').concat(x.UQ.supply, '-eBTC'), 3],
          [''.concat(y.el.proto_etherfi_v3, '-').concat(x.UQ.supply, '-weETH'), 3],
          [''.concat(y.el.proto_lido_v3, '-').concat(x.UQ.supply, '-weETH'), 3],
          [''.concat(y.el.proto_arbitrum_v3, '-').concat(x.UQ.supply, '-weETH'), 3],
          [''.concat(y.el.proto_base_v3, '-').concat(x.UQ.supply, '-weETH'), 3],
          [''.concat(y.el.proto_scroll_v3, '-').concat(x.UQ.supply, '-weETH'), 3],
          [''.concat(y.el.proto_zksync_v3, '-').concat(x.UQ.supply, '-weETH'), 3],
          [''.concat(y.el.proto_linea_v3, '-').concat(x.UQ.supply, '-weETH'), 3],
        ]),
        A = function (e, o, n) {
          if (e && n && o)
      ...
      var j,
        ...
        N =
          ...
          (0, U.Z)(r, y.el.proto_arbitrum_v3, {
            ETH: [
              {
