...
var P = (t, e, i) =>
    e in t ? ee(t, e, { enumerable: !0, configurable: !0, writable: !0, value: i }) : (t[e] = i),
  L = (t, e) => {
    for (var i in e || (e = {})) ie.call(e, i) && P(t, i, e[i]);
    if (f) for (var i of f(e)) oe.call(e, i) && P(t, i, e[i]);
    return t;
  };
...
(function () {
  try {
    ...
    e &&
      ...
      (t._sentryDebugIds[e] = 'cf734c6d-59b5-423c-9f21-cd6df5587eab'),
      (t._sentryDebugIdIdentifier = 'sentry-dbid-cf734c6d-59b5-423c-9f21-cd6df5587eab'));
  } catch (i) {}
})();
var w,
  A,
...
(function (t) {
  ...
  (function (t) {
    t.extractErrorReason = function (e) {
      return e.params[1];
    };
  })(A || (A = {})),
  (function (t) {
    (t.Default = 'default'), (t.FullSingleSession = 'full_single_session');
  })(I || (I = {})),
  (function (t) {
    (t.PeriodBack = 'period-back'), (t.TimeRange = 'time-range');
  })(v || (v = {})),
  (function (t) {
    (t.PeriodBack = 'period-back'), (t.TimeRange = 'time-range');
  })(O || (O = {})),
  (function (t) {
    (t.Open = 'market'),
      (t.Pre = 'pre_market'),
      (t.Post = 'post_market'),
      (t.Close = 'out_of_session'),
      (t.Holiday = 'holiday');
  })(R || (R = {})),
  (function (t) {
    (t.Separator = 'separator'), (t.Action = 'action');
  })(D || (D = {})),
  (function (t) {
    (t[(t.All = 0)] = 'All'),
      (t[(t.BarMarks = 1)] = 'BarMarks'),
      (t[(t.TimeScaleMarks = 2)] = 'TimeScaleMarks');
  })(V || (V = {})),
  (function (t) {
    (t[(t.Line = 0)] = 'Line'),
      (t[(t.Histogram = 1)] = 'Histogram'),
      (t[(t.Cross = 3)] = 'Cross'),
      (t[(t.Area = 4)] = 'Area'),
      (t[(t.Columns = 5)] = 'Columns'),
      (t[(t.Circles = 6)] = 'Circles'),
      (t[(t.LineWithBreaks = 7)] = 'LineWithBreaks'),
      (t[(t.AreaWithBreaks = 8)] = 'AreaWithBreaks'),
      (t[(t.StepLine = 9)] = 'StepLine'),
      (t[(t.StepLineWithDiamonds = 10)] = 'StepLineWithDiamonds'),
      (t[(t.StepLineWithBreaks = 11)] = 'StepLineWithBreaks');
  })(k || (k = {})),
  (function (t) {
    (t.Line = 'line'),
      (t.Colorer = 'colorer'),
      (t.BarColorer = 'bar_colorer'),
      (t.BgColorer = 'bg_colorer'),
      (t.TextColorer = 'text_colorer'),
      (t.OhlcColorer = 'ohlc_colorer'),
      (t.CandleWickColorer = 'wick_colorer'),
      (t.CandleBorderColorer = 'border_colorer'),
      (t.UpColorer = 'up_colorer'),
      (t.DownColorer = 'down_colorer'),
      (t.Shapes = 'shapes'),
      (t.Chars = 'chars'),
      (t.Arrows = 'arrows'),
      (t.Data = 'data'),
      (t.DataOffset = 'dataoffset'),
      (t.OhlcOpen = 'ohlc_open'),
      (t.OhlcHigh = 'ohlc_high'),
      (t.OhlcLow = 'ohlc_low'),
      (t.OhlcClose = 'ohlc_close');
  })(E || (E = {})),
  (function (t) {
  ...
  (function (t) {
    (t[(t.None = 0)] = 'None'),
      (t[(t.Pane = 1)] = 'Pane'),
      (t[(t.DataWindow = 2)] = 'DataWindow'),
      (t[(t.PriceScale = 4)] = 'PriceScale'),
      (t[(t.StatusLine = 8)] = 'StatusLine'),
      (t[(t.All = 15)] = 'All');
  })(F || (F = {})),
  (function (t) {
    (t[(t.None = 0)] = 'None'),
  ...
  (function (t) {
    (t.OhlcBars = 'ohlc_bars'), (t.OhlcCandles = 'ohlc_candles');
  })(B || (B = {})),
  (function (t) {
    (t.Auto = 'auto'),
      (t.Tiny = 'tiny'),
  ...
  (function (t) {
    (t.InitialCapital = 'initial_capital'),
      (t.Currency = 'currency'),
      (t.DefaultQTYValue = 'default_qty_value'),
      (t.DefaultQTYType = 'default_qty_type'),
      (t.Pyramiding = 'pyramiding'),
      (t.ComissionValue = 'commission_value'),
      (t.ComissionType = 'commission_type'),
      (t.BacktestFillLimitsAssumtion = 'backtest_fill_limits_assumption'),
      (t.Slippage = 'slippage'),
      (t.CalcOnOrderFills = 'calc_on_order_fills'),
      (t.CalcOnEveryTick = 'calc_on_every_tick'),
      (t.MarginLong = 'margin_long'),
      (t.MarginShort = 'margin_short'),
      (t.UseBarMagnifier = 'use_bar_magnifier'),
      (t.ProcessOrdersOnClose = 'process_orders_on_close'),
      (t.FillOrdersOnStandardOHLC = 'fill_orders_on_standard_ohlc');
  })(H || (H = {})),
  (function (t) {
    (t.Fixed = 'fixed'),
      (t.CashPerOrder = 'cash_per_order'),
      (t.PercentOfEquity = 'percent_of_equity');
  })(j || (j = {})),
  (function (t) {
    (t.Percent = 'percent'),
      (t.CashPerContract = 'cash_per_contract'),
      (t.CashPerOrder = 'cash_per_order');
  })(z || (z = {})),
  (function (t) {
    (t.FirstBar = 'first_visible_bar_time'),
      (t.LastBar = 'last_visible_bar_time'),
      (t.Realtime = 'subscribeRealtime');
  })(G || (G = {})),
  (function (t) {
    (t.FgColor = '__chart_fgcolor'), (t.BgColor = '__chart_bgcolor');
  })($ || ($ = {})),
  (function (t) {
    (t[(t.Right = 0)] = 'Right'), (t[(t.Left = 1)] = 'Left'), (t[(t.NoScale = 2)] = 'NoScale');
  })(J || (J = {})),
  (function (t) {
    (t[(t.Right = 0)] = 'Right'), (t[(t.Left = 1)] = 'Left'), (t[(t.None = 2)] = 'None');
  })(q || (q = {})),
  (function (t) {
    (t.TypePlots = 'plot_plot'), (t.TypeHlines = 'hline_hline');
  })(K || (K = {})),
  (function (t) {
  ...
  (function (t) {
    (t.Information = 'information'), (t.Warning = 'warning'), (t.Error = 'error');
  })(_t || (_t = {})),
  (function (t) {
  ...
  (function (t) {
    (t[(t.None = 0)] = 'None'), (t[(t.Pips = 1)] = 'Pips'), (t[(t.Ticks = 2)] = 'Ticks');
  })(bt || (bt = {})),
  (function (t) {
    (t.Halted = 'HALTED'), (t.NotShortable = 'NOT-SHORTABLE'), (t.HardToBorrow = 'HARD-TO-BORROW');
  })(ft || (ft = {})),
  (function (t) {
  ...
  (function (t) {
    (t[(t.LastPriceAndPercentageValue = 0)] = 'LastPriceAndPercentageValue'),
      (t[(t.LastValueAccordingToScale = 1)] = 'LastValueAccordingToScale');
  })(It || (It = {})),
  (function (t) {
  ...
  (function (t) {
    (t[(t.Offline = 0)] = 'Offline'),
      (t[(t.Resolving = 1)] = 'Resolving'),
      (t[(t.Loading = 2)] = 'Loading'),
      (t[(t.Ready = 3)] = 'Ready'),
      (t[(t.InvalidSymbol = 4)] = 'InvalidSymbol'),
      (t[(t.Snapshot = 5)] = 'Snapshot'),
      (t[(t.EOD = 6)] = 'EOD'),
      (t[(t.Pulse = 7)] = 'Pulse'),
      (t[(t.Delayed = 8)] = 'Delayed'),
      (t[(t.DelayedSteaming = 9)] = 'DelayedSteaming'),
      (t[(t.NoBars = 10)] = 'NoBars'),
      (t[(t.Replay = 11)] = 'Replay'),
      (t[(t.Error = 12)] = 'Error'),
      (t[(t.CalculationError = 13)] = 'CalculationError'),
      (t[(t.UnsupportedResolution = 14)] = 'UnsupportedResolution');
  })(Ot || (Ot = {})),
  (function (t) {
    (t[(t.Markers = 0)] = 'Markers'),
      (t[(t.Stepline = 1)] = 'Stepline'),
      (t[(t.Simple = 2)] = 'Simple');
  })(Rt || (Rt = {})),
  (function (t) {
    (t[(t.Bar = 0)] = 'Bar'),
      ...
      (t[(t.Kagi = 5)] = 'Kagi'),
      (t[(t.PnF = 6)] = 'PnF'),
      (t[(t.LineBreak = 7)] = 'LineBreak'),
      (t[(t.HeikinAshi = 8)] = 'HeikinAshi'),
      (t[(t.HollowCandle = 9)] = 'HollowCandle'),
      (t[(t.Baseline = 10)] = 'Baseline'),
      (t[(t.Range = 11)] = 'Range'),
      (t[(t.HiLo = 12)] = 'HiLo'),
      (t[(t.Column = 13)] = 'Column'),
      (t[(t.LineWithMarkers = 14)] = 'LineWithMarkers'),
      (t[(t.Stepline = 15)] = 'Stepline'),
      (t[(t.HLCArea = 16)] = 'HLCArea'),
      (t[(t.VolFootprint = 17)] = 'VolFootprint'),
      (t[(t.TPO = 18)] = 'TPO'),
      (t[(t.VolCandle = 19)] = 'VolCandle'),
      (t[(t.SVP = 20)] = 'SVP');
  })(Dt || (Dt = {})),
  (function (t) {
    (t.TwentyFourHours = '24-hours'), (t.TwelveHours = '12-hours');
  })(Vt || (Vt = {})),
  (function (t) {
    (t[(t.Initial = 2)] = 'Initial'),
      (t[(t.SeriesZOrderIsAlwaysZero = 3)] = 'SeriesZOrderIsAlwaysZero'),
...
C.Money, C.Money, _.Right;
var Et, Wt, Ft, Mt, Bt, Nt, Ut, xt, Ht, jt, zt, Gt, $t, Jt, qt;
function y(t, e) {
  const i = L({}, t);
  for (const o in e)
    typeof t[o] != 'object' || t[o] === null || Array.isArray(t[o])
      ? e[o] !== void 0 && (i[o] = e[o])
      : (i[o] = y(t[o], e[o]));
  return i;
}
(function (t) {
  (t[(t.Background = 0)] = 'Background'),
    ...
    (t[(t.Topmost = 2)] = 'Topmost');
})(Et || (Et = {})),
  (function (t) {
    (t[(t.Unavailable = 0)] = 'Unavailable'),
      (t[(t.AvailableReadonlyAlwaysDisabled = 1)] = 'AvailableReadonlyAlwaysDisabled'),
      (t[(t.AvailableReadonlyAlwaysEnabled = 2)] = 'AvailableReadonlyAlwaysEnabled'),
      (t[(t.Available = 3)] = 'Available');
  })(Wt || (Wt = {})),
  (function (t) {
    (t[(t.ViewportChangeUserAction = 0)] = 'ViewportChangeUserAction'),
      (t[(t.DataUpdate = 1)] = 'DataUpdate'),
      (t[(t.SeriesRestart = 2)] = 'SeriesRestart'),
      (t[(t.SeriesCompleted = 3)] = 'SeriesCompleted'),
      (t[(t.StudyCreation = 4)] = 'StudyCreation');
  })(Ft || (Ft = {})),
  (function (t) {
    t[(t.Chart = 0)] = 'Chart';
  })(Mt || (Mt = {})),
  ...
  (function (t) {
    (t[(t.Bars = 0)] = 'Bars'),
      (t[(t.Candles = 1)] = 'Candles'),
      (t[(t.Line = 2)] = 'Line'),
      (t[(t.Area = 3)] = 'Area'),
      (t[(t.HeikenAshi = 8)] = 'HeikenAshi'),
      (t[(t.HollowCandles = 9)] = 'HollowCandles'),
      (t[(t.Baseline = 10)] = 'Baseline'),
      (t[(t.HiLo = 12)] = 'HiLo'),
      (t[(t.Column = 13)] = 'Column'),
      (t[(t.LineWithMarkers = 14)] = 'LineWithMarkers'),
      ...
      (t[(t.Renko = 4)] = 'Renko'),
      (t[(t.Kagi = 5)] = 'Kagi'),
      (t[(t.PointAndFigure = 6)] = 'PointAndFigure'),
      (t[(t.LineBreak = 7)] = 'LineBreak');
  })(Ut || (Ut = {})),
  (function (t) {
    t.Value = '_seriesId';
  ...
  (function (t) {
    (t.UpDown = 'Up/Down'), (t.Total = 'Total'), (t.Delta = 'Delta');
  })(zt || (zt = {})),
  (function (t) {
    (t.AboveBar = 'AboveBar'),
      (t.BelowBar = 'BelowBar'),
      ...
      (t.Left = 'Left'),
      (t.Absolute = 'Absolute'),
      (t.AbsoluteUp = 'AbsoluteUp'),
      (t.AbsoluteDown = 'AbsoluteDown');
  })(Gt || (Gt = {})),
  (function (t) {
...
const ce = class {
  constructor(t) {
    ...
    !((e = t.overrides) === null || e === void 0) &&
      e['mainSeriesProperties.priceAxisProperties.lockScale'] &&
      (console.warn(
      ...
      (this._options = y(re, t)),
      ((i = this._options.theme) !== null && i !== void 0 ? i : 'light').toLowerCase() === 'dark' &&
        this._options.loading_screen === void 0 &&
        (this._options.loading_screen = { backgroundColor: '#131722' }),
      (this._options.debug || this._options.debug_broker) &&
        (Zt ||
          ((Zt = !0),
          console.log('Using CL v28.1.0 (internal id 17df7cfa @ 2024-09-05T15:20:50.323Z)'))),
      this._create();
  }
  setDebugMode(t) {
  ...
  setSymbol(t, e, i) {
    this._innerAPI().changeSymbol(t, e, i);
  }
  remove() {
  ...
  saveChartToServer(t, e, i) {
    this._innerAPI().saveChartToServer(t, e, i);
  }
  ...
  applyOverrides(t) {
    (this._options = y(this._options, { overrides: t })),
  ...
  getCSSCustomPropertyValue(t) {
    ...
    const e = this._innerWindow().document.body,
      i = e.style.getPropertyValue(t);
    return i || getComputedStyle(e).getPropertyValue(t);
  }
  unloadUnusedCharts() {
  ...
  async _create() {
    ...
    const l =
        (e =
          (t = this._options.enabled_features) === null || t === void 0
            ? void 0
            : t.includes('iframe_loading_same_origin')) !== null &&
        e !== void 0 &&
        e,
      c =
        l ||
        ((o =
          (i = this._options.enabled_features) === null || i === void 0
            ? void 0
            : i.includes('iframe_loading_compatibility_mode')) !== null &&
          o !== void 0 &&
          o),
      [S, r] = this._render(!c, l),
      n = this._options.container,
      s = typeof n == 'string' ? document.getElementById(n) : n;
    if (s === null) throw new Error('There is no such element - #'.concat(this._options.container));
    (s.innerHTML = S), (this._iFrame = s.querySelector('#'.concat(this._id)));
    const a = this._iFrame;
    l && (await this._innerWindowEvent('sameOriginLoad')),
      c &&
        (a.contentWindow
      ...
      this._innerWindowLoaded.then(() => {
        try {
          this._innerWindow().widgetReady(() => {
            this._ready = !0;
            for (const d of this._readyHandlers)
              try {
                d.call(this);
              } catch (h) {
                console.error(h);
          ...
          if (d instanceof Error && /widgetReady is not a function/.test(d.message))
            throw new Error(
              'There was an error when loading the library. Usually this error means the library failed to load its static files. Check that the library files are available at '
                ...
                .concat(this._options.library_path || '', ' or correct the library_path option.')
            );
        }
      });
  }
  _innerWindowEvent(t) {
    return new Promise((e) => {
      const i = () => {
        this._innerWindow().removeEventListener(t, i), e();
      };
      this._innerWindow().addEventListener(t, i);
    });
  }
  _render(t, e) {
    var i;
    ...
    if (
      ...
      const r = encodeURIComponent(this._options.locale);
      Kt.findIndex((n) => n.language === r) >= 0 ||
        (console.warn("locale isn't supported. Using default of `en`."),
        (this._options.locale = 'en'));
    }
    const l = (function (r, n) {
      var s;
      const a = new URL(''.concat(r || ''), location.href).href,
        d = JSON.parse(
          '["bundles/runtime.a78aa5d8cacc59cc758a.js","bundles/__LANG__.4026.7fd0f0d599a897631492.js","bundles/9662.03109f673cda5962c847.css","bundles/7346.b02c4b5d2d08b5be4162.js","bundles/library.a50e5cd0e299c98bc5fe.js"]'
        ),
        h = encodeURIComponent(n),
        p =
          (s = Kt.find((u) => u.language === h)) !== null && s !== void 0
            ? s
            : { iso: 'en', dir: 'ltr' },
        Qt = 'lang="'.concat(p.iso, '" dir="').concat(p.dir, '"'),
        Yt = '\n'.concat(
          (function (u, Xt, te) {
            if (u === void 0) return '';
            const T = [],
      ...
      return '<!DOCTYPE html><html '
        .concat(
          (m = { bundles: Yt, localeLanguage: h, htmlAttrs: Qt, libraryPath: a }).htmlAttrs,
          '><head><base href="'
        )
        .concat(
          m.libraryPath,
    ...
    if (t) {
      const r = new Blob([l], { type: 'text/html' }),
        n = URL.createObjectURL(r);
      c = new URL(n);
    } else if (e) {
      const r = (i = this._options.library_path) !== null && i !== void 0 ? i : '/';
      c = new URL(r + 'sameorigin.html', location.origin);
    }
    const S =
      'symbol=' +
      ...
      (this._options.debug_broker
        ? '&debugBroker=' + encodeURIComponent(String(this._options.debug_broker))
        : '') +
    ...
    return [
      '<iframe\n		id="'
        ...
        .concat(this._id, '" src="')
        .concat(c.href, '" data-widget-options="')
        .concat(S, '"\n		')
        .concat(
          this._options.autosize || this._options.fullscreen
            ? ''
            : 'width="'.concat(this._options.width, '" height="').concat(this._options.height, '"'),
...
typeof window < 'u' &&
  ((window.TradingView = window.TradingView || {}), (window.TradingView.version = ne));
const ae =
  !(typeof window > 'u' || !window.navigator || !window.navigator.userAgent) &&
  window.navigator.userAgent.includes('CriOS');
export { ce as D };
//# sourceMappingURL=charting_library.esm-DE-cokbk.js.map
