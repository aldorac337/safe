  ...
  [2193],
  {
    ...
    49478: (e, t, l) => {
      ...
      let F = (0, r.A)(
        ...
        p = [
          { label: 'Browser Wallet', icon: F, connector: 'injected' },
          {
          ...
          { label: 'Coinbase', icon: d, connector: 'coinbaseWallet' },
    ...
    53001: (e, t, l) => {
      ...
      let d = {
        ...
        pool: ({ chainId: e, poolId: t }) => [...d.chain({ chainId: e }), 'pool', { poolId: t }],
        contract: ({ blockchainId: e, contractAddress: t }) => [
          ...d.chainName({ blockchainId: e }),
          'contract',
          { contractAddress: t },
        ],
        gauge: ({ chainId: e, poolId: t }) => [...d.pool({ chainId: e, poolId: t }), 'gauge'],
      };
    },
    53082: (e, t, l) => {
      function a(e) {
    ...
    57254: (e, t, l) => {
      ...
      var a = l(7620),
        ...
        c = l(68642);
      let F = new Map(),
        d = (e, t) => (F.has(e) ? F.get(e) : t),
        h = (e, t) => (null == t ? F.delete(e) : F.set(e, t)),
        p = (e, t) => (0, c.E)({ key: e, initialValue: t, get: d, set: h });
      var f = l(35420),
        E = l(49478);
      let o = { provider: null, wallet: null },
        s = () => {
          let [e, t] = p('showConnectModal', !1),
            ...
            { wallet: c, provider: F } = (0, n.w5)();
          (o.wallet = c ?? null), (o.provider = F ?? null);
          let { connectAsync: d } = (0, r.e)(),
            { disconnect: h } = (0, m.u)(),
            s = (0, a.useCallback)(
              async (e) => {
                if (!e) {
                ...
                try {
                  await d({ connector: f.t[l.connector] }), t(!1);
                } catch (e) {
          ...
          return (
            ...
            { wallet: c, connect: s, disconnect: h, provider: F, showModal: e, closeModal: l }
          );
        };
    ...
    72415: (e, t, l) => {
      ...
      let a = {
        ...
        d = { Snackbar: 6e3, TooltipEnter: 500 },
        h = 'ease-out 256ms';
    },
    73716: (e, t, l) => {
      l.d(t, {
      ...
      let d = {
        ...
        { HYDRATE: E, SWITCH_NETWORK: o, CONNECT_API: s } = d,
      ...
      let x = ({ hydrate: e, initLib: t, chainId: l, onChainUnavailable: d, children: z }) => {
    ...
    88411: (e, t, l) => {
      ...
      let h = (e) =>
          (0, r.jsx)(n.A, {
            ...
            ...e,
            children: (0, d.t)`Connect Wallet`,
          }),
        p = ({ sx: e, onConnect: t }) => {
          let { address: l } = (0, m.F)(),
            { connect: i, disconnect: n } = (0, a.vT)(),
            { connectState: c } = (0, a.w5)(),
            d = (0, a.VP)(c, a.Ej.CONNECT_WALLET);
          return l
            ? (0, r.jsx)(F, { address: l, onClick: () => n(), loading: d, sx: e })
            : (0, r.jsx)(h, { onClick: () => (t?.(), i()), loading: d, sx: e });
        };
      var f = l(61773),
        E = l(31184),
        o = l(32678),
            ...
            children: [
              (0, r.jsxs)(E.A, {
                ...
                children: [
                  ...
                  (0, r.jsx)(s.A, { variant: 'headingXxl', children: (0, d.t)`Enter Curve` }),
                ],
              }),
              (0, r.jsxs)(E.A, {
                spacing: 3,
      ...
      let L = { hint: 'info', error: 'error', pending: 'info', success: 'success' },
        M = {
          hint: (0, d.t)`Hint`,
          error: (0, d.t)`Error`,
          pending: (0, d.t)`Pending`,
          success: (0, d.t)`Success`,
        },
        S = ({ headerHeight: e }) => {
