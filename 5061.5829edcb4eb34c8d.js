try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = '2ddf5677-2e40-4134-a8b5-acff8f2b1cdf'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-2ddf5677-2e40-4134-a8b5-acff8f2b1cdf'));
} catch (e) {}
('use strict');
        ...
        return '3' === e.version || e.headlessMode
          ? (0, i.K)((i) => ({
              ...
              async getProvider() {
                if (!d) {
                  t = new (await (async () => {
                    let { default: e } = await Promise.all([n.e(9141), n.e(8268)]).then(
                      n.t.bind(n, 49141, 19)
                    );
              ...
              async connect({ chainId: e, ...t } = {}) {
                try {
                  ...
                  m || ((m = this.onAccountsChanged.bind(this)), n.on('accountsChanged', m)),
                    ...
                    f || ((f = this.onDisconnect.bind(this)), n.on('disconnect', f));
              ...
              async getProvider() {
                if (!w) {
                  let i =
                    ...
                    { createCoinbaseWalletSDK: a } = await n.e(5766).then(n.bind(n, 15766));
                  w = a({
                    ...e,
