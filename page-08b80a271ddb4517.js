        ...
        let {
          ...
          em = async () => {
            if (!(en.length < G.V2)) {
              ...
              try {
                var e;
                await (null === (e = _.verify) || void 0 === e ? void 0 : e.onContinue(en)),
                  ex.setCurrentPage(g.jo.SUCCESS);
              } catch (e) {
          ...
          ex = (0, g.Qt)(),
          [ef, ey] = (0, a.useState)(!0);
        (0, a.useEffect)(() => {
          setTimeout(() => {
            ey(!1);
          }, 600);
        }, []);
        let [ej, eA] = (0, a.useState)(!1),
          eI = b === U.v.PERSONAL_SIGN,
          ek = ex.currentPage === g.jo.REVIEW,
          e_ = ex.currentPage === g.jo.VERIFY,
          eT = ex.currentPage === g.jo.PENDING && !eI,
          eS = ex.currentPage === g.jo.ERROR,
          eE = ex.currentPage === g.jo.SUCCESS,
          eC = ex.currentPage === g.jo.PENDING && eI,
          eN = eT || eS || eE,
          eb =
            0 !==
          ...
          eO = eN ? (eT ? eP[b].pending : eE ? eP[b].success : eP[b].error) : eP[b].ready;
        return (0, s.jsxs)('div', {
          className: h().screens,
          children: [
            !eI &&
              (0, s.jsxs)('ul', {
                className: h().steps,
                children: [
                  (0, s.jsx)('li', { 'data-active': ek, children: 'Review' }),
                  (null === (t = _.verify) || void 0 === t ? void 0 : t.onContinue) &&
                    (0, s.jsx)('li', { 'data-active': e_, children: 'Verify' }),
                  (0, s.jsx)('li', {
                    'data-active': eN,
            ...
            (0, s.jsxs)('div', {
              ...
              children: [
                (0, s.jsx)(A.w, {
                  ...
                  children: (0, s.jsx)(o.M, {
                    ...
                    children: (0, s.jsxs)(
                      ...
                      eN ? 'processing' : e_ ? 'verify' : 'review'
                    ),
                  }),
                }),
                ek &&
                ...
                !e_ && (0, s.jsx)(X.z, { wallet: T, network: C }),
                ek &&
                  eb &&
                  (0, s.jsx)(y.b, {
                    children: (0, s.jsx)('div', {
                          ...
                          (0, s.jsxs)(S.x, {
                            ...
                            children: [
                              ...
                              (0, s.jsx)(j.z, {
                                ...
                                wide: !0,
                                textOverflow: 'none',
                                onClick: eR && !eC ? _.review.onContinue : void 0,
                                state: Q ? 'idle' : eR ? void 0 : 'pending',
                                disabled: !eR || (ew && !ev) || (eb && !eh),
                                prefixIcon:
                                  eI && eC ? (0, s.jsx)(f.J, { name: 'toastCheck' }) : void 0,
                            ...
                            (0, s.jsxs)(S.x, {
                              ...
                              children: [
                                (0, s.jsx)(j.z, {
                                  ...
                                  id: 'back-button',
                                  disabled: ed,
                                  onClick: () => ex.setCurrentPage(g.jo.REVIEW),
                                  variant: 'secondary',
                                  type: 'button',
                                  children:
                                    null !==
  ...
  function (e) {
    e.O(
      ...
      [
        ...
        5469, 8130, 25, 5385, 4512, 1934, 2665, 3109, 9801, 1744,
      ],
      function () {
        return e((e.s = 78138));
      }
