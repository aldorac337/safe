try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = 'ae11e4de-b595-4a83-9b83-4b5593cf2ed8'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-ae11e4de-b595-4a83-9b83-4b5593cf2ed8'));
} catch (e) {}
  ...
  [1744],
  {
      ...
      let o = n.z.string(),
        ...
        p = (0, i.D)({
          client: {
            ...
            NEXT_PUBLIC_EXPLICIT_WRAP_FLOW_ENABLED: u,
          },
          runtimeEnv: {
            ...
            NEXT_PUBLIC_EXPLICIT_WRAP_FLOW_ENABLED: 'true',
          },
        });
    },
    ...
    43872: function (e, t, a) {
      ...
      (globalThis._sentryRewritesTunnelPath = void 0),
        (globalThis.SENTRY_RELEASE = { id: 'd7ca2c2a7fed091567cc6c1d2c87d3ecf9bc9cf7' }),
    ...
    43394: function (e, t, a) {
      ...
      let C = i('/assets/logos/aave.svg'),
        ...
        D = Object.values(F).filter((e) => void 0 !== e);
      ...
      let M = {
        ...
        getMetadata: (e) => {
          let t = F[e];
          if (!(0, n.isDefined)(t)) throw new S(e);
          return t;
        },
        getSafeIdentifier: (e) => {
          let t = F[e];
        ...
        tryGetChain: (e) => {
          ...
          let a = D.find((e) => e.chain.id === t || e.name === t);
          return a ? a.chain : null;
        },
        getProtocol: (e) => {
          let { chainId: t, name: a } = e,
            i = F[t];
          if (!(0, n.isDefined)(i)) throw new S(t);
        ...
        getVaultVersionByAddress: (e, t) => {
          var a;
          let i = F[e];
          if (!(0, n.isDefined)(i)) throw new S(e);
          return null ===
