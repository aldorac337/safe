try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = 'd5db25f4-ba5d-4a29-8f39-75d91a1dfa3b'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-d5db25f4-ba5d-4a29-8f39-75d91a1dfa3b'));
} catch (e) {}
('use strict');
  ...
  [6358],
  {
    ...
    69430: function (e, t, n) {
      ...
      var D = (0, i.memo)((e) => {
          ...
          let {
            ...
            eb = (0, A.ZP)({ address: q, error: eg, isWrongChain: H.isWrongChain, chainId: L }),
            eA = (0, y.Z)(H.address, eo.data, null == eh ? void 0 : eh.address),
            { isReadOnly: eZ } = (0, o.WW)({ chainId: L, address: q }),
            ew = (0, i.useMemo)(
              () => (K && G) || !!eg || !!z || !(0, p.H)(et) || eZ || H.isWrongChain || !eA,
              [H.isWrongChain, K, eA, G, eZ, eg, et, z]
            ),
            { initialData: ex, finalData: ek } = (0, b.Z)(H.address, em, et.vaultAddress, eh),
            eB = (0, Z.M)(
              et.vaultAddress,
              null == Y
                ? void 0
            ...
            eI = (0, i.useMemo)(
              () => !!ey || !!ef || !eA || !!H.isWrongChain || !(0, p.H)(et),
              [H.isWrongChain, eA, ef, et, ey]
            ),
            eM = (0, i.useCallback)(() => {
                  ...
                  children: [
                    (0, a.BX)(s.Kqy, {
                      ...
                      children: [
                        ...
                        !eA && (0, a.tZ)(u.r, { tokenAddress: eh.address }),
                      ],
                    }),
                    (0, a.tZ)(x.Z, {
                      vault: {
    ...
    55839: function (e, t, n) {
      ...
      var D = (0, i.memo)((e) => {
          ...
          let {
              ...
              confirm: eu,
              isLoading: ec,
            } = (0, b.L)(q, { origin: 'position-manager' }),
            ep = (0, i.useMemo)(
              () => (0, o.wk)(null == Y ? void 0 : Y.vaultByAddress.asset),
              [null == Y ? void 0 : Y.vaultByAddress.asset]
            ),
            ...
            ef = (0, A.ZP)({ address: q, error: ey, isWrongChain: H.isWrongChain, chainId: L }),
            eg = (0, y.Z)(H.address, eo.data, null == ep ? void 0 : ep.address),
            { isReadOnly: eb } = (0, o.WW)({ chainId: L, address: q }),
            eA = (0, i.useMemo)(
              () => (K && G) || !!ey || !!z || !(0, p.H)(et) || eb || H.isWrongChain || !eg,
              [H.isWrongChain, K, eg, G, eb, ey, et, z]
            ),
    ...
    1208: function (e, t, n) {
      ...
      t.default = (0, i.memo)((e) => {
        ...
        return (0, a.tZ)(o.I, {
          side: 'top',
          enabled: v && y.featureCallOut && !A && !Z,
    ...
    12472: function (e, t, n) {
      ...
      t.Z = (0, i.memo)((e) => {
        var t, n, y;
        let { initialPosition: f, finalPosition: g, vault: b } = e,
          { targetChain: A } = (0, u.Z_)(),
          Z = (0, i.useMemo)(() => (0, c.m)(b.allocation), [b.allocation]),
          w = (0, i.useMemo)(
            () => l.$0l.percent.digits(2).unit('%').of(b.dailyNetApy),
            [b.dailyNetApy]
          ),
          x = (0, i.useMemo)(
            () => ((0, o.isDefined)(b.warnings) ? (0, l.Myy)(b.warnings) : void 0),
            [b.warnings]
          ),
          k = (0, i.useMemo)(() => {
            let e = (0, l.Uaj)(b.name);
            return e ? (0, o.formatLongString)(e, 22) : '';
          }, [b.name]),
          B = (0, i.useMemo)(() => {
            if (b.dailyApy) return (0, s.safeParseNumber)(b.dailyApy);
          }, [b.dailyApy]),
          T = (0, i.useMemo)(() => {
            if (b.fee) return (0, s.safeParseNumber)(b.fee);
          }, [b.fee]);
        return (0, a.BX)(l.soA.Root, {
          ...
          children: [
            (0, a.BX)(l.soA.Header, {
              children: [
                (0, a.tZ)(l.qEK, { size: 'large', src: b.asset.logoURI }),
                (0, a.BX)(l.Kqy, {
                  direction: 'column',
                  gap: 'xs',
                  children: [
                    ...
                    (0, a.BX)(l.Kqy, {
                      ...
                      children: [
                        ...
                        (0, a.tZ)(m.x, {
                          tooltip: 'Open vault.',
                          href: (0, v.Q)({
                            chainName: r.FW.getNameById(A.id),
              ...
              children: [
                (0, a.tZ)(l.soA.ListItem, {
                  label: 'My Position ('.concat(
                    (0, o.formatLongString)(null !== (n = b.asset.symbol) && void 0 !== n ? n : ''),
                    ')'
                  ),
                    ...
                    children: [
                      ...
                      (0, a.tZ)(h.w, {
                        RewardsHoverCardProps: {
                          ...
                          apy: B,
                          rewards: b.rewards,
                          points: null !== (y = b.points) && void 0 !== y ? y : [],
                          variant: 'vault',
                        },
                      }),
                    ],
      ...
      let c = s.MathLib.MAX_UINT_160,
        p = function (e, t, n) {
          ...
          let v = !(arguments.length > 3) || void 0 === arguments[3] || arguments[3],
            ...
            [g, b] = (0, u.b)(y, f, n, m),
            { steps: A, exceededToken: Z } = (0, a.useMemo)(() => {
              let e;
              return v
                ? {
                    steps:
    ...
    61536: function (e, t, n) {
      ...
      let l = (e) => {
          ...
          let { userAddress: l, state: d, vault: u, position: c } = e,
            ...
            b = null == v ? void 0 : v.getBundleBalance(l, u.address),
            A = (0, r.isDefined)(null == c ? void 0 : c.assets) ? c.assets : null,
            Z = (0, r.isDefined)(g) && (0, r.isDefined)(h) ? h.toAssets(g) : void 0,
            w = (0, r.isDefined)(b) && (0, r.isDefined)(m) ? m.toAssets(b) : void 0,
            ...
            B =
              (0, r.isDefined)(w) && (0, r.isDefined)(y)
                ? null == y
                  ...
                  : y.toUsd(w)
                : void 0,
            T = (!(0, r.isDefined)(g) || 0n === g) && (0, r.isDefined)(b),
            I = { apiValue: f, initialOnchainValue: g, latestSimulatedValue: b },
            M = { apiValue: A, initialOnchainValue: Z, latestSimulatedValue: w },
    ...
    71021: function (e, t, n) {
      ...
      let h = function (e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          I = (0, a.useMemo)(
            () => ({
              ...
              options: {
                origin: t.origin,
                isMax: b ? [o.H.InterfaceOperationType.metaMorphoDeposit] : [],
                disabledPeripheralTokens: Z,
              },
            }),
            [f, Z, b, h.id, e, t.origin]
          ),
          ...
          D = (0, a.useMemo)(() => {
            let e = b !== h.options.isMax.includes(o.H.InterfaceOperationType.metaMorphoDeposit),
              t = f !== h.assets;
            return e || t;
          }, [f, b, h.assets, h.options.isMax]),
          X = (0, a.useCallback)(() => {
            M(I.id, () => I), S(!1);
          }, [I, M]);
        (0, a.useEffect)(() => {
        ...
        (0, a.useEffect)(() => {
          O ||
            (A(h.options.isMax.includes(o.H.InterfaceOperationType.metaMorphoDeposit)),
        ...
        return (0, a.useMemo)(
          ...
          [y, f, B, b, W, T, I, m, X, E, C, w, O, null == k ? void 0 : k.assets, D]
        );
      };
    },
    48972: function (e, t, n) {
      ...
      let p = function (e) {
        ...
        let O = (0, a.useCallback)(
          (e) => {
            if (e) {
              if ((null == A ? void 0 : A.assets) == null) return;
              m(A.assets), f(A.shares);
            }
            b(e);
          },
          [A]
        ...
        (0, a.useEffect)(() => {
          M || (m(n.assets), f(n.shares), b(n.options.isMax.includes(n.type)));
        ...
        return (0, a.useMemo)(
          () => ({
            ...
            setIsMax: O,
            localOperation: B,
            maxAmount: null == A ? void 0 : A.assets,
            isLoading: k,
            initialState: l,
            confirm: P,
            cancel: S,
          ...
          [p, Z, w, g, O, B, null == A ? void 0 : A.assets, k, l, P, S, M, x]
        );
      };
    },
