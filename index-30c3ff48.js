import { a2 as Q, i as kt, h as zt, d as $t, x as Y } from './index-6823ac84.js';
import { n as v, c as Ot } from './if-defined-5ea4ccf2.js';
...
(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = '3ce9812a-1d90-4167-92af-3895af3409cb'),
      (e._sentryDebugIdIdentifier = 'sentry-dbid-3ce9812a-1d90-4167-92af-3895af3409cb'));
  } catch {}
})();
var K = {},
  Vt = function () {
...
(function (e) {
  ...
  (e.getRowColCoords = function (o) {
    ...
    const r = Math.floor(o / 7) + 2,
      ...
      u = [n - 7];
    for (let a = 1; a < r - 1; a++) u[a] = u[a - 1] - s;
...
(function (e) {
  ...
  (e.isValid = function (r) {
    ...
    (e.getPenaltyN1 = function (r) {
      ...
      for (let B = 0; B < n; B++) {
        ...
        for (let p = 0; p < n; p++) {
          let w = r.get(B, p);
          w === d ? u++ : (u >= 5 && (s += t.N1 + (u - 5)), (d = w), (u = 1)),
            (w = r.get(p, B)),
            w === h ? a++ : (a >= 5 && (s += t.N1 + (a - 5)), (h = w), (a = 1));
        }
    ...
    (e.getPenaltyN3 = function (r) {
      ...
      for (let d = 0; d < n; d++) {
        u = a = 0;
        for (let h = 0; h < n; h++)
          (u = ((u << 1) & 2047) | r.get(d, h)),
            h >= 10 && (u === 1488 || u === 93) && s++,
            (a = ((a << 1) & 2047) | r.get(h, d)),
            h >= 10 && (a === 1488 || a === 93) && s++;
      }
      return s * t.N3;
    }),
  ...
  (e.applyMask = function (r, n) {
    const s = n.size;
    for (let u = 0; u < s; u++)
      for (let a = 0; a < s; a++) n.isReserved(a, u) || n.xor(a, u, i(r, a, u));
  }),
...
(function () {
  let t = 1;
  for (let i = 0; i < 255; i++) (V[i] = t), (W[t] = i), (t <<= 1), t & 256 && (t ^= 285);
...
(function (e) {
  ...
  (e.mul = function (o, r) {
    ...
    for (let s = 0; s < o.length; s++)
      for (let u = 0; u < r.length; u++) n[s + u] ^= t.mul(o[s], r[u]);
    return n;
  }),
    (e.mod = function (o, r) {
      ...
      for (; n.length - r.length >= 0; ) {
        const s = n[0];
        for (let a = 0; a < r.length; a++) n[a] ^= t.mul(r[a], s);
        let u = 0;
...
ht.prototype.initialize = function (t) {
...
const Wt = new RegExp('^' + H + '$'),
  qt = new RegExp('^' + Rt + '$'),
  xt = new RegExp('^[A-Z0-9 $%*+\\-./:]+$');
...
(function (e) {
  const t = I,
    ...
    u = t.getBCHDigit(s);
  function a(p, w, E) {
    for (let m = 1; m <= 40; m++) if (w <= e.getCapacity(m, E, p)) return m;
  }
  function d(p, w) {
    return r.getCharCountIndicator(p, w) + 4;
  }
  function h(p, w) {
    let E = 0;
    return (
  ...
  function B(p, w) {
    for (let E = 1; E <= 40; E++) if (h(p, E) <= e.getCapacity(E, w, r.MIXED)) return E;
  }
  (e.from = function (w, E) {
    ...
    (e.getCapacity = function (w, E, m) {
      ...
      typeof m > 'u' && (m = r.BYTE);
      const y = t.getSymbolTotalCodewords(w),
        g = i.getTotalCodewordsCount(w, E),
        l = (y - g) * 8;
    ...
    (e.getBestVersionForData = function (w, E) {
      let m;
      const y = o.from(E, o.M);
      if (Array.isArray(w)) {
        if (w.length > 1) return B(w, y);
        if (w.length === 0) return 1;
        m = w[0];
      } else m = w;
      return a(m.mode, m.getLength(), y);
    }),
    (e.getEncodedBits = function (w) {
      if (!n.isValid(w) || w < 7) throw new Error('Invalid QR Code version');
      let E = w << 12;
      for (; t.getBCHDigit(E) - u >= 0; ) E ^= s << (t.getBCHDigit(E) - u);
      return (w << 12) | E;
    });
})(Mt);
var Pt = {};
const ut = I,
  Lt = 1335,
  Xt = 21522,
  pt = ut.getBCHDigit(Lt);
Pt.getEncodedBits = function (t, i) {
  const o = (t.bit << 3) | i;
  let r = o << 10;
  for (; ut.getBCHDigit(r) - pt >= 0; ) r ^= Lt << (ut.getBCHDigit(r) - pt);
  return ((o << 10) | r) ^ Xt;
};
var _t = {};
const Zt = U;
...
(function (e) {
  var t = {
    single_source_shortest_paths: function (i, o, r) {
      ...
      u.push(o, 0);
      for (var a, d, h, B, p, w, E, m, y; !u.empty(); ) {
        (a = u.pop()), (d = a.value), (B = a.cost), (p = i[d] || {});
        for (h in p)
          p.hasOwnProperty(h) &&
            ((w = p[h]),
            (E = B + w),
...
(function (e) {
  ...
  function B(g) {
    const l = h(s.NUMERIC, t.NUMERIC, g),
      f = h(s.ALPHANUMERIC, t.ALPHANUMERIC, g);
    let c, C;
    return (
      u.isKanjiModeEnabled()
        ? ((c = h(s.BYTE, t.BYTE, g)), (C = h(s.KANJI, t.KANJI, g)))
        : ((c = h(s.BYTE_KANJI, t.BYTE, g)), (C = [])),
      l
        .concat(f, c, C)
        .sort(function (A, T) {
  ...
  function w(g) {
    return g.reduce(function (l, f) {
      const c = l.length - 1 >= 0 ? l[l.length - 1] : null;
      return c && c.mode === f.mode ? ((l[l.length - 1].data += f.data), l) : (l.push(f), l);
    }, []);
  }
  function E(g) {
    const l = [];
    for (let f = 0; f < g.length; f++) {
      ...
      switch (c.mode) {
        case t.NUMERIC:
          ...
          break;
        case t.ALPHANUMERIC:
          l.push([c, { data: c.data, mode: t.BYTE, length: c.length }]);
          break;
        case t.KANJI:
          l.push([c, { data: c.data, mode: t.BYTE, length: d(c.data) }]);
          break;
        case t.BYTE:
          l.push([{ data: c.data, mode: t.BYTE, length: d(c.data) }]);
      }
    }
    return l;
  }
  function m(g, l) {
    ...
    for (let b = 0; b < g.length; b++) {
      ...
      for (let _ = 0; _ < A.length; _++) {
        const S = A[_],
          O = '' + b + _;
        T.push(O), (f[O] = { node: S, lastCount: 0 }), (c[O] = {});
        for (let et = 0; et < C.length; et++) {
          const R = C[et];
          f[R] && f[R].node.mode === S.mode
            ? ((c[R][O] = p(f[R].lastCount + S.length, S.mode) - p(f[R].lastCount, S.mode)),
              (f[R].lastCount += S.length))
            : (f[R] && (f[R].lastCount = S.length),
              (c[R][O] = p(S.length, S.mode) + 4 + t.getCharCountIndicator(S.mode, l)));
        }
      }
      C = T;
    }
    for (let b = 0; b < C.length; b++) c[C[b]].end = 0;
    return { map: c, table: f };
  }
  function y(g, l) {
    let f;
    const c = t.getBestModeForData(g);
    if (((f = t.from(l, c)), f !== t.BYTE && f.bit < c.bit))
      throw new Error(
        '"' +
          g +
 ...
 Suggested mode is: ` +
    ...
    switch ((f === t.KANJI && !u.isKanjiModeEnabled() && (f = t.BYTE), f)) {
      case t.NUMERIC:
        return new i(g);
      case t.ALPHANUMERIC:
        return new o(g);
  ...
  (e.fromArray = function (l) {
    return l.reduce(function (f, c) {
      return typeof c == 'string' ? f.push(y(c, null)) : c.data && f.push(y(c.data, c.mode)), f;
    }, []);
  }),
    (e.fromString = function (l, f) {
      const c = B(l, u.isKanjiModeEnabled()),
        C = E(c),
        b = m(C, f),
        A = a.find_path(b.map, 'start', 'end'),
        T = [];
      for (let _ = 1; _ < A.length - 1; _++) T.push(b.table[A[_]].node);
      return e.fromArray(w(T));
    }),
    (e.rawSplit = function (l) {
      return e.fromArray(B(l, u.isKanjiModeEnabled()));
    });
})(_t);
const tt = I,
  rt = x,
...
function it(e, t, i) {
  const o = e.size,
    r = we.getEncodedBits(t, i);
  let n, s;
  for (n = 0; n < 15; n++)
    (s = ((r >> n) & 1) === 1),
      n < 6 ? e.set(n, 8, s, !0) : n < 8 ? e.set(n + 1, 8, s, !0) : e.set(o - 15 + n, 8, s, !0),
      n < 8
        ? e.set(8, o - n - 1, s, !0)
        : n < 9
...
function Ae(e, t, i) {
  ...
  i.forEach(function (a) {
    o.put(a.mode.bit, 4), o.put(a.getLength(), ye.getCharCountIndicator(a.mode, e)), a.write(o);
  });
  const r = tt.getSymbolTotalCodewords(e),
    n = lt.getTotalCodewordsCount(e, t),
    s = (r - n) * 8;
  for (o.getLengthInBits() + 4 <= s && o.put(0, 4); o.getLengthInBits() % 8 !== 0; ) o.putBit(0);
  const u = (s - o.getLengthInBits()) / 8;
  for (let a = 0; a < u; a++) o.put(a % 2 ? 17 : 236, 8);
  return Ie(o, e, t);
}
function Ie(e, t, i) {
  const o = tt.getSymbolTotalCodewords(t),
    r = lt.getTotalCodewordsCount(t, i),
    n = o - r,
    s = lt.getBlocksCount(t, i),
    u = o % s,
    a = s - u,
    d = Math.floor(o / s),
    h = Math.floor(n / s),
  ...
  for (let A = 0; A < s; A++) {
    const T = A < a ? h : B;
    (m[A] = l.slice(E, E + T)), (y[A] = w.encode(m[A])), (E += T), (g = Math.max(g, T));
  }
  const f = new Uint8Array(o);
  let c = 0,
    C,
    b;
  for (C = 0; C < g; C++) for (b = 0; b < s; b++) C < m[b].length && (f[c++] = m[b][C]);
  for (C = 0; C < p; C++) for (b = 0; b < s; b++) f[c++] = y[b][C];
  return f;
}
function Te(e, t, i, o) {
  let r;
  if (Array.isArray(e)) r = ot.fromArray(e);
  else if (typeof e == 'string') {
    let d = t;
    if (!d) {
      const h = ot.rawSplit(e);
      d = q.getBestVersionForData(h, i);
    }
    r = ot.fromString(e, d || 40);
  } else throw new Error('Invalid data');
  const n = q.getBestVersionForData(r, i);
...
`
  ...
  return (
    ...
    t >= 7 && Be(a, t),
    be(a, s),
    isNaN(o) && (o = ct.getBestMask(a, it.bind(null, a, i))),
    ct.applyMask(o, a),
    it(a, i, o),
    { modules: a, version: t, errorCorrectionLevel: i, maskPattern: o, segments: r }
  );
}
Bt.create = function (t, i) {
  ...
  return (
    typeof i < 'u' &&
      ((o = rt.from(i.errorCorrectionLevel, rt.M)),
      (r = q.from(i.version)),
      (n = ct.from(i.maskPattern)),
      i.toSJISFunc && tt.setToSJISFunction(i.toSJISFunc)),
    Te(t, r, o, n)
  );
};
var vt = {},
...
(function (e) {
  ...
  (e.getOptions = function (o) {
    ...
    return {
      ...
      scale: n ? 4 : s,
      margin: r,
      color: { dark: t(o.color.dark || '#000000ff'), light: t(o.color.light || '#ffffffff') },
      type: o.type,
    ...
    (e.qrToImageData = function (o, r, n) {
      ...
      for (let p = 0; p < d; p++)
        for (let w = 0; w < d; w++) {
          let E = (p * d + w) * 4,
            m = n.color.light;
          if (p >= h && w >= h && p < d - h && w < d - h) {
            const y = Math.floor((p - h) / a),
              g = Math.floor((w - h) / a);
            m = B[u[y * s + g] ? 1 : 0];
          }
...
(function (e) {
  ...
  (e.render = function (n, s, u) {
    ...
    typeof a > 'u' && (!s || !s.getContext) && ((a = s), (s = void 0)),
      s || (d = o()),
      (a = t.getOptions(a));
    const h = t.getImageWidth(n.modules.size, a),
      B = d.getContext('2d'),
      p = B.createImageData(h, h);
    return t.qrToImageData(p.data, n, a), i(B, d, h), B.putImageData(p, 0, 0), d;
  }),
    (e.renderToDataURL = function (n, s, u) {
      let a = u;
      typeof a > 'u' && (!s || !s.getContext) && ((a = s), (s = void 0)), a || (a = {});
      const d = e.render(n, s, a),
        h = a.type || 'image/png',
        B = a.rendererOpts || {};
      return d.toDataURL(h, B.quality);
    });
})(vt);
var Ut = {};
const Ne = mt;
  ...
  for (let u = 0; u < e.length; u++) {
    ...
    !a && !n && (n = !0),
      e[u]
        ? (s++,
          (u > 0 && a > 0 && e[u - 1]) ||
            ((o += n ? st('M', a + i, 0.5 + d + i) : st('m', r, 0)), (r = 0), (n = !1)),
          (a + 1 < t && e[u + 1]) || ((o += st('h', s)), (s = 0)))
        : r++;
  }
  return o;
}
Ut.render = function (t, i, o) {
  const r = Ne.getOptions(i),
    n = t.modules.size,
    s = t.modules.data,
    u = n + r.margin * 2,
    a = r.color.light.a
      ? '<path ' + Et(r.color.light, 'fill') + ' d="M0 0h' + u + 'v' + u + 'H0z"/>'
      : '',
    d = '<path ' + Et(r.color.dark, 'stroke') + ' d="' + Se(s, n, r.margin) + '"/>',
    h = 'viewBox="0 0 ' + u + ' ' + u + '"',
    p =
...
function wt(e, t, i, o, r) {
  const n = [].slice.call(arguments, 1),
    s = n.length,
    u = typeof n[s - 1] == 'function';
  if (!u && !Me()) throw new Error('Callback required as last argument');
  if (u) {
...
function Le(e, t) {
  const i = Array.prototype.slice.call(K.create(e, { errorCorrectionLevel: t }).modules.data, 0),
...
const _e = {
    generate({ uri: e, size: t, logoSize: i, dotColor: o = '#141414' }) {
      ...
      return (
        w.forEach(([m, y]) => {
          E[m] ? E[m]?.push(y) : (E[m] = [y]);
        }),
        Object.entries(E)
          .map(([m, y]) => {
            const g = y.filter((l) => y.every((f) => !at(l, f, a)));
            return [Number(m), g];
          })
          .forEach(([m, y]) => {
            y.forEach((g) => {
              s.push(Q`<circle cx=${m} cy=${g} fill=${o} r=${a / Ct} />`);
            });
          }),
        Object.entries(E)
          .filter(([m, y]) => y.length > 1)
          .map(([m, y]) => {
            const g = y.filter((l) => y.some((f) => at(l, f, a)));
            return [Number(m), g];
          })
          .map(([m, y]) => {
            y.sort((l, f) => (l < f ? -1 : 1));
            const g = [];
            for (const l of y) {
              const f = g.find((c) => c.some((C) => at(l, C, a)));
              f ? f.push(l) : g.push([l]);
            }
            return [m, g.map((l) => [l[0], l[l.length - 1]])];
          })
          .forEach(([m, y]) => {
            y.forEach(([g, l]) => {
              s.push(Q`
...
var L =
  ...
  function (e, t, i, o) {
    var r = arguments.length,
      n = r < 3 ? t : o === null ? (o = Object.getOwnPropertyDescriptor(t, i)) : o,
      s;
    if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
      n = Reflect.decorate(e, t, i, o);
    else
      for (var u = e.length - 1; u >= 0; u--)
        (s = e[u]) && (n = (r < 3 ? s(n) : r > 3 ? s(t, i, n) : s(t, i)) || n);
...
let N = class extends $t {
  ...
  templateVisual() {
    return this.imageSrc
      ? Y`<wui-image src=${this.imageSrc} alt=${this.alt ?? 'logo'}></wui-image>`
      : this.farcaster
        ? Y`<wui-icon
        class="farcaster"
        size="inherit"
        ...
        name="farcaster"
      ></wui-icon>`
        : Y`<wui-icon size="inherit" color="inherit" name="walletConnect"></wui-icon>`;
  }
};
N.styles = [zt, De];
L([v()], N.prototype, 'uri', void 0);
L([v({ type: Number })], N.prototype, 'size', void 0);
L([v()], N.prototype, 'theme', void 0);
L([v()], N.prototype, 'imageSrc', void 0);
L([v()], N.prototype, 'alt', void 0);
L([v()], N.prototype, 'color', void 0);
L([v({ type: Boolean })], N.prototype, 'arenaClear', void 0);
L([v({ type: Boolean })], N.prototype, 'farcaster', void 0);
N = L([Ot('wui-qr-code')], N);
