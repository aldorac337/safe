  ...
  [25],
  {
    ...
    47044: function (e, t, n) {
      ...
      let l = { appTheme: 'light' },
        d = { showTestnets: !1, autoSwitchNetwork: !1 },
        m = [
          i.V9.Arbitrum,
          i.V9.Base,
          i.V9.Blast,
    ...
    45960: function (e, t, n) {
      ...
      let c = () => {
          ...
          let t = (0, s.zS)(),
            n = (0, i.Vj)(t.id.value),
            [r, c] = (0, o.Rr)(a.j6, { defaultValue: { [n]: a.CS } });
          return (
            r[n] || c((e) => ({ ...e, [n]: a.CS })),
            {
              settings: null !== (e = r[n]) && void 0 !== e ? e : a.CS,
              update: (e, t) => {
                c((r) => ({ ...r, [n]: { ...r[n], [e]: t } }));
              },
            }
    ...
    15642: function (e, t, n) {
      ...
      let a = new Map();
      function i(e, t) {
        let n = null == t ? void 0 : t.serializer,
          [i] = (0, r.useState)(null == t ? void 0 : t.defaultValue);
        return (function (e, t) {
          let n = !(arguments.length > 2) || void 0 === arguments[2] || arguments[2],
            ...
            d = (0, r.useRef)({ string: null, parsed: void 0 }),
            m = (0, r.useSyncExternalStore)(
              (0, r.useCallback)(
                (t) => {
                  let n = (n) => {
                    e === n && t();
              ...
              () => {
                var n;
                let r = null !== (n = u(() => localStorage.getItem(e))) && void 0 !== n ? n : null;
                if (a.has(e)) d.current.parsed = a.get(e);
                else if (r !== d.current.string) {
                  let e;
                  try {
                    e = null === r ? t : i(r);
                  } catch (n) {
                ...
                return (
                  ...
                  null === r &&
                    ...
                    u(() => {
                      let n = l(t);
                      localStorage.setItem(e, n), (d.current = { string: r, parsed: t });
                    }),
                  d.current.parsed
                );
              },
            ...
            h = (0, r.useCallback)(
              (t) => {
                let n = t instanceof Function ? t(d.current.parsed) : t;
                try {
                  localStorage.setItem(e, l(n)), a.delete(e);
                } catch (t) {
                  a.set(e, n);
                }
                s(e);
          ...
          return (
            (0, r.useEffect)(() => {
              if (!n) return;
              let t = (t) => {
                t.storageArea === u(() => localStorage) && t.key === e && s(e);
              };
              return (
            ...
            (0, r.useMemo)(
              () => [
                ...
                h,
                {
                  isPersistent: m === t || !a.has(e),
                  removeItem() {
                    u(() => localStorage.removeItem(e)), a.delete(e), s(e);
                  },
                },
              ],
              [e, h, m, t]
