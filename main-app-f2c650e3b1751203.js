try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = '008ee28b-7827-4599-b0fa-98e8c0d0c0a6'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-008ee28b-7827-4599-b0fa-98e8c0d0c0a6'));
} catch (e) {}
  ...
  [1744],
  {
      ...
      let o = n.z.string(),
        ...
        f = (0, i.D)({
          client: {
            ...
            NEXT_PUBLIC_RPC_HTTP_URL_MAINNET: c,
            NEXT_PUBLIC_RPC_HTTP_URL_BASE_MAINNET: c,
            NEXT_PUBLIC_RPC_HTTP_URL_VIRTUAL_MAINNET: c,
            NEXT_PUBLIC_RPC_HTTP_URL_POLYGON_MAINNET: c,
            NEXT_PUBLIC_RPC_HTTP_URL_UNICHAIN_MAINNET: c,
            NEXT_PUBLIC_WALLET_CONNECT_PROJECT_ID: o,
            NEXT_PUBLIC_BLUE_API_URL: c,
            NEXT_PUBLIC_REWARDS_API_URL: c,
            NEXT_PUBLIC_STATUS_URL: c,
            ...
            NEXT_PUBLIC_CALLDATA_ORIGIN: o.default('1111'),
    ...
    18313: function (e, t, a) {
      ...
      let c = l.R,
        ...
        b = {
          ...
          AVAILABLE_CHAINS: f,
          INTERFACE_CHAINS: f.map((e) => o.FW.getMetadata(e.id)),
    ...
    21464: function (e, t, a) {
      ...
      let s = {
        ...
        debugSharedLiquidity: (e) => {
          let { bundlingOptions: t, userAddress: a, txHash: n, operations: r, steps: c } = e;
          r.some((e) => o.includes(e.type)) &&
            l.clientEnvs.NEXT_PUBLIC_DEBUG_SHARED_LIQUIDITY &&
            i.eN({
              message: '[Shared Liquidity] user "'.concat(a, '" with tx hash "').concat(n, '"'),
              level: 'debug',
    ...
    43872: function (e, t, a) {
      ...
      (globalThis._sentryRewritesTunnelPath = void 0),
        (globalThis.SENTRY_RELEASE = { id: 'bc8eeff0a783e378d4c5ac036c28b3c28eaa9d75' }),
    ...
    43394: function (e, t, a) {
      ...
      let h = i('/assets/logos/aave.svg'),
        ...
        I = { name: 'Morpho Aave V3', imageSrc: h, supportSignature: !0 },
        v = { name: 'Aave V2', imageSrc: h, supportSignature: !0 },
        ...
        P = c.addressesRegistry[c.ChainId.EthMainnet],
        m = c.addressesRegistry[c.ChainId.BaseMainnet],
        U = c.addressesRegistry[c.ChainId.PolygonMainnet],
        R = c.addressesRegistry[c.ChainId.Unichain],
        B = {
          [c.ChainId.EthMainnet]: {
            chain: b.R,
            safeIdentifier: 'eth',
            ...
            protocols: { aaveV3Optimizer: I, aaveV2: v, aaveV3: T, compoundV2: L, compoundV3: x },
            vaultVersion: {
          ...
          [c.ChainId.OptimismMainnet]: void 0,
    ...
    92196: function (e, t, a) {
      ...
      let u = (e) => {
        ...
        return { message: i, isReadOnly: (0, c.isDefined)(i) };
      };
    },
    9009: function (e, t, a) {
      'use strict';
    ...
    12556: function (e, t, a) {
      ...
      function u(e) {
        ...
        return (0, c.useMemo)(() => !(a.some((e) => !e) || n.every(d.isDefined)) && t, [t, a, n]);
      }
      var f = a(1017),
        b = a(92196),
        p = a(33877),
