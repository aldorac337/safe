!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = '11b02fc7-2bdd-4e7c-8eca-41cf8db0b567'),
      (e._sentryDebugIdIdentifier = 'sentry-dbid-11b02fc7-2bdd-4e7c-8eca-41cf8db0b567'));
  } catch (e) {}
})();
        ...
        function ep(e) {
          ...
          var tV = function (e) {
            ...
            t7 = function (e) {
              ...
              tV(e.data.response_message, t), t8(e.data.allowed_actions);
            };
          (0, w.useEffect)(
            function () {
              if (
