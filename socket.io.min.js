            ...
            (n = [
              {
                ...
                value: function (t, e) {
                  var n = new Error(t);
                  return (
                    (n.type = 'TransportError'), (n.description = e), this.emit('error', n), this
                  );
                },
              },
              {
          ...
          p(t, [
            {
              ...
              value: function (t) {
                return (t.type !== l.EVENT && t.type !== l.ACK) || !d.hasBinary(t)
                  ...
                  : ((t.type = t.type === l.EVENT ? l.BINARY_EVENT : l.BINARY_ACK),
            ...
            [
              {
                ...
                value: function (t) {
                  var e;
                  if ('string' == typeof t)
                    (e = this.decodeString(t)).type === l.BINARY_EVENT || e.type === l.BINARY_ACK
            ...
            (n = [
                  ...
                  var o = y.on(n, 'open', function () {
                    ...
                    s = y.on(n, 'error', function (n) {
                      r.cleanup(),
                        ...
                        i(u(v.prototype), 'emit', e).call(e, 'error', n),
              ...
              },
              {
                ...
                value: function () {
                  this.cleanup(),
                    ...
                    i(u(v.prototype), 'emit', this).call(this, 'open');
                  var t = this.engine;
                  this.subs.push(
                    y.on(t, 'ping', this.onping.bind(this)),
                    y.on(t, 'data', this.ondata.bind(this)),
              ...
              },
              {
                ...
                value: function (t) {
                  this.cleanup(),
                    this.backoff.reset(),
                    (this._readyState = 'closed'),
                    i(u(v.prototype), 'emit', this).call(this, 'close', t),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (this.backoff.attempts >= this._reconnectionAttempts)
                    this.backoff.reset(),
                      i(u(v.prototype), 'emit', this).call(this, 'reconnect_failed'),
                      (this._reconnecting = !1);
                  else {
                        ...
                        e.skipReconnect ||
                          e.open(function (n) {
                            n
                              ? ((e._reconnecting = !1),
                                e.reconnect(),
                                i(u(v.prototype), 'emit', t).call(t, 'reconnect_error', n))
                              : e.onreconnect();
                          }));
                    }, n);
                    this.subs.push(function () {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this._reconnecting = !1),
                    this.backoff.reset(),
                    i(u(v.prototype), 'emit', this).call(this, 'reconnect', t);
                },
              },
            ]) && o(e.prototype, n),
            a && o(e, a),
              ...
              },
              {
                ...
                value: function () {
                  var t = this.query || {},
                    ...
                    n = '';
                  return (
                    !1 !== this.opts.timestampRequests && (t[this.opts.timestampParam] = h()),
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    s || (this.connected ? this.packet(o) : this.sendBuffer.push(o)),
                    (this.flags = {}),
                    this
                  );
                },
              ...
              },
              {
                ...
                value: function (t) {
                  (this.connected = !1),
                    (this.disconnected = !0),
                    delete this.id,
                    c(p(f.prototype), 'emit', this).call(this, 'disconnect', t);
                },
              },
              {
                key: 'onpacket',
                    ...
                    switch (t.type) {
                      case l.PacketType.CONNECT:
                        if (t.data && t.data.sid) {
                          ...
                          c(p(f.prototype), 'emit', this).call(
                            this,
                            'connect_error',
                            new Error(
                      ...
                      case l.PacketType.CONNECT_ERROR:
                        ...
                        (n.data = t.data.data),
                          c(p(f.prototype), 'emit', this).call(this, 'connect_error', n);
                    }
                },
              },
              {
              ...
              },
              {
                ...
                value: function (t) {
                  (this.id = t),
                    (this.connected = !0),
                    (this.disconnected = !1),
                    c(p(f.prototype), 'emit', this).call(this, 'connect'),
                    this.emitBuffered();
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  return (
                    this.connected && this.packet({ type: l.PacketType.DISCONNECT }),
                    this.destroy(),
        ...
        v = (function (t) {
          ...
          function l(t) {
            ...
            return (
              ...
              (e.hostname =
                n.hostname || ('undefined' != typeof location ? location.hostname : 'localhost')),
              (e.port =
                n.port ||
              ...
              'string' == typeof e.opts.query && (e.opts.query = d.decode(e.opts.query)),
              (e.id = null),
              (e.upgrades = null),
              (e.pingInterval = null),
              (e.pingTimeout = null),
                ...
                value: function () {
                  ...
                  return (
                    this.opts.port &&
                      ...
                      (n = ':' + this.opts.port),
                    this.opts.timestampRequests && (t[this.opts.timestampParam] = l()),
