import { i as p, d, R as l, v as o, x as e } from './index-84fa2459.js';
import { r as u, c as h } from './if-defined-0db99fa5.js';
import { T as g } from './index-71ff72b7.js';
(function () {
  try {
    var r =
        typeof window < 'u'
    ...
    t &&
      ...
      (r._sentryDebugIds[t] = '500934ec-9997-4076-8ef8-0a134d99e9b1'),
      (r._sentryDebugIdIdentifier = 'sentry-dbid-500934ec-9997-4076-8ef8-0a134d99e9b1'));
  } catch {}
})();
const f = p`
  :host {
...
var v =
  ...
  function (r, t, i, a) {
    var w = arguments.length,
      n = w < 3 ? t : a === null ? (a = Object.getOwnPropertyDescriptor(t, i)) : a,
      c;
    if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
      n = Reflect.decorate(r, t, i, a);
    else
      for (var m = r.length - 1; m >= 0; m--)
        (c = r[m]) && (n = (w < 3 ? c(n) : w > 3 ? c(t, i, n) : c(t, i)) || n);
    return w > 3 && n && Object.defineProperty(t, i, n), n;
  };
let s = class extends d {
  constructor() {
    super(),
      ...
      (this.viewDirection = ''),
      this.unsubscribe.push(l.subscribeKey('view', (t) => this.onViewChange(t)));
  }
  firstUpdated() {
    (this.resizeObserver = new ResizeObserver(([t]) => {
      const i = `${t?.contentRect.height}px`;
      this.prevHeight !== '0px' &&
        (this.style.setProperty('--prev-height', this.prevHeight),
        this.style.setProperty('--new-height', i),
        (this.style.animation = 'w3m-view-height 150ms forwards ease'),
        (this.style.height = 'auto')),
        setTimeout(() => {
          (this.prevHeight = i), (this.style.animation = 'unset');
        }, o.ANIMATION_DURATIONS.ModalHeight);
    })),
      this.resizeObserver?.observe(this.getWrapper());
  }
  disconnectedCallback() {
    this.resizeObserver?.unobserve(this.getWrapper()), this.unsubscribe.forEach((t) => t());
  }
  render() {
  ...
  viewTemplate() {
    switch (this.view) {
      ...
      case 'Profile':
        return e`<w3m-profile-view></w3m-profile-view>`;
      case 'SwitchAddress':
        return e`<w3m-switch-address-view></w3m-switch-address-view>`;
      case 'Transactions':
        return e`<w3m-transactions-view></w3m-transactions-view>`;
      case 'OnRampProviders':
        return e`<w3m-onramp-providers-view></w3m-onramp-providers-view>`;
      case 'OnRampActivity':
        return e`<w3m-onramp-activity-view></w3m-onramp-activity-view>`;
  ...
  onViewChange(t) {
    g.hide();
    let i = o.VIEW_DIRECTION.Next;
    const { history: a } = l.state;
    a.length < this.prevHistoryLength && (i = o.VIEW_DIRECTION.Prev),
      (this.prevHistoryLength = a.length),
      (this.viewDirection = i),
      setTimeout(() => {
        this.view = t;
      }, o.ANIMATION_DURATIONS.ViewTransition);
  }
  getWrapper() {
...
s.styles = f;
v([u()], s.prototype, 'view', void 0);
v([u()], s.prototype, 'viewDirection', void 0);
s = v([h('w3m-router')], s);
export { s as W };
