try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = '9ffe5f44-2fa7-4ca5-b230-e4bcf81b4c9c'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-9ffe5f44-2fa7-4ca5-b230-e4bcf81b4c9c'));
} catch (e) {}
!(function () {
  'use strict';
  var e,
  ...
  (i.m = o),
    ...
    (i.O = function (t, f, c, n) {
      ...
      for (var a = 1 / 0, d = 0; d < e.length; d++) {
        for (var f = e[d][0], c = e[d][1], n = e[d][2], r = !0, b = 0; b < f.length; b++)
          a >= n &&
    ...
    (i.l = function (e, t, f, d) {
      ...
      if (void 0 !== f)
        for (var a, r, b = document.getElementsByTagName('script'), o = 0; o < b.length; o++) {
          var u = b[o];
          if (u.getAttribute('src') == e || u.getAttribute('data-webpack') == n + f) {
            a = u;
            break;
          }
        }
    ...
    (i.f.j = function (e, t) {
      ...
      if (0 !== f) {
        if (f) t.push(f[2]);
        else if (/^(2272|7148)$/.test(e)) a[e] = 0;
        else {
    ...
    (r = function (e, t) {
      ...
      for (e && e(t); b < n.length; b++) (c = n[b]), i.o(a, c) && a[c] && a[c][0](), (a[c] = 0);
      return i.O(o);
    }),
