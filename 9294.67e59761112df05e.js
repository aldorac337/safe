...
${e.length}`,
            ...
            (function (e) {
              ...
              let {
                  ...
                  function h(e) {
                    ...
                    try {
                      t = 'bigint' == typeof e ? e : t3(t9('private key', e, s));
                    } catch {
                      throw Error(
      ...
      function rr(e) {
        if (2 === re(e.type)) return H(j([e.type, e.sealed]), i2);
        if (1 === re(e.type)) {
          if (typeof e.senderPublicKey > 'u')
            throw Error('Missing sender public key for type 1 envelope');
          return H(j([e.type, e.senderPublicKey, e.iv, e.sealed]), i2);
        }
        return H(j([e.type, e.iv, e.sealed]), i2);
      }
      function rs(e) {
        let t = K((e.encoding || i2) === i8 ? ri(e.encoded) : e.encoded, i2),
          i = t.slice(0, 1);
        if (1 === re(i)) {
          let e = t.slice(1, 33),
            r = t.slice(33, 45);
        ...
        constructor(e, t, i) {
          (this.core = e),
            ...
            s1(this, 'generateKeyPair', () => {
              ...
              let e = (function () {
                let e = iV.utils.randomPrivateKey(),
                  t = iV.getPublicKey(e);
                return { privateKey: H(e, i3), publicKey: H(t, i3) };
              })();
              return this.setPrivateKey(e.publicKey, e.privateKey);
            }),
            ...
            s1(this, 'generateSharedKey', (e, t, i) => {
              ...
              let s =
                ((r = this.getPrivateKey(e)),
                H(tM(tF, iV.getSharedSecret(K(r, i3), K(t, i3)), void 0, void 0, 32), i3));
              return this.setSymKey(s, i);
            }),
            s1(this, 'setSymKey', async (e, t) => {
              this.isInitialized();
              let i = t || H(tF(K(e, i3)), i3);
              return await this.keychain.set(i, e), i;
            }),
            ...
            s1(this, 'encode', async (e, t, i) => {
              ...
              return (function (e) {
                ...
                if (1 === re(i) && typeof e.senderPublicKey > 'u')
                  throw Error('Missing sender public key for type 1 envelope');
                let r = 'u' > typeof e.senderPublicKey ? K(e.senderPublicKey, i3) : void 0,
                  s = 'u' > typeof e.iv ? K(e.iv, i3) : eM(12),
                  n = rr({
                    type: i,
                    sealed: tR(K(e.symKey, i3), s).encrypt(K(e.message, i4)),
                    iv: s,
                    senderPublicKey: r,
                  });
            ...
            s1(this, 'decode', async (e, t, i) => {
              ...
              let r = (function (e, t) {
                ...
                return rn({
                  type: re(i.type),
                  senderPublicKey:
                    'u' > typeof i.senderPublicKey ? H(i.senderPublicKey, i3) : void 0,
                  receiverPublicKey: t?.receiverPublicKey,
                });
              })(t, i);
              if (2 === r.type) {
            ...
            s1(this, 'getPayloadType', (e, t = i2) => re(rs({ encoded: e, encoding: t }).type)),
            s1(this, 'getPayloadSenderPublicKey', (e, t = i2) => {
              let i = rs({ encoded: e, encoding: t });
              return i.senderPublicKey ? H(i.senderPublicKey, i3) : void 0;
            }),
            (this.core = e),
            (this.logger = (0, a.U5)(t, this.name)),
        ...
        constructor(e, t) {
          (this.core = e),
            ...
            n1(this, 'pair', async (e) => {
              ...
              this.isInitialized();
              let i = this.core.eventClient.createEvent({
                properties: { topic: e?.uri, trace: [r3.pairing_started] },
              });
              this.isValidPair(e, i);
              let { topic: r, symKey: s, relay: n, expiryTimestamp: o, methods: a } = rl(e.uri);
              if (
                ((i.props.properties.topic = r),
                i.addTrace(r3.pairing_uri_validation_success),
                i.addTrace(r3.pairing_uri_not_expired),
                this.pairings.keys.includes(r))
              ) {
                if (((t = this.pairings.get(r)), i.addTrace(r3.existing_pairing), t.active))
                  throw (
                    (i.setError(r2.active_pairing_already_exists),
                    Error(
                      `Pairing already exists: ${r}. Please try again with a new connection URI.`
                    ))
                  );
                i.addTrace(r3.pairing_not_expired);
              }
              let h = o || ed(T.FIVE_MINUTES),
                l = { topic: r, relay: n, expiry: h, active: !1, methods: a };
              this.core.expirer.set(r, h),
                await this.pairings.set(r, l),
                i.addTrace(r3.store_new_pairing),
                e.activatePairing && (await this.activate({ topic: r })),
                this.events.emit(rX.create, l),
                i.addTrace(r3.emit_inactive_pairing),
                this.core.crypto.keychain.has(r) || (await this.core.crypto.setSymKey(s, r)),
                i.addTrace(r3.subscribing_pairing_topic);
              try {
                await this.core.relayer.confirmOnlineStateOrThrow();
              } catch {
                i.setError(r2.no_internet_connection);
              }
              try {
                await this.core.relayer.subscribe(r, { relay: n });
              } catch (e) {
                throw (i.setError(r2.subscribe_pairing_topic_failure), e);
              }
              return i.addTrace(r3.subscribe_pairing_topic_success), l;
            }),
            ...
            n1(this, 'isValidPair', (e, t) => {
              ...
              if (!rA(e)) {
                ...
                throw (t.setError(r2.malformed_pairing_uri), Error(i));
              }
              if (
                !(function (e) {
                  function t(e) {
              ...
              if (!(null != (i = r?.relay) && i.protocol)) {
                ...
                throw (t.setError(r2.malformed_pairing_uri), Error(e));
              }
              if (!(null != r && r.symKey)) {
      ...
      var n6 = Object.defineProperty,
        n3 = (e, t, i) =>
          t in e
            ...
            : (e[t] = i),
        n2 = (e, t, i) => n3(e, 'symbol' != typeof t ? t + '' : t, i);
      class n8 extends y {
        constructor(e, t) {
          super(e, t),
            (this.core = e),
            (this.logger = t),
            n2(this, 'records', new Map()),
            n2(this, 'events', new r.EventEmitter()),
            n2(this, 'name', 'history'),
            n2(this, 'version', '0.3'),
            n2(this, 'cached', []),
            n2(this, 'initialized', !1),
            n2(this, 'storagePrefix', rD),
            n2(this, 'init', async () => {
              this.initialized ||
                (this.logger.trace('Initialized'),
                await this.restore(),
...
//# sourceMappingURL=9294.67e59761112df05e.js.map
