...
Beamer.init = function () {
  if (!Beamer.started) {
    ...
    if (beamer_config.language) c += '&language=' + encodeURIComponent(beamer_config.language);
      ...
      d &&
        1 < d.length &&
        ((d = d.substring(0, 2).toUpperCase()), (c += '&language=' + encodeURIComponent(d)));
    }
    Beamer.ajax(
      c,
      function (e) {
...
Beamer.showFeed = function (a, b) {
  if (Beamer.enabled) {
    ...
    var c =
      'undefined' !== typeof beamer_config.onopen ? beamer_config.onopen : beamer_config.onOpen;
      ...
      if (null != document.getElementById(h)) {
        ...
        (function (l) {
          if (!Beamer.initialized) {
            ...
            v && (t += ' style="background-color: ' + v + ';"');
            t += '></div>';
            'undefined' !== typeof Beamer.escapeHtml && (m = Beamer.escapeHtml(m));
            var n =
            ...
            Beamer.isEmbedMode()
              ? Beamer.forEachElement(beamer_config.selector, function (p) {
                  Beamer.appendHtml(p, n);
                })
              : Beamer.appendHtml(document.body, n);
            Beamer.addClick('beamerOverlay', Beamer.hide);
          }
          _BEAMER_SHOW_PUSH_PROMPT &&
            'undefined' === typeof Beamer.pushDomain &&
            Beamer.forEachElement('beamerNews', function (p) {
              p.onload = Beamer.showNotificationPrompt(2e3);
            });
          Beamer.isInApp() &&
            !Beamer.isEmbedMode() &&
            Beamer.forEachElement('beamerNews, beamerLoader', function (p) {
              Beamer.forEachElement(beamer_config.selector, function (u) {
                Beamer.isElementVisible(u) &&
                  (Beamer.setPopperPosition(p, u), Beamer.initPopper(p, u));
              });
              if ('undefined' !== typeof l && l.target && Beamer.isElementVisible(l.target)) {
                var q = null;
                Beamer.forEachElement(beamer_config.selector, function (u) {
                  u.contains(l.target) && (q = u);
                });
                null !== q && (Beamer.setPopperPosition(p, q), Beamer.updatePopper(q));
              }
              Beamer.removeEventListener(p, 'mouseenter', Beamer.mouseEnterHandler);
              Beamer.addEventListener(p, 'mouseenter', Beamer.mouseEnterHandler);
              Beamer.removeEventListener(p, 'mouseleave', Beamer.mouseLeaveHandler);
              Beamer.addEventListener(p, 'mouseleave', Beamer.mouseLeaveHandler);
            });
        })(a),
          Beamer.showElement(h),
          Beamer.removeClass(h, 'beamer_hide'),
    ...
    Beamer.enableSoundNotification &&
      Beamer.setCookie(_BEAMER_SOUND_PLAYED + '_' + beamer_config.product_id, !1, 7);
  }
};
Beamer.hide = function () {
  ...
  setTimeout(function () {
    var a =
      'undefined' !== typeof beamer_config.onclose ? beamer_config.onclose : beamer_config.onClose;
...
Beamer.addClick = function (a, b) {
  var c = function (e) {
      ...
      ('undefined' !== typeof g && g) ||
        (Beamer.addEventListener(e, 'keypress', function (m) {
          m = 'which' in m ? m.which : m.keyCode;
          (13 != m && 32 != m) || e.click();
        }),
...
Beamer.removeClass = function (a, b) {
  try {
    Beamer.forEachElement(a, function (c) {
      null != c &&
        (c.className = c.className.replace(new RegExp('( |^)' + b + '( |$)', 'g'), ' ').trim());
    });
  } catch (c) {}
};
...
Beamer.removeClassBody = function (a) {
  try {
    ...
    null != b &&
      b.className &&
      (b.className = b.className.replace(new RegExp('( |^)' + a + '( |$)', 'g'), ' ').trim());
    var c = document.getElementsByTagName('HTML')[0];
    null != c &&
      c.className &&
      (c.className = c.className.replace(new RegExp('( |^)' + a + '( |$)', 'g'), ' ').trim());
  } catch (d) {}
};
...
Beamer.appendStyles = function (a) {
  ...
  c ||
    ...
    Beamer.isEmbedMode()
      ...
      : (c.href = _BEAMER_URL + 'styles/beamer-embed.css?v=9'),
    (c.onload = function () {
    ...
    Beamer.ajax(
      ...
      function (f) {
        ...
        if (void 0 != beamer_config.mobile && !beamer_config.mobile && Beamer.isMobile())
              ...
              : null == d ||
                ...
                ? 'undefined' !== typeof beamer_config.first_visit_unread
                  ? 0 < beamer_config.first_visit_unread
                    ? ((Beamer.notificationNumber = beamer_config.first_visit_unread),
                      (Beamer.notificationActive = !0))
                    : ((Beamer.notificationNumber = 0),
                      (Beamer.notificationActive = !1),
                      setTimeout(function () {
          ...
          a ||
            Beamer.saveInStorage(_BEAMER_HEADER_COLOR, Beamer.getConfigParameter(f, 'headerColor'));
          ...
          (('undefined' !== typeof k && k) || (a && Beamer.pushEnabled)) &&
            ...
            a ||
              ...
              (k = Beamer.getConfigParameter(f, 'pushNotificationsPromptAccept')) &&
                (_BEAMER_PUSH_PROMPT_ACCEPT = k),
              (k = Beamer.getConfigParameter(f, 'pushNotificationsPromptRefuse')) &&
          ...
          a ||
            ...
            'undefined' !== typeof k &&
              k &&
              ((Beamer.enableFaviconNotification = !0), Beamer.appendFaviconScript()));
...
Beamer.triggerClick = function (a, b, c, d) {
  var e =
    'undefined' !== typeof beamer_config.onclick ? beamer_config.onclick : beamer_config.onClick;
  ...
  try {
    if (Beamer.enableFaviconNotification && 'Favico' in window) {
      if ('undefined' == typeof Beamer.favicons) {
        Beamer.favicons = [];
        for (
          var a = document.getElementsByTagName('head')[0].getElementsByTagName('link'), b = 0;
          b < a.length;
          b++
        )
          /(^|\s)icon(\s|$)/i.test(a[b].getAttribute('rel')) &&
            Beamer.favicons.push(
              new Favico({ animation: 'fade', bgColor: Beamer.notificationColor, element: a[b] })
            );
      }
...
Beamer.initPopper = function (a, b, c) {
  ...
  d = { placement: 'auto', modifiers: { flip: { padding: 20, boundariesElement: 'viewport' } } };
...
Beamer.showLastPostTitle = function (a, b, c, d, e, g, f, h, k, l, m) {
  if ('undefined' === typeof k || !k) {
    var r = Beamer.getDateCookie();
    if (void 0 === r || null === r || '' === r) return;
    r = Beamer.getCookie(_BEAMER_LAST_POST_SHOWN + '_' + beamer_config.product_id);
    if ('undefined' !== typeof r && r == b) return;
  }
  Beamer.appendStyles(!0);
  Beamer.appendPopperScript();
  var t = function () {
    if ('undefined' === typeof Popper) setTimeout(t, 1500);
    else {
      var v = !1;
      Beamer.forEachElement(beamer_config.selector, function (q) {
        Beamer.isElementVisible(q) && (v = !0);
      });
      if (v) {
        var n = Beamer.findElements('beamerLastPostTitle');
        n && 0 !== n.length
          ? (n = n[0])
          : (Beamer.appendHtml(document.body, '<div id="beamerLastPostTitle"></div>'),
            (n = Beamer.findElements('beamerLastPostTitle')[0]));
        'undefined' !== typeof e && e
          ? Beamer.addClass('beamerLastPostTitle', 'rtl')
          : Beamer.removeClass('beamerLastPostTitle', 'rtl');
        n.onclick = function (q) {
          -1 === q.target.className.indexOf('beamerTitleWatermark') &&
            -1 === q.target.className.indexOf('beamerTitleWatermarkLink') &&
            ('undefined' !== typeof l && l
              ? (Beamer.closeLastPostTitle(q),
                'undefined' !== typeof g
                  ? window.open(g, '_blank', 'noopener,noreferrer')
                  : BeamerPreview.show())
              : 'undefined' !== typeof g && '' !== g.trim()
                ? (Beamer.openCta(g, f, a, b, 'boosted-tooltip'), Beamer.closeLastPostTitle(q))
                : Beamer.show());
        };
        var p = '';
        'undefined' !== typeof c &&
        ...
        n.innerHTML = p;
        Beamer.forEachElement(beamer_config.selector, function (q) {
          Beamer.isElementVisible(q) &&
            (Beamer.setPopperPosition(n, q), Beamer.initPopper(n, q, !0));
        });
        setTimeout(function () {
          Beamer.updatePopper();
          Beamer.addClass(n, 'active');
          Beamer.waitLastPostTitleClose();
          Beamer.removeEventListener(n, 'mouseenter', Beamer.clearLastPostTitleClose);
          Beamer.addEventListener(n, 'mouseenter', Beamer.clearLastPostTitleClose);
          Beamer.removeEventListener(n, 'mouseleave', Beamer.waitLastPostTitleClose);
          Beamer.addEventListener(n, 'mouseleave', Beamer.waitLastPostTitleClose);
          Beamer.forEachElement('.beamerClose', function (q) {
            Beamer.addEventListener(q, 'click', Beamer.closeLastPostTitle);
          });
        }, 1e3);
        ('undefined' !== typeof l && l) ||
          ...
          'undefined' !== typeof k &&
            k &&
            (Beamer.updateBoostedAnnouncementDate(), Beamer.trackViews(b, m)));
      }
    }
  };
  Beamer.onWindowVisible(t);
};
...
Beamer.updateWindowVisibility = function (a) {
  ...
  if (Beamer.windowVisible)
    for (; 0 < Beamer.windowVisibleBinds.length; ) Beamer.windowVisibleBinds.shift()();
};
  ...
  try {
    ...
    if ('undefined' !== typeof b && 0 < b.length)
      for (e = 0; e < b.length; e++)
        try {
          if (
            ((g = new RegExp(b[e].replace(/[-[\]{}()+?.,\\^$|#\s]/g, '\\$&').replace(/\*/g, '.*'))),
            g.test(c))
          )
            return !1;
        } catch (f) {}
