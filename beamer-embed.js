    ...
    var a = function () {
      ...
      b = function (e, g) {
        ...
        if ('undefined' !== typeof e.enableNPS && e.enableNPS) {
          ...
          'undefined' !== e.enableHiddenTooltipObserver &&
        ...
        (function (l) {
          if (!Beamer.initialized) {
            ...
            ('left' !== beamer_config.display &&
              ...
              ? Beamer.isInApp() && (t = 'popup inapp')
              : (t = beamer_config.display);
            t || (t = 'right');
            ...
            Beamer.isEmbedMode()
              ? Beamer.forEachElement(beamer_config.selector, function (m) {
                  Beamer.appendHtml(m, u);
                })
              : Beamer.appendHtml(document.body, u);
          ...
          Beamer.isInApp() &&
            ...
            Beamer.forEachElement('beamerNews, beamerLoader', function (m) {
              Beamer.forEachElement(beamer_config.selector, function (p) {
                Beamer.isElementVisible(p) &&
                  (Beamer.setPopperPosition(m, p), Beamer.initPopper(m, p));
              });
              if ('undefined' !== typeof l && l.target && Beamer.isElementVisible(l.target)) {
                var q = null;
                Beamer.forEachElement(beamer_config.selector, function (p) {
                  p.contains(l.target) && (q = p);
                });
...
Beamer.showLastPostTitle = function (a, b, c, d, e, g, f, h, k, l, n) {
      ...
      if ('undefined' !== typeof Popper) {
        ...
        var m = new IntersectionObserver(
          function (q, p) {
            ...
            for (var w = q.next(); !w.done; w = q.next())
              if (((w = w.value), w.isIntersecting && Beamer.isElementVisible(w.target))) {
                p.disconnect();
                v();
                break;
              }
        ...
        Beamer.forEachElement(beamer_config.selector, function (q) {
          try {
            ...
            console.error('Beamer: failed to observe element', q, p);
          }
        });
      }
    }, 100);
  ...
  var v = function () {
    if ('undefined' === typeof Popper) setTimeout(v, 1500);
    else {
      var u = !1;
      Beamer.forEachElement(beamer_config.selector, function (p) {
        Beamer.isElementVisible(p) && (u = !0);
      });
      if (u) {
        ...
        Beamer.forEachElement(beamer_config.selector, function (p) {
          Beamer.isElementVisible(p) &&
            (Beamer.setPopperPosition(m, p), Beamer.initPopper(m, p, !0));
        });
        setTimeout(function () {
          Beamer.updatePopper();
          ...
          Beamer.forEachElement('.beamerClose', function (p) {
            Beamer.addEventListener(p, 'click', Beamer.closeLastPostTitle);
          });
        }, 1e3);
        ('undefined' !== typeof l && l) ||
