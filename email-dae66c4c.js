...
import { n as I, c as h, r as m, U as D } from './if-defined-5ea4ccf2.js';
import './index-ac2c30fa.js';
import './index-6dd11eb1.js';
import './index-66bb34ae.js';
import { e as H, n as q } from './ref-51923e9b.js';
import './index-fbd81dd5.js';
import './index-47c8137f.js';
...
(function () {
  try {
    ...
    e &&
      ...
      (a._sentryDebugIds[e] = 'c20d35f8-fa82-434d-aea8-15a5d95135fb'),
      (a._sentryDebugIdIdentifier = 'sentry-dbid-c20d35f8-fa82-434d-aea8-15a5d95135fb'));
  } catch {}
})();
const K = E`
  :host {
  ...
  function (a, e, t, n) {
    ...
    if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
      ...
      for (var l = a.length - 1; l >= 0; l--)
        (r = a[l]) && (i = (o < 3 ? r(i) : o > 3 ? r(e, t, i) : r(e, t)) || i);
...
v.styles = [N, U, K];
R([I({ type: Boolean })], v.prototype, 'disabled', void 0);
R([I({ type: String })], v.prototype, 'value', void 0);
v = R([h('wui-input-numeric')], v);
const Y = E`
  :host {
    position: relative;
    display: block;
...
let f = class extends w {
  ...
  firstUpdated() {
    ...
    const e = this.shadowRoot?.querySelectorAll('wui-input-numeric');
  ...
  updateInput(e, t, n) {
    ...
    i && ((i.value = n), (this.values = this.values.map((r, l) => (l === t ? n : r))));
  }
  selectInput(e) {
    const t = e.target;
  ...
  handlePaste(e, t, n) {
    ...
    if (o && D.isNumber(o)) {
      ...
      if (n + 1 < this.length && r.length) {
        const l = this.numerics[n + 1],
          A = l ? this.getInputElement(l) : void 0;
        A && this.handlePaste(A, r, n + 1);
...
f.styles = [N, Y];
C([I({ type: Number })], f.prototype, 'length', void 0);
C([I({ type: String })], f.prototype, 'otp', void 0);
C([m()], f.prototype, 'values', void 0);
f = C([h('wui-otp')], f);
const G = E`
  wui-loading-spinner {
    margin: 9px auto;
...
let p = class extends w {
  ...
  render() {
    ...
    return u`
      ...
      >
        ...
        ${
          this.loading
            ? u`<wui-loading-spinner size="xl" color="accent-100"></wui-loading-spinner>`
            : u` <wui-flex flexDirection="column" alignItems="center" gap="xs">
              <wui-otp
                dissabled
                length="6"
  ...
  async onOtpInputChange(e) {
    try {
      ...
      (this.error = x.parseError(t)), (this.loading = !1);
    }
  }
  async onResendCode() {
    try {
...
p.styles = G;
O([m()], p.prototype, 'loading', void 0);
O([m()], p.prototype, 'timeoutTimeLeft', void 0);
O([m()], p.prototype, 'error', void 0);
...
V = Q([h('w3m-email-verify-otp-view')], V);
const X = E`
  wui-icon-box {
...
y.styles = X;
W([m()], y.prototype, 'loading', void 0);
y = W([h('w3m-email-verify-device-view')], y);
const Z = E`
  wui-email-input {
    width: 100%;
  }
...
b.styles = Z;
$([m()], b.prototype, 'email', void 0);
$([m()], b.prototype, 'loading', void 0);
b = $([h('w3m-update-email-wallet-view')], b);
var ee =
  (globalThis && globalThis.__decorate) ||
  function (a, e, t, n) {
    var o = arguments.length,
...
P = ee([h('w3m-update-email-primary-otp-view')], P);
var te =
  (globalThis && globalThis.__decorate) ||
  function (a, e, t, n) {
    var o = arguments.length,
...
L = te([h('w3m-update-email-secondary-otp-view')], L);
var F =
  (globalThis && globalThis.__decorate) ||
  function (a, e, t, n) {
    var o = arguments.length,
...
let T = class extends w {
  constructor() {
    super(),
      (this.authConnector = d.getAuthConnector()),
      (this.isEmailEnabled = j.state.features?.email),
...
F([m()], T.prototype, 'connectors', void 0);
T = F([h('w3m-email-login-view')], T);
export {
  T as W3mEmailLoginView,
