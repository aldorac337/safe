...
var W = (t, n, s) =>
    n in t ? fe(t, n, { enumerable: !0, configurable: !0, writable: !0, value: s }) : (t[n] = s),
  D = (t, n) => {
...
import { J as Re } from './JupiterService-DgkMwrEN.js';
import { u as We } from './useKswapSdk-6qh4k4RZ.js';
import { a as le, b as de, c as me, g as ue, P as v, d as He } from './priceImpact-CFdGNOO4.js';
import { N as Ve } from './Notification-5W3SHIHB.js';
import { W as q } from './TransactionSettingButton-Cr4fbUjr.js';
import { C as Ue } from './CapacityLimitIcon-CWXOclGs.js';
(function () {
  try {
    var t =
        typeof window < 'u'
    ...
    n &&
      ...
      (t._sentryDebugIds[n] = '0a631f89-13c9-41d6-82f3-1fbd7d27f7ff'),
      (t._sentryDebugIdIdentifier = 'sentry-dbid-0a631f89-13c9-41d6-82f3-1fbd7d27f7ff'));
  } catch (s) {}
})();
function X(t) {
...
function Gn({
  ...
  const { getPriceByTokenMintDecimal: c } = ge(),
    ...
    d = async () => {
      ...
      const f = c(t),
        b = f.eq(0) ? new j(1) : new j(1).div(f),
        w = await Re.getBestRoute({
          kswapSdk: l,
          amountLamports: S.numberToLamportsDecimal(b.mul(100), h(t).decimals),
          inputMint: t,
          outputMint: n,
          slippage: 0,
          mode: 'ExactIn',
    ...
    { data: u } = m,
    x = z(m, ['data']);
  return D({ data: u || Ke, queryFn: d }, x);
}
const Sn = ({
    inputMint: t,
    outputMint: n,
  ...
  { formatTokenAllDecimals: Z, formatPercent: p } = C;
function et(t, n, s, a, r) {
  ...
  return o && i
    ? 'Continue with '
        .concat(p(n.div(100)), ' price impact and ')
        .concat(p(a.div(100)), ' price divergence')
    : o
      ? 'Continue with '.concat(p(a.div(100)), ' price divergence')
      : i
        ? 'Continue with '.concat(p(n.div(100)), ' price impact')
        : c
          ? 'Proceed With '.concat(p(r == null ? void 0 : r.toNumber(), 2, !0), ' Slippage')
          : 'Continue';
}
function tt(t, n, s, a) {
  const r = $(t, s),
...
const Cn = ({
    ...
    const x = re(),
      m = ue(n, s),
      f = () => {
        x.track('price_impact:modal:confirm', {
      ...
      b = () => {
        x.track('price_impact:modal:cancel', {
          priceImpactPct: s.div(100).toFixed(),
          marketPrice: r.toFixed(),
          theoreticalPrice: o.toString(),
        }),
            ...
            i != null && i.greaterThan(R)
              ? e.jsxs('div', {
                  ...
                  children: [
                    ...
                    p(i == null ? void 0 : i.toNumber(), 2, !0),
  ...
  ht = '_trigger_byb4x_4',
  ft = '_content_byb4x_11',
  xt = '_icon_byb4x_17',
  gt = '__isOpen_byb4x_21',
  G = { container: _t, trigger: ht, content: ft, icon: xt, _isOpen: gt },
  yt = xe(G),
  ...
  pt = '_metalGreyGradient_1h3ic_9',
  bt = '_goldGradient_1h3ic_15',
  ...
  kt = '_pointsSilverTextGradient_1n4qz_33',
  Lt = '_root_1n4qz_39',
  ...
  qt = '_circularChart_w8gb5_9',
  Bt = '_circle_w8gb5_14',
  Ot = '_outerCircle_w8gb5_22',
  k = { progressContainer: zt, circularChart: qt, circle: Bt, outerCircle: Ot },
  ...
  { formatTokenAllDecimals: L, formatPercent: Wt } = C,
  Ln = (t) => {
    var E;
    const { getToken: n } = A(),
      {
      ...
      x = (r == null ? void 0 : r.outAmount) || '0',
      m = r == null ? void 0 : r.inputMint,
      f = r == null ? void 0 : r.outputMint,
      b = (he) => {
        he.stopPropagation(), i();
      },
      w = m ? Q(u, n(m).decimals) : new j(0),
      P = f ? Q(x, n(f).decimals) : new j(0);
          ...
          children: [
            e.jsxs('div', {
              ...
              children: [
                ...
                e.jsxs(_, { color: 'white', children: [L(w, 6), ' ', m ? n(m).symbol : ''] }),
              ],
            }),
            e.jsxs('div', {
              className: T.statsItem,
              children: [
                ...
                e.jsxs(_, { color: 'white', children: [L(P, 6), ' ', f ? n(f).symbol : ''] }),
              ],
            }),
            l &&
              e.jsxs('div', {
            ...
            e.jsxs('div', {
              ...
              children: [
                ...
                e.jsx(_, { color: 'white', children: L(d, 0) }),
              ],
            }),
          ],
        }),
...
const hn = (t) => {
  ...
  fn = (t) => t.concat(Array(4 - t.length).fill(ie.U16_MAX)),
  xn = [
    ...
    { mintAddress: ke, chain: [494] },
    { mintAddress: Le, chain: [487] },
  ...
  const { web3client: s } = Te(),
    a = async () => {
      ...
      const c = new ie.Scope('mainnet-beta', s.connection),
        ...
        l = await Promise.all(
          xn.map(async (d) => {
            const u = await c.getPriceFromChain(fn(d.chain), h);
            return [new O(d.mintAddress), u.price];
          })
        );
...
//# sourceMappingURL=useGetLSTsStakeRatesQuery-By0XPz62.js.map
