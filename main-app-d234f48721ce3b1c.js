try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = '12bb49a9-6b6a-4d5d-b258-2c94025610f8'),
    (e._sentryDebugIdIdentifier = 'sentry-dbid-12bb49a9-6b6a-4d5d-b258-2c94025610f8'));
} catch (e) {}
  ...
  [1744],
  {
    ...
    59855: function (e, t, a) {
      ...
      let c = {
        ...
        debugSharedLiquidity: (e) => {
          var t, a, n, r, u, p, f;
          let { bundlingOptions: b, userAddress: _, txHash: E, operations: h, steps: A } = e;
            ...
            i.eN({
              ...
              extra: c.createExtra({
                defaultMaxWithdrawalUtilization:
                  null === (t = b.publicAllocatorOptions) || void 0 === t
                    ? void 0
                    : t.defaultMaxWithdrawalUtilization,
                defaultSupplyTargetUtilization:
                  null === (a = b.publicAllocatorOptions) || void 0 === a
                    ? void 0
                    : a.defaultSupplyTargetUtilization,
                publicAllocatorEnabled:
                  null === (n = b.publicAllocatorOptions) || void 0 === n ? void 0 : n.enabled,
                ...o(
                  null === (r = b.publicAllocatorOptions) || void 0 === r
                    ? void 0
                    : r.reallocatableVaults,
                  'reallocatableVaults',
                  30
                ),
                delay: null === (u = b.publicAllocatorOptions) || void 0 === u ? void 0 : u.delay,
                ...s(
                  null === (p = b.publicAllocatorOptions) || void 0 === p
                    ? void 0
                ...
                ...s(
                  null === (f = b.publicAllocatorOptions) || void 0 === f
                    ? void 0
    ...
    43872: function (e, t, a) {
      ...
      (globalThis._sentryRewritesTunnelPath = void 0),
        (globalThis.SENTRY_RELEASE = { id: 'cc374f22513ac9bd8a715060b0a7c82094000744' }),
          ...
          vaultsWithPoints: {
            1: {
              ...
              '0x0F359FD18BDa75e9c49bC027E7da59a4b01BF32a': [
                ...
                { title: 'Points', label: 'Resolv', link: 'https://app.resolv.xyz/points' },
              ],
              '0x2C25f6C25770fFEC5959D34B94Bf898865e5D6b1': [
                { title: 'Units', label: 'Relend', link: 'https://app.relend.network/dashboard' },
              ],
            ...
            130: {
              '0x2c0F7e917257926BA6233B20DE19d7fe3210858C': [
                { title: 'XP', label: 'Superstacks', link: 'https://app.optimism.io/superstacks' },
              ],
